...
<script type="text/javascript" src="../js/ss/prm/BINBESSPRM05.js"></script>
<style>
...
<s:a action="BINBESSPRM05_getCounter" id="getCounter" cssStyle="display: none;"></s:a>
<s:a action="BINBESSPRM05_getDiff" id="getDiff" cssStyle="display: none;"></s:a>
...
<div class="section">
    <div class="section-content">
        ...
        <div class="center">
            <s:a action="BINBESSPRM05_Exec" id="exec" cssStyle="display: none;"></s:a>
            <input type="hidden" id="brandInfoId" value="${brandInfoId}"></input>
            <button class="save" onclick="BINBESSPRM05.save();return false;"><span class="ui-icon icon-confirm"></span><span class="button-text">执行同步</span></button>
