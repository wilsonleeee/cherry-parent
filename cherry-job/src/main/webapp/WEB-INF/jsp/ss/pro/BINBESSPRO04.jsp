...
<script type="text/javascript" src="../js/ss/pro/BINBESSPRO04.js"></script>
<style>
...
%>
<s:a action="BINBESSPRO04_getDepart" id="getDepart" cssStyle="display: none;"></s:a>
<s:a action="BINBESSPRO04_getDiff" id="getDiff" cssStyle="display: none;"></s:a>
<s:a action="BINBESSPRO04_export" id="downUrl" cssStyle="display: none;"></s:a>
...
<div class="section">
    <div class="section-content">
        ...
        <hr/>
        <div>注意：执行平产品库存前必须停止MQ</div>
        <form action="BINBESSPRO04_export" id="exportForm">
	        ...
	        <button onclick="BINBESSPRO04.search();return false;">查询</button>
        ...
        <div class="center">
            <s:a action="BINBESSPRO04_Exec" id="exec" cssStyle="display: none;"></s:a>
            <input type="hidden" id="brandInfoId" value="${brandInfoId}"></input>
            <button class="save" onclick="BINBESSPRO04.save();return false;"><span class="ui-icon icon-confirm"></span><span class="button-text">执行平产品库存</span></button>
