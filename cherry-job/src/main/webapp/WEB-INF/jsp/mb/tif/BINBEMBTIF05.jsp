		    ...
		    <div class="section">
			  <form id="execForm">
				  ...
				  <div class="clearfix" style="margin-top:10px;">
				 	<span class="left">会员ID范围：<s:textfield name="mebIdStart"></s:textfield>-<s:textfield name="mebIdEnd"></s:textfield></span> 
				  	<s:url action="BINBEMBTIF05_memExec" id="execUrl"></s:url>
