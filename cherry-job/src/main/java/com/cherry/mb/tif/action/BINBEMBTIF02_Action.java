 ...
 */
public class BINBEMBTIF02_Action extends BaseAction{

	/**
	 * 
	 */
	private static final long serialVersionUID = 7792419945314979146L;
	
	private static Logger logger = LoggerFactory.getLogger(BINBEMBTIF02_Action.class.getName());
	...
	public String binbembarcExec() throws Exception {
		...
		try {
			...
			flg = binBEMBTIF02_BL.tran_MixMobile(map);
