 ...
 */
public class BINBEMBTIF08_BL {
	
	private static Logger logger = LoggerFactory.getLogger(BINBEMBTIF08_BL.class.getName());
	...
	public int tran_MixMobile(Map<String, Object> map) throws Exception {
		...
		while (true) {
			...
			// 取得需要手机加密的会员信息List
			List<Map<String, Object>> memList = binBEMBTIF01_Service.getMemPhoneList(map);
			// 会员信息List不为空
	...
	public void executeMembers(List<Map<String, Object>> memList, Map<String, Object> map) throws Exception {
		...
		String mixKey = binBEMBTIF01_Service.getTmMixKey(Integer.valueOf(ConvertUtil.getString(map.get("brandInfoId"))));
...
//	}
	...
	private void commParamsForUp(Map<String, Object> map){
		// 作成者
		map.put(CherryBatchConstants.CREATEDBY, "BINBEMBTIF08");
		// 作成程序名
		map.put(CherryBatchConstants.CREATEPGM, "BINBEMBTIF08");
		// 更新者
		map.put(CherryBatchConstants.UPDATEDBY, "BINBEMBTIF08");
		// 更新程序名
		map.put(CherryBatchConstants.UPDATEPGM, "BINBEMBTIF08");
	}
}
