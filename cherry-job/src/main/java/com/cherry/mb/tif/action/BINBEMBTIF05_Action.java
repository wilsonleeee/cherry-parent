/*	
 * @(#)BINBEMBTIF05_Action.java     1.0 2015/06/24		
 * 		
 ...
 */
public class BINBEMBTIF05_Action extends BaseAction{

	private static final long serialVersionUID = -7687923613763321808L;
	
private static Logger logger = LoggerFactory.getLogger(BINBEMBTIF05_Action.class.getName());
	...
	public String binbembarcExec() throws Exception {
		...
		try {
			...
			flg = binBEMBTIF05_BL.tran_MemMerge(map);
			...
			if(flg == CherryBatchConstants.BATCH_SUCCESS) {
				this.addActionMessage("天猫会员合并处理正常终了");
				logger.info("******************************天猫会员合并处理正常终了***************************");
			} else if(flg == CherryBatchConstants.BATCH_WARNING) {
				this.addActionError("天猫会员合并处理警告终了");
				logger.info("******************************天猫会员合并处理警告终了***************************");
			} else if(flg == CherryBatchConstants.BATCH_ERROR) {
				this.addActionError("天猫会员合并处理异常终了");
				logger.info("******************************天猫会员合并处理异常终了***************************");
			}
		}
		return "DOBATCHRESULT";
	}
