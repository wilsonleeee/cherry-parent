/*	
 * @(#)BINBEMBTIF03_Action.java     1.0 2015/06/24		
 * 		
 ...
 */
public class BINBEMBTIF03_Action extends BaseAction{

	private static final long serialVersionUID = 2765807482991911457L;
	
	private static Logger logger = LoggerFactory.getLogger(BINBEMBTIF03_Action.class.getName());
	...
	public String binbembarcExec() throws Exception {
		...
		try {
			...
			flg = binBEMBTIF03_BL.tran_MemBind(map);
			...
			if(flg == CherryBatchConstants.BATCH_SUCCESS) {
				this.addActionMessage("天猫新会员绑定处理正常终了");
				logger.info("******************************天猫新会员绑定处理正常终了***************************");
			} else if(flg == CherryBatchConstants.BATCH_WARNING) {
				this.addActionError("天猫新会员绑定处理警告终了");
				logger.info("******************************天猫新会员绑定处理警告终了***************************");
			} else if(flg == CherryBatchConstants.BATCH_ERROR) {
				this.addActionError("天猫新会员绑定处理异常终了");
				logger.info("******************************天猫新会员绑定处理异常终了***************************");
			}
		}
		return "DOBATCHRESULT";
	}
