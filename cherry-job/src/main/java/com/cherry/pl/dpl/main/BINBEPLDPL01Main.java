...
public class BINBEPLDPL01Main {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			BINBEPLDPL01_BL binBEPLDPL01_BL = (BINBEPLDPL01_BL) ac
					.getBean("binBEPLDPL01_BL");
			...
			flg = binBEPLDPL01_BL.tran_createDataPrivilege(map);
