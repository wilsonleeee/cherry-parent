 ...
 *
 */
public class BINCPMEACT01_FN implements FunctionProvider{
	
	@Resource
	private BINCPMEACT01_BL bincpmeact01_BL;
	
	private static Logger logger = LoggerFactory.getLogger(BINCPMEACT01_FN.class.getName());
	...
	public void execute(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
		try {
			...
			int result = bincpmeact01_BL.tran_publicActive(map);
			logger.info("======================会员活动下发BATCH处理结束==========================");
