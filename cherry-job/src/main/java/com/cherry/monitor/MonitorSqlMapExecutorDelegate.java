...
public class MonitorSqlMapExecutorDelegate extends SqlMapExecutorDelegate {
     ...
     * @throws java.sql.SQLException - if the delete fails
     */
     ...
     *
     * @param sessionScope - the session
     * @throws java.sql.SQLException - if the transaction could not be started
     */
     ...
     *
     * @param sessionScope - the session
     * @throws java.sql.SQLException - if the transaction could not be committed
     */
     ...
     *
     * @param sessionScope - the session
     * @throws java.sql.SQLException - if the transaction could not be ended
     */
     ...
     * @throws java.sql.SQLException - if the batch fails
     */
