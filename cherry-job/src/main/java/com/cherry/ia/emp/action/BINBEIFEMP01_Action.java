/*
 * @(#)BINBEIFEMP01_Action.java     1.0 2010/11/12
 * 
 ...
 */
public class BINBEIFEMP01_Action extends BaseAction {
	
	private static final long serialVersionUID = 2335413329487273899L;

	private static Logger logger = LoggerFactory.getLogger(BINBEIFEMP01_Action.class.getName());
	 ...
	 * 
	 */
	public String binbeifemp01Exec() throws Exception {
		...
		try {
			...
			// 营业员列表导入batch主处理
			flg = binBEIFEMP01_BL.tran_batchBaInfo(map);
