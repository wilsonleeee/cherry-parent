/*	
 * @(#)BINBE04Job.java     1.0 2012/06/15		
 * 		
 ...
 */
public class BINBE04Job implements ApplicationContextAware{
...
//			}catch (Exception e){
//				// 刷新工作流文件有异常时停止工作
//				logger.error("刷新工作流文件异常：" + e.getMessage());
//			}
			...
			if (null != confBrandList) {
				for (Map<String, Object> brandInfo : confBrandList) {
					...
					try {
						...
						checkMap.put("fileCode", "BatchJobFlow04");
					...
					try {
						...
						String wf_name = ConvertUtil.getWfName(orgCode, brandCode, "BatchJobFlow04");
