/*	
 * @(#)BINBE02Job.java     1.0 2012/06/15		
 * 		
 ...
 */
public class BINBE02Job implements ApplicationContextAware{
			...
			if (null != confBrandList) {
				for (Map<String, Object> brandInfo : confBrandList) {
					...
					try {
						...
						checkMap.put("fileCode", "BatchJobFlow02");
					...
					try {
						...
						String wf_name = ConvertUtil.getWfName(orgCode, brandCode, "BatchJobFlow02");
