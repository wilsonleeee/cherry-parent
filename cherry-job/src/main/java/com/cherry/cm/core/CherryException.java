 ...
 * @version 
 */
public class CherryException extends Exception implements TextProvider,Serializable, LocaleProvider{
	 ...
	 */
     public CherryException(String argErrCode){
    	 ...
    	 if(errMessage==null||"null".equals(errMessage)||argErrCode.equals(errMessage)){
