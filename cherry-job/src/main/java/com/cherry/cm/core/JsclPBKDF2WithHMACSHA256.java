...
public class JsclPBKDF2WithHMACSHA256 {
...
//            String test = "{\"iv\":\"ia9l7n0un2gXEHfgHL3LkA\",\"v\":1,\"iter\":1000,\"ks\":128,\"ts\":64,\"mode\":\"ccm\",\"adata\":\"yuiop\",\"cipher\":\"aes\",\"salt\":\"w2hwk/68m/Y\",\"ct\":\"yhaUUp3fPrDohhiZjcT3F/wwJafcRxJSBl5lEGyQSmfuxb6APA0QEA\"}";
//            JsonNode rootNode = mapper.readTree(test);
...
//
//            System.out.println(new String(cipherText.getAssociatedData(),
//                    SJCL_CHARSET));
//
...
//    }
    ...
    public static String DecrptPBKDF2WithHMACSHA256(String password, String jsonParam) {
    	final SJCLCipherTextStruct cipherText;
        try {
            ObjectMapper mapper = new ObjectMapper();
            JsonNode rootNode = mapper.readTree(jsonParam);
            cipherText = readJsonCipherText(rootNode);
        } catch (IOException e) {
            throw new IllegalArgumentException(e);
        }
