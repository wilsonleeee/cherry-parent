/*	
 * @(#)BINBAT166_BL.java     1.0 @2016-09-26
 * 		
...
* @version  2016-09-26
*/
public class BINBAT166_BL {
	
	private static Logger logger = LoggerFactory.getLogger(BINBAT166_BL.class.getName());
	...
	private int addESOrderMain(Map<String, Object> orderMainMap, Map<String, Object> ordersMap, Map<String, Object> params, Map<String, Object> searchMap) {
        ...
        // 退款理由
        orderMainMap.put("comments", binBAT165_Service.subStringByLimit(
