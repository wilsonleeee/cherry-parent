 ...
 * 
 */
public class BINBAT133_FN implements FunctionProvider {

	private static Logger logger = LoggerFactory.getLogger(BINBAT133_FN.class.getName());
	
	/** 产品退库申请单详细数据导出到标准接口表BL */
	...
	public void execute(Map transientVars, Map args, PropertySet ps)
		...
		try {
			...
			int flag = binbat133_BL.tran_binbat133(transientVars);
			...
			logger.info("******************************产品退库申请单导出(标准接口)处理结束***************************");
		}
