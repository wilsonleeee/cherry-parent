/*	
 * @(#)BINOTYIN01_Service.java     1.0 @2013-4-16
 * 		
...
public class BINOTYIN09_Service extends BaseService {
	...
	public int searchProductId(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.searchProductId");
	...
	public int searchProductIdByUnitCode(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.searchProductIdByUnitCode");
		return CherryBatchUtil.Object2int(baseServiceImpl.get(map));
	}
	...
	public int insertProductInfo(Map<String, Object> productMap) {
		...
		paramMap.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.insertProductInfo");
	...
	public int updateProductInfo(Map<String, Object> productMap) {
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.putAll(productMap);
		paramMap.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.updateProductInfo");
	...
	public void delProductPrice(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.delProductPrice");
	...
	public void updatePrtPrice(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.updatePrtPrice");
	...
	public void insertProductPrice(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID,"BINOTYIN09.insertProductPrice");
	...
	public String selProductPrice(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.selProductPrice");
	...
	public int updProductPrice(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.updProductPrice");
	...
	public int insertProductVendor(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.insertProductVendor");
	...
	public int insertPrmProductVendor(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.insertPrmProductVendor");
		return baseServiceImpl.saveBackId(map);
	}
	...
	public Map<String, Object> getProductVendorInfo(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.getProductVendorInfo");
	...
	public Map<String, Object> getPrmProductVendorInfo(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.getPrmProductVendorInfo");
		return (Map<String, Object>)baseServiceImpl.get(map);
	}
	...
	public int updPrtVendor(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.updPrtVendor");
		return baseServiceImpl.update(map);
	}
	...
	public int updPrmVendor(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.updPrmVendor");
		return baseServiceImpl.update(map);
	}
	...
	public void updPrtBarCode(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.updPrtBarCode");
		baseServiceImpl.update(map);
	}
	...
	public void updPrmBarCode(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.updPrmBarCode");
		baseServiceImpl.update(map);
	}
	...
	public void updatePrtClosingTime(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.updatePrtClosingTime");
		baseServiceImpl.update(map);
	}
	...
	public void updatePrmClosingTime(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOTYIN09.updatePrmClosingTime");
		baseServiceImpl.update(map);
	}
	...
	public int getCatPropId1(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.getCatPropId1");
		return CherryBatchUtil.Object2int(baseServiceImpl.get(map));
	}
	...
	public int getCatPropId2(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.getCatPropId2");
		return CherryBatchUtil.Object2int(baseServiceImpl.get(map));
	}
	...
	public int getCatPropId3(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.getCatPropId3");
		return CherryBatchUtil.Object2int(baseServiceImpl.get(map));
	}
	...
	public int addCatProperty(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.addCatProperty");
		return baseServiceImpl.saveBackId(map);
	}
	...
	public int updProp(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID, "BINOTYIN09.updProp");
		return baseServiceImpl.update(map);
	}
	...
	public void delPrtCategory(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.delPrtCategory");
		baseServiceImpl.remove(map);
	}
	...
	public int getCatPropValId1(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.getCatPropValId1");
		return CherryBatchUtil.Object2int(baseServiceImpl.get(map));
	}
	...
	public int getCatPropValId2(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID,"BINOTYIN09.getCatPropValId2");
		return CherryBatchUtil.Object2int(baseServiceImpl.get(map));
	}
	...
	public int addPropVal(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID, "BINOTYIN09.addPropVal");
		return baseServiceImpl.saveBackId(map);
	}	
	...
	public int updPropVal(Map<String, Object> map) {
		map.put(CherryBatchConstants.IBATIS_SQL_ID, "BINOTYIN09.updPropVal");
		return baseServiceImpl.update(map);
	}
