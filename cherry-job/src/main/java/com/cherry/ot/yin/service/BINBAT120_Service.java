/*	
 * @(#)BINOTBAT120_Service.java     1.0 @2015-8-13		
 * 		
...
public class BINBAT120_Service extends BaseService {
	...
	public int updTrxStatusNullTo1ForOT(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINBAT120.updTrxStatusNullTo1ForOT");
	...
	public List<String> getDocEntryListForOT(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINBAT120.getDocEntryListForOT");
	...
	public int updTrxStatusForOT(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINBAT120.updTrxStatusForOT");
		return tpifServiceImpl.update(map);
	}
	...
	public List<Map<String,Object>> getExportTransListForOT(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINBAT120.getExportTransListForOT");
		return tpifServiceImpl.getList(map);
	}
	...
	public Map<String,Object> getProPrmPriceByUB(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINBAT120.getProPrmPriceByUB");
	...
	public String getBrandCode(Map<String, Object> map){
		...
		parameterMap.put(CherryBatchConstants.IBATIS_SQL_ID,"BINBAT120.getBrandCode");
