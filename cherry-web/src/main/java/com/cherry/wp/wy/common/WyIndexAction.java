package com.cherry.wp.wy.common;
...
public class WyIndexAction extends BaseAction{

	/**
	 * 
	 */
	private static final long serialVersionUID = -5284803260027247960L;
	
	/**异常日志*/
	private static final Logger logger = LoggerFactory.getLogger(WyIndexAction.class);
