...
import com.cherry.wp.wr.srp.form.BINOLWRSRP07_Form;
 ...
 */
public class BINOLWRSRP07_Action extends BaseAction implements ModelDriven<BINOLWRSRP07_Form> {
	
	//private static final long serialVersionUID = 367477792025605399L;
	
	private static Logger logger = LoggerFactory.getLogger(BINOLWRSRP07_Action.class.getName());
	
	@Resource
	private BINOLWRCOM01_Service binOLWRCOM01_Service;
	
	@Resource
	private BINOLWRSRP07_IF binOLWRSRP07_BL;
	...
	public String search() throws Exception {
		...
		storeRankingCountInfo = binOLWRSRP07_BL.getStoreRankingCountInfo(map);
		int count = 0;
		if(storeRankingCountInfo != null) {
			count = (Integer)storeRankingCountInfo.get("count");
		}
		form.setITotalDisplayRecords(count);
		form.setITotalRecords(count);
		if(count != 0) {
			storeRankingList = binOLWRSRP07_BL.getStoreRankingList(map);
		}
		return SUCCESS;
	}
    ...
    public String exportExcel() throws Exception {
        ...
        try {
    		...
    		// 获取导出参数
    		Map<String, Object> exportMap = binOLWRSRP07_BL.getExportParam(map);
    		
    		String zipName = CherryUtil.getResourceValue("wp", "BINOLWRSRP07", language, "downloadFileName");
    		downloadFileName = zipName+".zip";
            
    		// 导出excel处理
        	byte[] byteArray = binOLCM37_BL.exportExcel(exportMap, binOLWRSRP07_BL);
    ...
    public String exportCsv() throws Exception {
    	...
    	try {
    		...
    		String tempFilePath = binOLWRSRP07_BL.exportCSV(map);
	...
	private Map storeRankingCountInfo;
	
	private List<Map<String, Object>> storeRankingList;
	...
	public Map getStoreRankingCountInfo() {
		return storeRankingCountInfo;
	}

	public void setStoreRankingCountInfo(Map storeRankingCountInfo) {
		this.storeRankingCountInfo = storeRankingCountInfo;
	}
	
	public List<Map<String, Object>> getStoreRankingList() {
		return storeRankingList;
	}

	public void setStoreRankingList(List<Map<String, Object>> storeRankingList) {
	...
	/** 销售分类统计Form **/
	private BINOLWRSRP07_Form form = new BINOLWRSRP07_Form();

	@Override
	public BINOLWRSRP07_Form getModel() {
		return form;
	}
