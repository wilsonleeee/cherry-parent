 ...
 */
public class BINOLPTJCS26_BL implements BINOLPTJCS26_IF {

	@Resource
	private BINOLPTJCS26_Service binOLPTJCS26_Service;
	...
	public List<Map<String, Object>> getBarCodeList(Map<String, Object> map) {
		...
		return binOLPTJCS26_Service.getBarCodeList(praMap);
	}
	...
	public List<Map<String, Object>> getCateList(Map<String, Object> map) {
		...
		return binOLPTJCS26_Service.getCateList(map);
	}
	...
	public Map<String, Object> getDetail(Map<String, Object> map) {
		...
		return binOLPTJCS26_Service.getDetail(map);
	}
	...
	public List<Map<String, Object>> getSellPriceList(Map<String, Object> map) {
		...
		return binOLPTJCS26_Service.getSellPriceList(map);
	}
	...
	public List<Map<String, Object>> getImgList(Map<String, Object> map) {
		...
		List<Map<String, Object>> list = binOLPTJCS26_Service.getImgList(map);
	...
	public List<Map<String, Object>> getBOMList(Map<String, Object> map) {
		return binOLPTJCS26_Service.getBOMList(map);
	}
	...
	public List<Map<String, Object>> getPrtBCHistoryList(Map<String, Object> map){
    	return binOLPTJCS26_Service.getPrtBCHistoryList(map);
    }
