/*  
 * @(#)BINOLPTJCS47_Action.java     1.0 2014/08/31      
 *      
...
public class BINOLPTJCS47_Action extends BaseAction implements ModelDriven<BINOLPTJCS45_Form>{
	...
	public String save()  throws Exception {
		...
		try{
			// 修改方案
			binOLPTJCS47_IF.tran_updPrtPriceSolu(map);
		} catch (Exception e) {
			// 更新失败场合
