...
public class BINOLPTJCS21_Action extends BaseAction implements ModelDriven<BINOLPTJCS18_Form> {
...
//		String solutionCode = (String)codeMap.get("value1")+binOLCM15_BL.getSequenceId(autoMap);
		...
		String solutionCode = binOLPTJCS21_IF.getSolutionCode(map);
	...
	public String save() throws Exception {
		...
		binOLPTJCS21_IF.tran_addPrtPriceSolu(map);
//		
		//处理成功
