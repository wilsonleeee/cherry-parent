/*  
 * @(#)BINOLPTJCS47_BL.java     1.0 2014/08/31      
 *      
...
import com.cherry.pt.jcs.service.BINOLPTJCS47_Service;
import com.cherry.ss.common.base.SsBaseBussinessLogic;

public class BINOLPTJCS47_BL extends SsBaseBussinessLogic implements BINOLPTJCS47_IF{
	@Resource
	private BINOLPTJCS47_Service binOLPTJCS47_Service;
	@Resource
	...
	public int tran_updPrtPriceSolu(Map<String, Object> map) throws Exception{
		...
		return binOLPTJCS47_Service.updPrtPriceSolution(map);
	}
}