...
import com.cherry.pt.jcs.service.BINOLPTJCS26_Service;
 ...
 */
public class BINOLPTJCS36_BL implements BINOLPTJCS36_IF {
	...
	public List<Map<String, Object>> getBarCodeList(Map<String, Object> map) {
		...
		return binOLPTJCS36_Service.getBarCodeList(praMap);
	}
	...
	public List<Map<String, Object>> getPrtSoluDetailCateList(Map<String, Object> map) {
		...
		return binOLPTJCS36_Service.getPrtSoluDetailCateList(map);
	}
	...
	public List<Map<String, Object>> getCateList(Map<String, Object> map) {
		...
		return binOLPTJCS36_Service.getCateList(map);
	}
	...
	public Map<String, Object> getDetail(Map<String, Object> map) {
		...
		return binOLPTJCS36_Service.getDetail(map);
	}
	...
	public Map<String,Object> getSoluDeatilPrtInfo(Map<String,Object> map){
		return binOLPTJCS36_Service.getSoluDeatilPrtInfo(map);
	}
	...
	public List<Map<String, Object>> getSellPriceList(Map<String, Object> map) {
		...
		return binOLPTJCS36_Service.getSellPriceList(map);
	}
	...
	public List<Map<String, Object>> getImgList(Map<String, Object> map) {
		...
		List<Map<String, Object>> list = binOLPTJCS36_Service.getImgList(map);
	...
	public List<Map<String, Object>> getBOMList(Map<String, Object> map) {
		return binOLPTJCS36_Service.getBOMList(map);
	}
	...
	public List<Map<String, Object>> getPrtBCHistoryList(Map<String, Object> map){
    	return binOLPTJCS36_Service.getPrtBCHistoryList(map);
    }
