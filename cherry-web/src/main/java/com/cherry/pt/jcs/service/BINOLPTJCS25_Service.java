 ...
 * 
 */
public class BINOLPTJCS25_Service extends BaseService {
	...
	public int updProduct(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.updProduct");
	...
	public void delProductPrice(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.delProductPrice");
	...
	public void updProductVendor(Map<String, Object> map,String validflag) {
		...
		paramMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.updProductVendor");
	...
	public List<Map<String, Object>> getBarCodeList(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.getBarCodeList");
	...
	public Map<String, Object> getProductVendorInfo(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.getProductVendorInfo");
	...
	public Map<String, Object> getProductPrice(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.getProductPrice");
		return (Map<String, Object>)baseServiceImpl.get(map);
	}
	...
	public Map<String, Object> getPreProductPrice(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.getPreProductPrice");
		return (Map<String, Object>)baseServiceImpl.get(map);
	}
	...
	public void upProPrices(Map<String, Object> map) {
		Map<String, Object>	paramMap = new HashMap<String, Object>(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.upProPrices");
		baseServiceImpl.update(paramMap);
	}
	...
	public void delPrtCategory(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.delPrtCategory");
		baseServiceImpl.remove(map);
	}
	...
	public List getExistPvCN(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS25.getExistPvCN");
