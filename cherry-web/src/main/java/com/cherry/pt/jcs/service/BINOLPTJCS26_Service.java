 ...
 *
 */
public class BINOLPTJCS26_Service extends BaseService {
	...
	public Map<String,Object> getDetail(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS26.getDetail");
	...
	public List<Map<String,Object>> getBarCodeList(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS26.getBarCodeList");
	...
	public List<Map<String,Object>> getCateList(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS26.getCateList");
		return baseServiceImpl.getList(map);
	}
	...
	public List<Map<String,Object>> getSellPriceList(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS26.getSellPriceList");
		return baseServiceImpl.getList(map);
	}
	...
	public List<Map<String,Object>> getImgList(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS26.getImgList");
		return baseServiceImpl.getList(map);
	}
	...
	public List<Map<String,Object>> getBOMList(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS26.getBOMList");
		return baseServiceImpl.getList(map);
	}
	...
	public List<Map<String, Object>> getPrtBCHistoryList(Map<String, Object> map) {
        map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS26.getPrtBCHistoryList");
        return baseServiceImpl.getList(map);
    }
}
