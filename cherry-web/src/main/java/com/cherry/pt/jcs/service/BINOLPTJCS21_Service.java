...
public class BINOLPTJCS21_Service {
	@Resource
	...
	public int insertPrtPriceSolu(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS21.insertPrtPriceSolu");
	...
	public String getCount(Map<String, Object> map) {
		...
		parameterMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS21.getCount");
