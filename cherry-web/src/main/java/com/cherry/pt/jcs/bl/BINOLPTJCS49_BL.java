/*  
 * @(#)BINOLPTJCS49_BL.java     1.0 2014/08/31      
 *      
...
import com.cherry.pt.jcs.service.BINOLPTJCS49_Service;
...
public class BINOLPTJCS49_BL extends SsBaseBussinessLogic implements BINOLPTJCS49_IF{
	@Resource
	private BINOLPTJCS49_Service binOLPTJCS49_Service;
	...
	public Map<String, Object> getSolutionInfo(Map<String, Object> map) {
		return binOLPTJCS49_Service.getSolutionInfo(map);
	}
	...
	public int getSolutionInfoDetailCount(Map<String, Object> map){
		return binOLPTJCS49_Service.getSolutionInfoDetailCount(map);
	}
	...
	public List getSolutionInfoDetailList(Map<String, Object> map){
		return binOLPTJCS49_Service.getSolutionInfoDetailList(map);
	}
	...
	public Map<String, Object> tran_addPrtPriceSoluDetail(Map<String, Object> map,BINOLPTJCS45_Form form) throws JSONException,Exception{
...
//			map.put("priceJson", priceJson);
	 ...
	 */
	@CacheEvict(value="CherryProductCache",allEntries=true,beforeInvocation=false)
	public Map<String, Object> tran_editPrtPriceSoluDetail(Map<String, Object> map,BINOLPTJCS45_Form form)  throws JSONException,Exception{
...
//		map.put("memPrice", form.getMemPrice());
	 ...
	 */
	@CacheEvict(value="CherryProductCache",allEntries=true,beforeInvocation=false)
	public Map<String, Object> tran_addPrtPriceSoluCateDetail(Map<String, Object> map,BINOLPTJCS45_Form form)  throws JSONException,Exception{
		
		String businessDate = binOLPTJCS49_Service.getBusDate(map);
		...
		// 删除产品方案绑定的产品分类
		binOLPTJCS49_Service.delPrtSoluDetailCate(map);
...
//						binOLPTJCS03_Service.insertPrtCategory(cate);
						...
						if(!CherryUtil.isBlankList(propValArrList)){
							for(String propVal : propValArrList){
								...
								binOLPTJCS49_Service.insertCate(cate);
							}
						}
					}
				}
		...
		List<Map<String, Object>> prtForPrtSoluDetailDiff = binOLPTJCS49_Service.getPrtForPrtSoluDetailDiff(map);
		if (!CherryUtil.isBlankList(prtForPrtSoluDetailDiff)) {
			for(Map<String, Object> diffMap : prtForPrtSoluDetailDiff){
				...
				if("add".equals(modifyFlag)){
					...
					// 1: 插入产品方案明细表
					binOLPTJCS49_Service.mergeProductPriceSolutionDetail(diffMap);
				...
				// 取得当前方案明细减少的产品,merge到产品方案部门关系表 validFlag = 0,version = tversion +1
					...
					// 1: 将方案明细表的产品数据无效掉
					binOLPTJCS49_Service.updPrtSoluDetail(diffMap);
				}
			}
	...
	public List<Map<String, Object>> getCateList(Map<String, Object> map) {
		...
		return binOLPTJCS49_Service.getCateList(map);
	}
}
