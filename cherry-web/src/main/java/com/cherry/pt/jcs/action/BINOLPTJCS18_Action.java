/*  
 * @(#)BINOLPTJCS18_Action.java     1.0 2014/08/31      
 *      
...
import com.cherry.pt.jcs.interfaces.BINOLPTJCS18_IF;
 ...
 *
 */
public class BINOLPTJCS18_Action extends BaseAction implements
ModelDriven<BINOLPTJCS18_Form>{
	...
	@Resource
	private BINOLPTJCS18_IF binOLPTJCS18_IF;
...
//		}
		...
		// 取得总数
		int count = binOLPTJCS18_IF.searchSolutionCount(searchMap);
		if (count > 0) {
			// 取得渠道List
			form.setSolutionList(binOLPTJCS18_IF.searchSolutionList(searchMap));
		}
		// form表单设置
...
//		isPosCloud = "";
	...
	private Map<String, Object> getParamMap() {
		...
		// 作成程序名
		map.put(CherryConstants.UPDATEPGM, "BINOLPTJCS18");	
		return map;
	}
    ...
    public String disOrEnableSolu() throws Exception {
		...
		binOLPTJCS18_IF.tran_disOrEnableSolu(map);
