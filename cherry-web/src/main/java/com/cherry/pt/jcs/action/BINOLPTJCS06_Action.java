 ...
 */
public class BINOLPTJCS06_Action extends BaseAction{
	...
	public String init() throws Exception {
		...
		// 取得分类List
		cateList = binolptjcs06_IF.getCateList(map);
		// 取得销售价格List
		sellPriceList = binolptjcs06_IF.getSellPriceList(map);
		// 取得图片List
		imgList = binolptjcs06_IF.getImgList(map);
		// 产品类型
		...
		// 产品编码条码修改履历
		prtBCHistoryList = binolptjcs06_IF.getPrtBCHistoryList(map);
