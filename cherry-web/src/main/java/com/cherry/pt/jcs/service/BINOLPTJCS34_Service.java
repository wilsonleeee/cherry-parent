...
public class BINOLPTJCS34_Service extends BaseService {
	...
	public int getProCount(Map<String, Object> map) {
		...
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getProCount");
	...
	public Map<String, Object> getPrtBarCodeVF(Map<String, Object> map) {
		...
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getPrtBarCodeVF");
	...
	public List<Map<String, Object>> getProList (Map<String, Object> map) {
		...
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getProList");
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getPrtListByPram (Map<String, Object> map) {
		
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getPrtListByPram");
		return baseServiceImpl.getList(map);
	}
	...
	public List<Map<String, Object>> getBrandList(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getBrandList");
		return baseServiceImpl.getList(map);
	}
	...
	public List<Integer> getCatPropList(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getCatPropList");
		return baseServiceImpl.getList(map);
	}
	...
	public List<Map<String, Object>> getCateValList(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getCateValList");
		return baseServiceImpl.getList(map);
	}
	/**
	 * 取得path下级分类数
	...
	public int getChildCount(Map<String, Object> map) {
		...
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getChildCount");
		return baseServiceImpl.getSum(map);
	}
	/**
     * 取得产品信息List（Excel）
    ...
    public List<Map<String, Object>> getProductInfoListExcel(Map<String, Object> map) {
        map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getProductInfoListExcel");
        return baseServiceImpl.getList(map);
    }
    ...
    public List<Map<String,Object>> getPrtCatPropertyList(Map<String, Object> map){
        map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getPrtCatPropertyList");
        return baseServiceImpl.getList(map);
    }
    ...
    public List<Map<String,Object>> getLocateCatHigher(Map<String, Object> map){
    	map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getLocateCatHigher");
    	return baseServiceImpl.getList(map);
    }
    ...
    public List<Map<String,Object>> getCatSortByBing(Map<String, Object> map){
    	map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getCatSortByBing");
    	return baseServiceImpl.getList(map);
    }
	...
	public String getLocationPrtCatValId(Map<String, Object> map) {
		...
		parameterMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getLocationPrtCatValId");
	...
	public int updProduct(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.updProduct");
	...
	public int updProductVersion(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.updProductVersion");
		return baseServiceImpl.update(map);
	}
	...
	public int updPrtSolutionDetail(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.updPrtSolutionDetail");
		return baseServiceImpl.update(map);
	}
	...
	public List<Map<String,Object>> getPrtVendorDetailList(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getPrtVendorDetailList");
		return baseServiceImpl.getList(map);
	}
	...
	public Map<String,Object> getPrtVendorInfo(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getPrtVendorInfo");
		return (Map<String, Object>) baseServiceImpl.get(map);
	}
	...
	public Map<String,Object> getPrtDetailInfo(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getPrtDetailInfo");
		return (Map<String, Object>) baseServiceImpl.get(map);
	}
	...
	public int updPrtVendor(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.updPrtVendor");
		return baseServiceImpl.update(map);
	}
	...
	public void updateClosingTime(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID,"BINOLPTJCS34.updateClosingTime");
	...
	public void insertPrtBarCode(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID,"BINOLPTJCS34.insertPrtBarCode");
	...
	public void updPrtBarCode(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.updPrtBarCode");
		baseServiceImpl.update(map);
	}
	...
	public int delProductInfo(Map<String, Object> map) {
		Map<String, Object> parameterMap = new HashMap<String, Object>();
		parameterMap.putAll(map);
		parameterMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.delProductInfo");
	...
	public Map<String,Object> getDepartSolu(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getDepartSolu");
		return (Map<String, Object>) baseServiceImpl.get(map);
	}
	...
	public List<Map<String, Object>> getProductList(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID,"BINOLPTJCS34.getProductList");
		return baseServiceImpl.getList(map);
	}
	...
	public Integer disProductSCS(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID,"BINOLPTJCS34.disProductSCS");
	...
	public Map<String,Object> mergeProductSCS(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.mergeProductSCS");
	...
	public int delIFProductInfo(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.delIFProductInfo");
	...
	public void addProductSCS(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID,"BINOLPTJCS34.addProductSCS");
	...
	public int getBarCodeCount(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getBarCodeCount");
		return baseServiceImpl.getSum(map);
	}
	...
	public Map<String,Object> getBarCodeModify(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS34.getBarCodeModify");
		return (Map<String, Object>)baseServiceImpl.get(map);
	}
	...
	public void addProductSetting(Map<String, Object> map) {
		map.put(CherryConstants.IBATIS_SQL_ID,"BINOLPTJCS34.addProductSetting");
		baseSynchroService.save(map);
	}
