/*  
 * @(#)BINOLPTJCS18_BL.java     1.0 2014/08/31      
 *      
...
import com.cherry.pt.jcs.service.BINOLPTJCS18_Service;
...
public class BINOLPTJCS18_BL extends SsBaseBussinessLogic implements BINOLPTJCS18_IF{
		@Resource
		private BINOLPTJCS18_Service binOLPTJCS18_Service;
		...
		public int searchSolutionCount(Map<String, Object> map) {
			return binOLPTJCS18_Service.getSolutionCount(map);
		}
		/**
		 * 取得方案List
		 * 
		...
		public List searchSolutionList(Map<String, Object> map) {
			return binOLPTJCS18_Service.getSolutionList(map);
		}
	    /**
	     * 方案停用/启用
	     * 
	    ...
	    public int tran_disOrEnableSolu(Map<String, Object> map) throws CherryException, JSONException,Exception{
	        ...
	        return binOLPTJCS18_Service.disOrEnableSolu(map);
	    }
