 ...
 */
public class BINOLPTJCS48_Service extends BaseService {
	...
	public Map<String,Object> getProductInfo(Map<String, Object> map) {
		...
		parameterMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.getProductInfo");
	...
	public List<Map<String,Object>> getProductInfoList(Map<String, Object> map) {
		Map<String, Object> parameterMap = new HashMap<String, Object>();
		parameterMap.putAll(map);
		parameterMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.getProductInfoList");
	...
	public int delPrtPriceSoluDetail(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.delPrtPriceSoluDetail");
	...
	public int delProductDepartPrice(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.delProductDepartPrice");
		return baseServiceImpl.remove(map);
	}
	...
	public List getNewSoluDetailProductDepartPriceList(Map<String, Object> map) {
		Map<String, Object> parameterMap = new HashMap<String, Object>();
		parameterMap.putAll(map);
		parameterMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.getNewSoluDetailProductDepartPriceList");
		return baseServiceImpl.getList(parameterMap);
	}
	...
	public String mergeProductDepartInfo(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.mergeProductDepartInfo");
	...
	public Map<String,Object> mergePrtPriceSoluDetail(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.mergePrtPriceSoluDetail");
	...
	public int updProductDepart(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.updProductDepart");
	...
	public int updPrtPriceSoluDetail(Map<String,Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.updPrtPriceSoluDetail");
		return baseServiceImpl.update(map);
	}
	...
	public List getPrtPriceSolutionList(Map<String, Object> map) {
		...
		parameterMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.getPrtPriceSolutionList");
		return baseServiceImpl.getList(parameterMap);
	}
	...
	public void insertProductPrice(Map<String, Object> map){
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTJCS48.insertProductPrice");
