/*  
 * @(#)BINOLPTUNQ02_Form.java    1.0 2016-06-26     
 *      
 ...
 */
public class BINOLPTUNQ02_Form extends DataTable_BaseForm implements Serializable{

	private static final long serialVersionUID = 2137063709730408297L;
	...
	/** 产品唯一码（页面输入）  */
	private String pointUniqueCodeSrh;
	
	/** 关联唯一码（页面输入）  */
	private String relUniqueCodeSrh;
	
	/** 箱码（页面输入）  */
	private String boxCodeSrh;
	...
	public String getPointUniqueCodeSrh() {
		return pointUniqueCodeSrh;
	}

	public void setPointUniqueCodeSrh(String pointUniqueCodeSrh) {
		this.pointUniqueCodeSrh = pointUniqueCodeSrh;
	}

	public String getRelUniqueCodeSrh() {
		return relUniqueCodeSrh;
	}

	public void setRelUniqueCodeSrh(String relUniqueCodeSrh) {
		this.relUniqueCodeSrh = relUniqueCodeSrh;
	}

	public String getBoxCodeSrh() {
		return boxCodeSrh;
	}

	public void setBoxCodeSrh(String boxCodeSrh) {
		this.boxCodeSrh = boxCodeSrh;
	}
