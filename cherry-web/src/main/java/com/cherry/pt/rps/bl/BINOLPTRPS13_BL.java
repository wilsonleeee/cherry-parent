...
import com.cherry.pt.rps.service.BINOLPTRPS13_Service;
/**
 * 销售记录查询一览BINOLPTRPS13_BL
 * @author zgl
 * @version 1.0 2011/03/16
 * 
 * */
public class BINOLPTRPS13_BL implements BINOLPTRPS13_IF, BINOLCM37_IF {
	
	@Resource(name="binOLMOCOM01_BL")
	private BINOLMOCOM01_IF binOLMOCOM01_BL;
	
	@Resource(name="binOLPTRPS13_Service")
	private BINOLPTRPS13_Service binolptrps13Service;
	...
	private final static String[][] proArray = {
			...
			{ "unitCode", "RPS13_unitCode", "20", "", "" },// 厂商编码
	...
	public int getSaleRecordCount(Map<String, Object> map) {
		return binolptrps13Service.getSaleRecordCount(map);
	}

	//获取销售记录LIST
	public List<Map<String, Object>> getSaleRecordList(Map<String, Object> map) {
		return binolptrps13Service.getSaleRecordList(map);
	}
	...
	public Map<String, Object> getSumInfo(Map<String, Object> map) {
		List<Map<String, Object>> sumInfoList = binolptrps13Service
				.getSumInfo(map);
		...
		if ("SR".equals(map.get("saleType"))) {
			...
			if(map.get("isShow").equals("1")){//需要显示统计成本价
				sumInfoMap.put("sumCostPrice", 0 - Double.parseDouble(String
						.valueOf(sumInfoMap.get("sumCostPrice"))));
			}
		}
		return sumInfoMap;
	}
	...
	public List<Map<String,Object>> getSaleProPrmList(Map<String,Object> map){
		List<Map<String, Object>> saleProPrmLis = binolptrps13Service
	...
	public Map<String,Object> getSaleProPrmCostPriceList(Map<String,Object> map){
		Map<String, Object> saleProPrmLis = binolptrps13Service
				.getSaleProPrmCostPriceList(map);
	...
	public String indSearchPrmPrt(Map<String, Object> map){
		//取销售商品信息
		List<Map<String, Object>> activeList = binolptrps13Service.indSearchPrmPrt(map);
		// 转化List为所需要的String类型
	...
	public byte[] exportExcel(Map<String, Object> map) throws Exception {
		//需导出数据总量
		int dataLen = binolptrps13Service.getExportDetailCount(map);
		map.put("dataLen", dataLen);
//		map.put("batchPageLen", 101);
		BINOLMOCOM01_IF.ExcelParam ep = new BINOLMOCOM01_IF.ExcelParam();
		//必须设置sqlID（必须）,用于批查询
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLPTRPS13.getExportDetailList");
		ep.setMap(map);
	...
	public Map<String, Object> getExportParam(Map<String, Object> map) {
        ...
        String[][] titleRows = {
    			...
    			{ "unitCode", binOLCM37_BL.getResourceValue("BINOLPTRPS13", language, "RPS13_unitCode"), "20", "", "" },// 厂商编码
    			...
    			{ "billModel", binOLCM37_BL.getResourceValue("BINOLPTRPS13", language, "RPS14_billModel"), "20", "", "1326" }, // 单据模式
    			{ "dataSource", binOLCM37_BL.getResourceValue("BINOLPTRPS13", language, "RPS14_dataSource"), "20", "", "" }, // 原始数据来源
        };
        String organizationInfoID = ConvertUtil.getString(map.get("organizationInfoId"));
        String brandInfoID = ConvertUtil.getString(map.get("brandInfoId"));
        String configValue = binOLCM14_BL.getConfigValue("1140", organizationInfoID, brandInfoID);
	...
	public void updateInvoiceFlag(List<Map<String, Object>> list) throws Exception {
		...
		binolptrps13Service.updateInvoiceFlag(list);
	}
	...
	public List<Map<String, Object>> getPayTypeList(Map<String, Object> map) {
		return binolptrps13Service.getPayTypeList(map);
	}
	...
	public List<Map<String, Object>> getDataList(Map<String, Object> map)
		...
		if("".equals(exportType)) {
			return binolptrps13Service.getExportDetailList(map);
		} else if("1".equals(exportType)) {
			return binolptrps13Service.getExportSaleRecordList(map);
		} else if("2".equals(exportType)) {
			return binolptrps13Service.getExprotDetailListFilterKD(map);
		}
		return binolptrps13Service.getExportDetailList(map);
	}
	...
	public int getExportDetailCount(Map<String, Object> map) {
		return binolptrps13Service.getExportDetailCount(map);
	}
	
	@Override
	public int getExportDetailFilterKDCount(Map<String, Object> map) {
		return binolptrps13Service.getExportDetailFilterKDCount(map);
	}
