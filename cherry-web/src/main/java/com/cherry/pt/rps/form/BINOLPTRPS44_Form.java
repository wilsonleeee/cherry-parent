 ...
 */
public class BINOLPTRPS44_Form extends BINOLCM13_Form {
	...
	/**选中的产品条码组*/
	private String selPrtBarCodeArr;
	...
	public String getSelPrtBarCodeArr() {
		return selPrtBarCodeArr;
	}

	public void setSelPrtBarCodeArr(String selPrtBarCodeArr) {
		this.selPrtBarCodeArr = selPrtBarCodeArr;
	}
