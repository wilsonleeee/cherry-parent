...
import com.cherry.pt.rps.bl.BINOLPTRPS35_BL;
import com.cherry.pt.rps.form.BINOLPTRPS35_Form;
import com.opensymphony.xwork2.ModelDriven;

/**
 * 
 * @ClassName: BINOLPTRPS35_Action 
 * @Description: TODO(柜台月度坪效明細Action) 
 * @author menghao
 * @version v1.0.0 2015-1-12 
 *
 */
public class BINOLPTRPS35_Action extends BaseAction 
	implements ModelDriven<BINOLPTRPS35_Form> {

	private static final long serialVersionUID = 1975571425270592510L;
	
	private static Logger logger = LoggerFactory
			.getLogger(BINOLPTRPS35_Action.class.getName());
	
	private BINOLPTRPS35_Form form = new BINOLPTRPS35_Form();
	
	@Resource(name="binOLCM05_BL")
	private BINOLCM05_BL binOLCM05_BL;
	
	@Resource(name="binOLPTRPS35_BL")
	private BINOLPTRPS35_BL binOLPTRPS35_BL;
    ...
    private List<Map<String, Object>> monthPingEffectList;
	...
	public String search() throws Exception {
		...
		int count = binOLPTRPS35_BL.getMonthPingEffectCount(map);
		if(count > 0) {
			monthPingEffectList = binOLPTRPS35_BL.getMonthPingEffectList(map);
		}
		form.setITotalDisplayRecords(count);
		form.setITotalRecords(count);
		return "BINOLPTRPS35_1";
	}
	...
	public String export() throws Exception {
		try {
    		...
    		// 获取导出参数
    		Map<String, Object> exportMap = binOLPTRPS35_BL.getExportParam(map);
    		
    		String zipName = CherryUtil.getResourceValue("pt", "BINOLPTRPS35", language, "downloadFileName");
    		downloadFileName = zipName+".zip";
            
    		// 导出excel处理
        	byte[] byteArray = binOLCM37_BL.exportExcel(exportMap, binOLPTRPS35_BL);
	...
	@Override
	public BINOLPTRPS35_Form getModel() {
		// TODO Auto-generated method stub
		return form;
	}

	public List<Map<String, Object>> getMonthPingEffectList() {
		return monthPingEffectList;
	}

	public void setMonthPingEffectList(List<Map<String, Object>> monthPingEffectList) {
		this.monthPingEffectList = monthPingEffectList;
	}
