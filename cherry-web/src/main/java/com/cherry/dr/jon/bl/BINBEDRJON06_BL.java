/*	
 * @(#)BINBEDRJON06_BL.java     1.0 2011/08/25	
 * 		
 ...
 */
public class BINBEDRJON06_BL implements CampRuleExec_IF{
	
	@Resource
	private RuleEngine_IF ruleEngineIF;

	@Resource
	private CampRuleIF binbedrjon06Rule;
	...
	public void ruleExec(CampBaseDTO campBaseDTO) throws Exception {
		...
		// 会员活动规则batch处理
		ruleEngineIF.executeRuleBatch(campBaseDTO, binbedrjon06Rule);
		// 规则执行后处理
