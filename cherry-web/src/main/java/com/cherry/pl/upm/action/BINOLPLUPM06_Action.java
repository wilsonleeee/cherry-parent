/*	
 * @(#)BINOLPLUPM06_Action.java     1.0 2010/12/28		
 * 		
...
import com.cherry.pl.upm.bl.BINOLPLUPM06_BL;
import com.cherry.pl.upm.form.BINOLPLUPM06_Form;
...
public class BINOLPLUPM06_Action extends BaseAction implements
		ModelDriven<BINOLPLUPM06_Form> {

	private static final long serialVersionUID = -7163846509424446646L;

	/** 参数FORM */
	private BINOLPLUPM06_Form form = new BINOLPLUPM06_Form();

	@Resource
	private BINOLPLUPM04_BL binOLPLUPM04_BL;

	@Resource
	private BINOLPLUPM06_BL binOLPLUPM06_BL;

	/** 密码安全配置信息 */
	private Map pwConfInfo;

	public BINOLPLUPM06_Form getModel() {
		return form;
	}
	...
	public String init() throws Exception {
		...
		if (ConvertUtil.getString(CherryConstants.BRAND_INFO_ID_VALUE).equals(
				form.getBrandInfoId())
				&& null != pwConfInfo) {
			pwConfInfo.put("brandName", getText("PPL00006"));
		}
		// 取得密码组合
	...
	public String save() throws Exception {
		...
		// 更新模块
		map.put(CherryConstants.UPDATEPGM, "BINOLPLUPM06");
		try {
			// 取得密码复杂度
			binOLPLUPM04_BL.getComplexity(map);
			// 更新数据库
			binOLPLUPM06_BL.tran_updatePwConfig(map);
