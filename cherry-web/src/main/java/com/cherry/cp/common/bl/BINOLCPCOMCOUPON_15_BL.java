 ...
 */
@Component
public class BINOLCPCOMCOUPON_15_BL{

	protected static final Logger logger = LoggerFactory
			.getLogger(BINOLCPCOMCOUPON_15_BL.class);

	public static final int bitCount = 20;// 2的11次方的大质数
	
	public static final int bitCountQ = 20;// 2的10次方的大质数
	
	public static final int length = 15;// coupon位数
