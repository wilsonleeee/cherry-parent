 ...
 */
@Component
public class BINOLCPCOMCOUPON_10_1_BL {

	protected static final Logger logger = LoggerFactory
			.getLogger(BINOLCPCOMCOUPON_10_1_BL.class);

	public static final int bitCount = 17;// 2的17次方的大质数
	
	public static final int bitCountQ = 16;// 2的16次方的大质数

	
	public static final int length = 10;// coupon位数
