...
public class BINOLCPCOMCOUPON_4_BL{
	
	protected static final Logger logger = LoggerFactory
			.getLogger(BINOLCPCOMCOUPON_4_BL.class);

	public static final int bitCount = 7;// 2的7次方的大质数
	
	public static final int bitCountQ = 7;// 2的7次方的大质数
	
	public static final int length = 4;// coupon位数
