 ...
 */
public class BINOLMOWAT10_Service extends BaseService{
    /**
     * Job运行履历信息总数
     * 
     * @param map 查询条件
    ...
    public int getCountJobRun(Map<String, Object> map) {
    	...
    	map.put(CherryConstants.IBATIS_SQL_ID, "BINOLMOWAT10.getCountJobRun");
    ...
    public List<Map<String,Object>> getJobRunList(Map<String, Object> map) {
    	...
    	map.put(CherryConstants.IBATIS_SQL_ID, "BINOLMOWAT10.getJobRunList");
