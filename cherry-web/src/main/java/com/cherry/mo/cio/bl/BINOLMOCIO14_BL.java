/*  
 * @(#)BINOLMOCIO14_BL.java     1.0 2011/06/14      
 *      
 ...
 */
public class BINOLMOCIO14_BL implements BINOLMOCIO14_IF {
	
	private static Logger logger = LoggerFactory.getLogger(BINOLMOCIO14_BL.class.getName());

    @Resource(name="binOLMOCIO14_Service")
    private BINOLMOCIO14_Service binOLMOCIO14_Service;
    
    @Resource(name="binOLCM05_Service")
	private BINOLCM05_Service binOLCM05_Service;
    
    @Resource(name="counterMessageSynchro")
	...
	public List<Map<String, Object>> getAllTree(Map<String, Object> map) {
		...
		List<Map<String, Object>> counterOrganiztionIdList = binOLMOCIO14_Service
				.getCounterOrganiztionId(map);
		if ("1".equals(selMode)) {
			resultList = binOLMOCIO14_Service.getAllCounter(map);
			...
			resultList = binOLMOCIO14_Service.getDepartCntList(map);
			// 把线性的结构转化为树结构
	...
	public List<Map<String, Object>> getRegionList(Map<String, Object> map) {
		return binOLMOCIO14_Service.getRegionList(map);
	}
	...
	public List<Map<String, Object>> getChannelCntList(Map<String, Object> map) {
		// 查询区域信息List
		List<Map<String, Object>> channelList = binOLMOCIO14_Service
    ...
    public void tran_publish(List<Map<String, Object>> allowList,List<Map<String, Object>> forbiddenList,Map<String, Object> map) throws CherryException {
        ...
        String counterMessageId = ConvertUtil.getString(map.get("counterMessageId"));
        ...
        mapControlFlagParam.put("counterMessageId", counterMessageId);
        List<Map<String, Object>> listControlFlag = binOLMOCIO14_Service.getControlFlagList(mapControlFlagParam);
        ...
        delParam.put("counterMessageId", counterMessageId);
        binOLMOCIO14_Service.deleteForbidden(delParam);
        ...
        if(allowList.size() == 0 || radioControlFlag.equals(MonitorConstants.ControlFlag_Forbidden)){
			...
			for (int i = 0; i < forbiddenList.size(); i++) {
	            ...
	            if(hmControlFlag.containsKey(organizationId)){
                    ...
                    mapInsertUpdate.put("counterMessageId", counterMessageId);
                    ...
                    binOLMOCIO14_Service.insertCounterMessageForbidden(mapInsertUpdate);
                    //根据柜台对应的部门ID获取柜台code
                    String counterCode = binOLMOCIO14_Service.getCounterCode(organizationId);
        ...
        mapCounterMsgParam.put("counterMessageId", counterMessageId);
        Map<String, Object> CounterMessage = binOLMOCIO14_Service.getCounterMessage(mapCounterMsgParam);
        if(null != CounterMessage){
            ...
            binOLMOCIO14_Service.modifyPublishDate(mapPublishDateParam);
            ...
            if(null == publishDateDB || "".equals(publishDateDB)){
                ...
                param.put("CounterMessageID", counterMessageId);
                ...
                counterMessageSynchro.publishCounterMessage(param);
            }else{
                ...
                counterMessageSynchro.updForbiddenCounters(param);
            }
        }else{
    ...
    public Map<String, Object> getCounterMessage(Map<String, Object> map) {
        return binOLMOCIO14_Service.getCounterMessage(map);
    }
    ...
    public String getControlFlag(Map<String, Object> map) {
        List<Map<String,Object>> list = binOLMOCIO14_Service.getCounterOrganiztionId(map);
	...
	public List<Map<String, Object>> parseFile(File file, Map<String, Object> map)
		...
		for (int r = 1; r < dateSheet.getRows(); r++) {
			...
			// 数据库对应的柜台信息
			Map<String, Object> dbCounterInfo = binOLMOCIO14_Service.getCounterInfo(checkMap);
	...
	public List<Map<String, Object>> getContraryOrgID(Map<String, Object> map)
		...
		return binOLMOCIO14_Service.getContraryOrgID(map);
	}
}
