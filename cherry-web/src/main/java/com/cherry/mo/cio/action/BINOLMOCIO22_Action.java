/*  
 * @(#)BINOLMOCIO22_Action.java     1.0 2011/06/14      
 *      
...
import com.cherry.mo.cio.form.BINOLMOCIO22_Form;
 ...
 */
public class BINOLMOCIO22_Action extends BaseAction implements
		ModelDriven<BINOLMOCIO22_Form> {
		    
	private static final long serialVersionUID = 1490156708872085714L;

	private static Logger logger = LoggerFactory.getLogger(BINOLMOCIO22_Action.class.getName());

    /** 参数FORM */
    private BINOLMOCIO22_Form form = new BINOLMOCIO22_Form();
    
    @Resource(name="binOLMOCIO22_BL")
    private BINOLMOCIO22_IF binOLMOCIO22_BL;
    ...
    @Override
    public BINOLMOCIO22_Form getModel() {
        return form;
    }
    ...
    public String init(){
        ...
        param.put("departmentMessageId", form.getDepartmentMessageId());
        ...
        counterMessage = binOLMOCIO22_BL.getCounterMessage(param);
        //设置radio checked
        form.setRadioControlFlag(binOLMOCIO22_BL.getControlFlag(param));
        return SUCCESS;
    }
    ...
    public void getTree() throws Exception{
        ...
        if("1".equals(form.getSelMode()) || "3".equals(form.getSelMode())) {
			// 查询区域信息List
        	List<Map<String, Object>> allTree = binOLMOCIO22_BL.getAllTree(map);
			ConvertUtil.setResponseByAjax(response, allTree);
		} else if("2".equals(form.getSelMode())) {
			// 查询大区信息List
			List<Map<String, Object>> regionList = binOLMOCIO22_BL.getRegionList(map);
    ...
    public void getChannelCntTree() throws Exception {
		...
		// 查询渠道信息List
		List<Map<String, Object>> channelList = binOLMOCIO22_BL.getChannelCntList(map);
    ...
    public String publish() throws Exception{
        ...
        try{
            binOLMOCIO22_BL.tran_publish(allowList, forbiddenList, map);
            // 处理成功
	...
	private Map<String, Object> getPublishComMap() throws Exception {
		...
		map.put(CherryConstants.CREATEPGM, "BINOLMOCIO22");
		map.put(CherryConstants.UPDATEDBY, userInfo.getLoginName());
		map.put(CherryConstants.UPDATEPGM,	"BINOLMOCIO22");
    ...
    public String importCounter() throws Exception {
    	...
    	try{
    		...
    		List<Map<String, Object>> list = binOLMOCIO22_BL.parseFile(upExcel, map);
    		...
    		List<Map<String, Object>> contraryList = binOLMOCIO22_BL.getContraryOrgID(map);
