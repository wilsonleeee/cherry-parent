...
public class BINOLMBMBM18_Form extends DataTable_BaseForm{
	/** 开始时间*/
	...
	public String getImportAway() {
		return importAway;
	}

	public void setImportAway(String importAway) {
		this.importAway = importAway;
	}
