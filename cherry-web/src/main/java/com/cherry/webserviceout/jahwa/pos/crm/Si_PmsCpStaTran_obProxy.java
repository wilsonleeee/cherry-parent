...
public class Si_PmsCpStaTran_obProxy implements Si_PmsCpStaTran_ob {
  private String _endpoint = null;
  private Si_PmsCpStaTran_ob si_PmsCpStaTran_ob = null;
  ...
  private void _initSi_PmsCpStaTran_obProxy() {
    try {
      si_PmsCpStaTran_ob = (new Si_PmsCpStaTran_obServiceLocator()).getsi_PmsCpStaTran_obPort();
  ...
  public Si_PmsCpStaTran_ob getSi_PmsCpStaTran_ob() {
    if (si_PmsCpStaTran_ob == null)
      _initSi_PmsCpStaTran_obProxy();
