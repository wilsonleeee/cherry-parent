...
public class Si_PmsCpStaTran_obServiceLocator extends org.apache.axis.client.Service implements Si_PmsCpStaTran_obService {
    ...
    public Si_PmsCpStaTran_ob getsi_PmsCpStaTran_obPort() throws javax.xml.rpc.ServiceException {
    ...
    public Si_PmsCpStaTran_ob getsi_PmsCpStaTran_obPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Si_PmsCpStaTran_obBindingStub _stub = new Si_PmsCpStaTran_obBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Si_PmsCpStaTran_ob.class.isAssignableFrom(serviceEndpointInterface)) {
                Si_PmsCpStaTran_obBindingStub _stub = new Si_PmsCpStaTran_obBindingStub(new java.net.URL(si_PmsCpStaTran_obPort_address), this);
                _stub.setPortName(getsi_PmsCpStaTran_obPortWSDDServiceName());
                return _stub;
            }
        }
