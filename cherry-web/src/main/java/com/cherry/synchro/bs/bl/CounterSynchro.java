...
public class CounterSynchro implements CounterSynchro_IF {
	 ...
	 * */
	@Override
	public void addCounter(Map<String,Object> param) throws CherryException {
		try {
			param.put("Result", "OK");
			CounterSynchroService.synchroCounter(param);
			String ret = String.valueOf(param.get("Result"));
	 ...
	 * */
	@Override
	public void updCounter(Map<String,Object> param)throws CherryException {
		try {
			param.put("Result", "OK");
			CounterSynchroService.synchroCounter(param);
			String ret = String.valueOf(param.get("Result"));
	 ...
	 * */
	@Override
	public void delCounter(Map<String,Object> param) throws CherryException{
		try {
			param.put("Result", "OK");
			CounterSynchroService.delCounter(param);
			String ret = String.valueOf(param.get("Result"));
			if (!"OK".equals(ret)) {
				CherryException cex = new CherryException("ECM00035");
				cex.setErrMessage(cex.getErrMessage() + ret);
	...
	public Map<String,Object> assemblingSynchroInfo(Map<String,Object> map) throws CherryException{
