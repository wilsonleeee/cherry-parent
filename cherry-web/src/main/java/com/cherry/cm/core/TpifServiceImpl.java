...
/**
 * 第三方 TpifServiceImpl实现类
 * 
 * @author 
 * @version 1.0 2010.04.12
 */
public class TpifServiceImpl extends SqlMapClientDaoSupport implements IBaseService, Serializable {
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -4518684788361607911L;
