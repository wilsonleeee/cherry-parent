...
public class CherrySecretServlet extends HttpServlet {

	private static final long serialVersionUID = 632111374600003235L;

	private static Logger logger = LoggerFactory.getLogger(CherrySecretServlet.class.getName());

	public CherrySecretServlet() {
		super();
	}
	...
	public void init(){
		...
		for (Map<String, Object> map : list) {
			...
			try {
				...
				String str2 = CherrySecret.decryptData(brandCode,CherrySecret.encryptData(brandCode,str1));
				if(str1.equals(str2)){
					logger.error("=========================== 注意 ==========================");
					logger.error("==                                                      ==");
