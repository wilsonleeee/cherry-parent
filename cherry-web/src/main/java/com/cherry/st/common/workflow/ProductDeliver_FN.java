...
/*  
 * @(#)ProductDeliver_FN.java    1.0 2011-11-3     
 *      
...
public class ProductDeliver_FN implements FunctionProvider {
    @Resource
	...
	public void execute(Map arg0, Map arg1, PropertySet propertyset)
		...
		}else if("auditAgreeAuto_K3".equals(method)){
		    auditAgreeAuto_K3(arg0,  arg1,  propertyset);
		}else if("productSend_K3".equals(method)){
		    productSend_K3(arg0,  arg1,  propertyset);
	...
	private void startFlow(Map arg0, Map arg1, PropertySet propertyset){
        ...
        paramMap.put("CurrentUnit", "ProductDeliver_FN");
	...
	private void acceptDeliver(Map arg0, Map arg1, PropertySet propertyset){
		...
		if(null != mainData){
		 ...
		 if(CherryConstants.OS_MAINKEY_OPERATE_POS.equals(operateFlag)){
				//pos机操作，在BINBEMQMES02_BL.analyzeStockData处理收货单
    ...
    private void SD_update(Map arg0, Map arg1, PropertySet propertyset){
        ...
        //没有配置审核者或没有匹配的审核者时及审核时点击按钮时已经更新过，不需要更新
        boolean updatedSDDetailFlag = false;
        if(null != mainData.get("updatedSDDetailFlag") ){
            updatedSDDetailFlag = (Boolean) mainData.get("updatedSDDetailFlag") ;
        }
        if(null != mainData.get("BINOLSTSFH05_Form") && updatedSDDetailFlag == false){
     ...
     * @param propertyset
     */
    private void auditAgreeAuto_K3(Map arg0, Map arg1, PropertySet propertyset){
        Map<String, Object> mainData = (Map<String, Object>)arg0.get("mainData");
        Map<String, Object> pramData =  new HashMap<String, Object>();
        int productDeliverID = propertyset.getInt("BIN_ProductDeliverID");
        pramData.put("BIN_ProductDeliverID",productDeliverID);
     ...
     * @throws WorkflowException 
     */
    private void productSend_K3(Map arg0, Map arg1, PropertySet propertyset) throws WorkflowException{
        int productDeliverID = propertyset.getInt("BIN_ProductDeliverID");
        Map<String, Object> mainData = (Map<String, Object>)arg0.get("mainData");
        String userID = String.valueOf(mainData.get(CherryConstants.OS_ACTOR_TYPE_USER));
        //更新发货单状态 为已发货
