/*  
 * @(#)BINOLSTBIL17_Action.java     1.0 2012/11/28      
 *      
...
public class BINOLSTBIL17_Action extends BaseAction implements
ModelDriven<BINOLSTBIL17_Form>{

    private static final long serialVersionUID = -4253186873463728433L;

    /** 异常处理 */
	private static final Logger logger = LoggerFactory
			.getLogger(BINOLSTBIL17_Action.class);
	
    /** 参数FORM */
    private BINOLSTBIL17_Form form = new BINOLSTBIL17_Form();
    ...
    @Override
    public BINOLSTBIL17_Form getModel() {
        return form;
    }
	...
	public String export() {
        ...
        try {
            ...
            String fileName = binOLMOCOM01_BL.getResourceValue("BINOLSTBIL17", language, "downloadFileName");
            downloadFileName = fileName + ".zip";
            excelStream=new ByteArrayInputStream(binOLCM37_BL.fileCompression(binOLSTBIL17_BL.exportExcel(searchMap), fileName+".xls"));
            return SUCCESS;
        } catch (Exception e) {
    ...
    private Map<String, Object> getSearchMap() throws JSONException {
        ...
        // 退库单号
        map.put("allocationrNo", ConvertUtil.getString(form.getAllocationrNo()).trim());
        // 开始日期
        ...
        // 画面ID
        map.put("MENU_ID", form.getCurrentMenuID());
    ...
    public void exportCheck() throws Exception {
        ...
        int count = binOLSTBIL17_BL.getExportDetailCount(map);
        // Excel导出最大数据量
    ...
    public String exportCsv() throws Exception {
        ...
        try {
            ...
            if(count > maxCount) {
                ...
                String tempFilePath = binOLSTBIL17_BL.exportCSV(map);
