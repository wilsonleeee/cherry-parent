...
import com.cherry.st.bil.form.BINOLSTBIL13_Form;
...
public class BINOLSTBIL13_Action extends BaseAction implements
ModelDriven<BINOLSTBIL13_Form>{

    private static final long serialVersionUID = 3070714916051322030L;

    /** 异常处理 */
	private static final Logger logger = LoggerFactory
			.getLogger(BINOLSTBIL13_Action.class);
    /** 参数FORM */
    private BINOLSTBIL13_Form form = new BINOLSTBIL13_Form();
    ...
    @Override
    public BINOLSTBIL13_Form getModel() {
        return form;
    }
	...
	public String export() {
        ...
        try {
            ...
            String fileName = binOLMOCOM01_BL.getResourceValue("BINOLSTBIL13", language, "downloadFileName");
            downloadFileName = fileName + ".zip";
            excelStream=new ByteArrayInputStream(binOLCM37_BL.fileCompression(binOLSTBIL13_BL.exportExcel(searchMap), fileName+".xls"));
            return SUCCESS;
        } catch (Exception e) {
