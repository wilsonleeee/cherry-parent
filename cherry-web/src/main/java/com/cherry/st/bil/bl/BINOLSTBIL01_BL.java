...
import com.cherry.st.bil.service.BINOLSTBIL01_Service;
 ...
 *
 */
public class BINOLSTBIL01_BL implements BINOLSTBIL01_IF{

	@Resource
	private BINOLSTBIL01_Service binOLSTBIL01_Service;
	@Resource
	...
	private final static String[][] proArray = {
			...
			{ "mainComments", "BIL01_mainComments", "20", "", "" }, // 主单入库理由
	...
	public int getPrtInDepotCount(Map<String, Object> map) {
		return binOLSTBIL01_Service.getPrtInDepotCount(map);
	}
	...
	public List<Map<String, Object>> getPrtInDepotList(Map<String, Object> map) {
		return binOLSTBIL01_Service.getPrtInDepotList(map);
	}
	...
	public Map<String, Object> getSumInfo(Map<String, Object> map) {
		return binOLSTBIL01_Service.getSumInfo(map);
	}

	@Override
	public byte[] exportExcel(Map<String, Object> map) throws Exception {
		int dataLen = binOLSTBIL01_Service.getExportDetailCount(map);
		if(dataLen <= 0){
		...
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLSTBIL01.getPrtInDepotExportList");
		ep.setMap(map);
		// 导出数据列数组
		...
		for (String con : proCondition) {
			...
			if (!"".equals(paramValue)) {
				...
				if ("billNoIF".equals(con)) {
					...
					// 审核区分
					paramName = binOLMOCOM01_BL.getResourceValue(
							"BINOLSTBIL01", language, "BIL01_verifiedFlag");
					paramValue = codeTable.getVal("1305", paramValue);
				} else if ("tradeStatus".equals(con)) {
					// 处理状态
					paramName = binOLMOCOM01_BL.getResourceValue(
							"BINOLSTBIL01", language, "BIL01_tradeStatus");
