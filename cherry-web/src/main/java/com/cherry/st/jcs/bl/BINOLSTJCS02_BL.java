...
import com.cherry.st.jcs.service.BINOLSTJCS02_Service;

/*  
 * @(#)BINOLSTJCS02_BL.java    1.0 2012-6-14     
 *      
 ...
 */
public class BINOLSTJCS02_BL implements BINOLSTJCS02_IF {
	
	@Resource
	private BINOLSTJCS02_Service binOLSTJCS02_Service;
...
//		}
		...
		depotId = binOLSTJCS02_Service.addDepot(map);
		...
		//实体仓库ID
		relMap.put("inventoryInfoId", depotId);
		// 作成者为当前用户
