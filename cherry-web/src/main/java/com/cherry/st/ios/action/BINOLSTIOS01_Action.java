/*  
 * @(#)BINOLSTIOS01_Action.java     1.0 2011/09/06      
 *      
...
import com.cherry.st.ios.form.BINOLSTIOS01_Form;
 ...
 */
public class BINOLSTIOS01_Action  extends BaseAction implements
ModelDriven<BINOLSTIOS01_Form>{

    private static final long serialVersionUID = 1618180886183092500L;
    
    /**异常日志*/
    private static final Logger logger = LoggerFactory.getLogger(BINOLSTIOS01_Action.class);

    /** 参数FORM */
    private BINOLSTIOS01_Form form = new BINOLSTIOS01_Form();
    ...
    @Override
    public BINOLSTIOS01_Form getModel() {
        return form;
    }
    ...
    public String submit() throws Exception{
        try{
            ...
            int billId = binOLSTIOS01_BL.tran_submit(map, arrList, userInfo);
    ...
    public String save() throws Exception{
        try{
            ...
            arrList.add(priceArr);
            arrList.add(referencePriceArr);
            int billId = binOLSTIOS01_BL.tran_save(map, arrList, userInfo);
            if(billId == 0){
                //抛出自定义异常：操作失败！
                throw new CherryException("ISS00005");
            }
    ...
    public boolean validateSave() throws Exception {
        ...
        //所属品牌ID
        map.put(CherryConstants.BRANDINFOID, userInfo.getBIN_BrandInfoID());
        String bussinessDate = binOLSTIOS01_BL.getBussinessDate(map);
