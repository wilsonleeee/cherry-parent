/*
 * @(#)BINOLSTIOS09_Form.java     1.0 2015-10-9
 * 
...
/**
 * 
 * @ClassName: BINOLSTIOS13_Form 
 * @Description: TODO(入库单（Excel导入）Form) 
 * @author menghao
 * @version v1.0.0 2015-10-9 
 *
 */
public class BINOLSTIOS13_Form extends DataTable_BaseForm {
	/** 品牌ID */
