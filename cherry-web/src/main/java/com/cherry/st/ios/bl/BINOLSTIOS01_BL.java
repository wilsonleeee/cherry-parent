 ...
 */
public class BINOLSTIOS01_BL  extends SsBaseBussinessLogic implements BINOLSTIOS01_IF{
    ...
    @Resource(name="binOLSTIOS01_Service")
    ...
    public int tran_save(Map<String, Object> map, List<String[]> list,UserInfo userinfo) throws Exception {
        ...
        String[] referencePriceArr = list.get(5);
    ...
    public int tran_submit(Map<String, Object> map, List<String[]> list,UserInfo userinfo) throws Exception {
		...
		pramMap.put("CurrentUnit", "BINOLSTIOS01");
		...
		//是否由云POS画面提交
		pramMap.put("WEBPOS_SUBMIT", ConvertUtil.getString(map.get("WEBPOS_SUBMIT")));
    ...
    public String getDepart(Map<String, Object> map){
        return binOLSTIOS01_Service.getDepart(map);
    }

	@Override
	public String getBussinessDate(Map<String, Object> map) {
		return binOLSTIOS01_Service.getBussinessDate(map);
	}
}
