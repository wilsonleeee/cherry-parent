/*	
 * @(#)BINOLBSCNT01_Action.java     1.0 2011/05/09		
 * 		
...
public class BINOLBSCNT01_Action extends BaseAction implements ModelDriven<BINOLBSCNT01_Form> {
	
	private static final long serialVersionUID = 944446482429999813L;
	
	/** 柜台查询画面Form */
	private BINOLBSCNT01_Form form = new BINOLBSCNT01_Form();
	...
	@Override
	public BINOLBSCNT01_Form getModel() {
		return form;
	}
