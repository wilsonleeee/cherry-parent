...
public class BINOLBSEMP50_Service extends BaseService {
	...
	public Map<String, Object> getBaInfoByNameCode(Map<String, Object> map) {
		...
		paramMap.put(CherryConstants.IBATIS_SQL_ID,
				"BINOLBSEMP50.getBaInfoByNameCode");
	...
	public int getPositionCategoryIdByCode(Map<String, Object> map) {
		...
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID,
				"BINOLBSEMP50.getPositionCategoryIdByCode");
	...
	public void insertEmployeeDepart(Map<String, Object> map) {
		...
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID,
				"BINOLBSEMP50.insertEmployeeDepart");
		baseServiceImpl.save(paramMap);
	}
	...
	public int updateEmployeeDepart(Map<String, Object> map) {
		...
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID,
				"BINOLBSEMP50.updateEmployeeDepart");
	...
	public int updateEmployeeInfo(Map<String, Object> map) {
		...
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID,
				"BINOLBSEMP50.updateEmployeeInfo");
		return baseServiceImpl.update(paramMap);
	}
	...
	public int updateEmployeeQuit(Map<String, Object> map) {
		...
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID,
				"BINOLBSEMP50.updateEmployeeQuit");
		return baseServiceImpl.update(paramMap);
	}
	...
	public int getEmployeeDepartCount(Map<String, Object> map) {
		...
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID,
				"BINOLBSEMP50.getEmployeeDepartCount");
		return baseServiceImpl.getSum(paramMap);
	}
	...
	public int delEmployeeDepart(Map<String, Object> map) {
		...
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID,
				"BINOLBSEMP50.delEmployeeDepart");
	...
	public void insertBaInfo(Map<String, Object> map) {
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLBSEMP50.insertBaInfo");
		baseServiceImpl.save(paramMap);
	}
	...
	public int updateBaInfo(Map<String, Object> map) {
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID, "BINOLBSEMP50.updateBaInfo");
		return baseServiceImpl.update(paramMap);
	}
	...
	public List<String> getBaCodeByMobile(Map<String, Object> map) {
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.putAll(map);
		paramMap.put(CherryConstants.IBATIS_SQL_ID,"BINOLBSEMP50.getBaCodeByMobile");
		return baseServiceImpl.getList(paramMap);
	}
