 ...
 */
public class BINOLBSWEM02_Service extends BaseService{

	public void save(List<Map<String, Object>> list) {
		baseServiceImpl.saveAll(list, "BINOLBSWEM02.saveOrderDiscount");
	}

	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> getDiscountConfList() {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put(CherryConstants.IBATIS_SQL_ID, "BINOLBSWEM02.getDiscountList");
