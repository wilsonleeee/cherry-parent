/*	
 * @(#)BINOLSSPRM23_Action.java     1.0 2010/12/02		
 * 		
...
import com.cherry.ss.prm.bl.BINOLSSPRM23_BL;
 ...
 *
 */
public class BINOLSSPRM23_Action extends BaseAction implements ModelDriven<BINOLSSPRM23_Form>{
	...
	private BINOLSSPRM23_Form form = new BINOLSSPRM23_Form();

	@Resource(name="binOLCM01_BL")
	private BINOLCM01_BL binolcm01BL;
	
	@Resource(name="binOLSSPRM23_BL")
	private BINOLSSPRM23_BL binolssprm23BL;
    ...
    public String save() throws JSONException{
    	UserInfo userInfo = (UserInfo) session.get(CherryConstants.SESSION_USERINFO);
    	binolssprm23BL.tran_stocktaking(form,userInfo);    	
    	//binolssprm23BL.droolsFlow(id);
    	//form.clear();
    	//重新初始化画面
    	this.init();
	...
	@Override
	public BINOLSSPRM23_Form getModel() {
		return form;
	}
