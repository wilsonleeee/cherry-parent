/*	
 * @(#)BINOLSSPRM21_BL.java     1.0 2010/10/27		
 * 		
...
public class BINOLSSPRM21_BL {
	 ...
	 * @param form
	 */
	public int tran_stocktaking(BINOLSSPRM21_Form form,UserInfo userInfo){
		//盘点部门ID
		...
		mapInventory.put("createPGM", "BINOLSSPRM21");
		mapInventory.put("updatedBy", userInfo.getLoginName());
		mapInventory.put("updatePGM", "BINOLSSPRM21");
		...
		tempMap.put("CreatePGM", "BINOLSSPRM21");
		tempMap.put("UpdatedBy", userInfo.getLoginName());
		tempMap.put("UpdatePGM", "BINOLSSPRM21");
		//insert 【促销产品盘点业务单据表】
		...
		//【促销产品入出库表】【促销产品入出库明细表�?
		userInfo.setCurrentUnit("BINOLSSPRM21");
