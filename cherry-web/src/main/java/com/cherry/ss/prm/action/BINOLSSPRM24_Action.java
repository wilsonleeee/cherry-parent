/*	
 * @(#)BINOLSSPRM24_Action.java     1.0 2010/12/03		
 * 		
...
import com.cherry.ss.prm.bl.BINOLSSPRM24_BL;
 ...
 *
 */
public class BINOLSSPRM24_Action extends BaseAction implements ModelDriven<BINOLSSPRM24_Form>{
	...
	private BINOLSSPRM24_Form form = new BINOLSSPRM24_Form();
	...
	@Resource(name="binOLSSPRM24_BL")
	private BINOLSSPRM24_BL binOLSSPRM24_BL;
    ...
    public String save() throws JSONException{
    	UserInfo userInfo = (UserInfo) session.get(CherryConstants.SESSION_USERINFO);
    	binOLSSPRM24_BL.tran_stocktaking(form,userInfo);    	
	...
	@Override
	public BINOLSSPRM24_Form getModel() {
		return form;
	}
