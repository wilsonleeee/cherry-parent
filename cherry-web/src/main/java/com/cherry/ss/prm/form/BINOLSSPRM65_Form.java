/*
 * @(#)BINOLSSPRM65_Form.java     1.0 2013/01/25
 * 
 ...
 */
public class BINOLSSPRM65_Form extends DataTable_BaseForm {
    ...
    public String getPrmInDepotID() {
		return prmInDepotID;
	}

	public void setPrmInDepotID(String prmInDepotID) {
		this.prmInDepotID = prmInDepotID;
	}
