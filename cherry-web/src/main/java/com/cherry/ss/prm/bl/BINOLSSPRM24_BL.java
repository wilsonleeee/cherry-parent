/*	
 * @(#)BINOLSSPRM24_BL.java     1.0 2010/12/03		
 * 		
...
public class BINOLSSPRM24_BL {
	 ...
	 * @param form
	 */
	public int tran_stocktaking(BINOLSSPRM24_Form form,UserInfo userInfo){
		//盘点部门ID
		...
		mapInventory.put("createPGM", "BINOLSSPRM24");
		mapInventory.put("updatedBy", userInfo.getLoginName());
		mapInventory.put("updatePGM", "BINOLSSPRM24");
		...
		tempMap.put("CreatePGM", "BINOLSSPRM24");
		tempMap.put("UpdatedBy", userInfo.getLoginName());
		tempMap.put("UpdatePGM", "BINOLSSPRM24");
		//insert 【促销产品盘点业务单据表】
		...
		//【促销产品入出库表】【促销产品入出库明细表】
		userInfo.setCurrentUnit("BINOLSSPRM24");
