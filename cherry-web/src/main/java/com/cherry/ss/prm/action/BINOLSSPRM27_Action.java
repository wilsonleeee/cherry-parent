/*
 * @(#)BINOLSSPRM27_Action.java     1.0 2010/11/03
 * 
...
public class BINOLSSPRM27_Action extends BaseAction implements
...
//		Map<String, Object> map = new HashMap<String, Object>();
//		// 促销产品发货单信息 
//		map.put("deliverInfo", form.getDeliverInfo());
//		// 登陆用户信息
//		UserInfo userInfo = (UserInfo) session
//				.get(CherryConstants.SESSION_USERINFO);
//		// 存放共通参数的map
...
//		try {
//			// 删除选中的促销品发货单
//			binOLSSPRM27BL.tran_deleteDeliver(map);
...
//		try {
//			// 发货选中的促销品发货单
//			binOLSSPRM27BL.tran_sendDeliver(map, userInfo);
//		} catch (CherryException e) {
//			this.addActionError(e.getErrMessage());
//			return CherryConstants.GLOBAL_ACCTION_RESULT;
//		}
...
//	}
	...
	private Map<String, Object> getSearchMap()throws Exception {
		...
		// 业务类型
		map.put("tradeType", CherryConstants.TRADE_TYPE_1);
		// 开始日
