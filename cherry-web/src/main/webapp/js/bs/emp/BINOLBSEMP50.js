var BINOLBSEMP50 = function() {
	
};

BINOLBSEMP50.prototype = {
		// 取得错误信息HTML
	    ...
	    "ajaxFileUpload" : function (url){
	    	...
	    	$.ajaxFileUpload({
		        url: url,
		        secureuri:false,
		        data:{'csrftoken':$('#csrftoken').val(),'brandInfoId':$('#brandInfoId').val(),'operateFlag':$('#operateFlag').val()},
...
var BINOLBSEMP50 = new BINOLBSEMP50();
