var BINOLWSMNG04 = function () {
    
};

BINOLWSMNG04.prototype = {
	...
	"search":function(){
		...
		$("#mainForm").find(":input").each(function() {
		 ...
		 // 显示结果一览
		 $("#section").show();
		 var inputStockState=$("#inputStockState").val();
		 // 表格设置
		 if(inputStockState == "Y"){
			 var tableSetting = {
					 // 表格ID
					 tableId : '#dataTable',
					 // 数据URL
					 ...
					 aoColumns : [
					              ...
					              { "sName": "allocationrNo","sWidth": "20%"},
					              { "sName": "date","sWidth": "10%"},
					              { "sName": "departNameOut","bVisible": false,"sWidth": "10%"},
	...
	"exportCsv" : function() {
		if($(".dataTables_empty:visible").length==0) {
		    ...
		    var params = binOLWSMNG04.getSearchParams();
			exportReport({
...
var binOLWSMNG04 = new BINOLWSMNG04();
