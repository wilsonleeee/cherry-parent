...
var BINOLWPSAL08_4_GLOBAL = function() {

};


BINOLWPSAL08_4_GLOBAL.prototype = {
		"confirm":function(){
			var maincode=$('#maincode_LYHD_4').val();
			var spanMemberCode=$('#memberCode_LYHD_4').val();
			var subjectCode=$('#subjectCode_LYHD_4').val();
		...
		"cancel":function(){
			// 最后一行第一个可见的文本框获得焦点
			BINOLWPSAL02.firstInputSelect();
			var activityCode = $("#maincode_LYHD_4").val();
			// 移除对应选择框选中状态
...
var BINOLWPSAL08_4 = new BINOLWPSAL08_4_GLOBAL();
