...
//		alert(this.dom.scroller.parentNode.parentNode.className);
		
		this.dom.header = this.s.dt.nTHead.parentNode;
//		alert(this.dom.header.parentNode.className);
//		this.dom.header.parentNode.style.position = "relative";
//		this.dom.body.style.width = this.dom.header.style.width;
//		alert(this.dom.body.style.width);
...
//		this.dom.scroller.parentNode.style.position = "relative";
...
//			that._fnScroll.call( that );
	...
	"_fnClone": function ()
	{
		...
		/* Grab the heights that we are going to need */
		$('tbody tr', this.dom.body).each( function () {
			iTrHeight.push($(this).outerHeight());
		} );
...
//		this.dom.header.parentNode.appendChild( this.dom.clone.header );
		this.dom.header.parentNode.parentNode.parentNode.parentNode.appendChild( this.dom.clone.header );
		...
		// ================2010-12-06修改开始 ================ //
		// 修改固定列表格的Id属性
		this.dom.clone.body.id += "_Cloned";
		// ================2010-12-06修改结束================ //
		$('thead tr', this.dom.clone.body).each( function () {
			$('th:gt('+(that.s.columns-1)+')', this).remove();
		} );
		
		$('tbody tr', this.dom.clone.body).each( function (i) {
			this.style.height = iTrHeight[i]+"px";
		...
		this.dom.clone.body.style.top = "31px";
...
//		this.dom.body.parentNode.appendChild( this.dom.clone.body );
		this.dom.body.parentNode.parentNode.parentNode.appendChild( this.dom.clone.body );
		...
		if ( this.s.dt.nTFoot !== null )
		{
			...
			this.dom.clone.footer.style.left = "2000px";
