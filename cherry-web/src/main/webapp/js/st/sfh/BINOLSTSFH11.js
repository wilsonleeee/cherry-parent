 ...
 * 全局变量定义
 */
var binOLSTSFH11_global = {};

// 消息区分(true:显示消息，false:删除消息)
binOLSTSFH11_global.msgKbn = false;

var BINOLSTSFH11 = function () {};
BINOLSTSFH11.prototype = {	
	//用户查询
	"search":function(){
		if (!$('#mainForm').valid()) {
			return false;
...
var BINOLSTSFH11 = new BINOLSTSFH11();
