var STCM18_global = {};
STCM18_global.inDepotDialogHtml="";
 ...
 * @return
 */
function popDataTableOfProInDepot(thisObj, param,callback){
	if ("" == STCM18_global.inDepotDialogHtml) {
		// 临时存放部门信息页面内容
		STCM18_global.inDepotDialogHtml = $("#inDepotDialog").html();
	} else {
		$("#inDepotDialog").html(STCM18_global.inDepotDialogHtml);
	}
	oTableArr[31] = null;
