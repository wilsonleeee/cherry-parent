function BINOLSTJCS11_04(){
	this.needUnlock = true;
};

BINOLSTJCS11_04.prototype={
		// 取得错误信息HTML
	    ...
	    "formValid" : function(){
	    	...
	    	if($('#isChecked').attr("checked") == undefined ){
	    		var importBatchCode = $('#batchCode').val();
	    		var reg = /^[A-Za-z0-9]+$/i;
	    		var errorMsg = '';
	    ...
	    "ajaxFileUpload" : function (url){
	    	...
	    	$errorMessage.empty();
	    	var $form = $("#mainForm");
	    	$('#batchCode').val($.trim($('#batchCode').val()));
...
var BINOLSTJCS11_04 = new BINOLSTJCS11_04();
