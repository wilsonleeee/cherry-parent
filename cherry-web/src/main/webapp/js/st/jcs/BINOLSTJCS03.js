var BINOLSTJCS03 = function(){};

BINOLSTJCS03.prototype={
	    ...
	    "getNextRegin":function(obj, text, grade) {
	    	...
	    	var callback = function(msg) {
	    		if(msg) {
	    			...
	    			var json = eval('('+msg+')'); 
	    			var str = '<ul class="u2"><li onclick="binOLSTJCS03.getNextRegin(this, \''+text+'\', '+nextGrade+');">'+defaultText+'</li>';
	    		    for (var one in json){
	    		        str += '<li id="'+json[one]["regionId"]+'" onclick="binOLSTJCS03.getNextRegin(this, \''+text+'\', '+nextGrade+');">'+escapeHTMLHandle(json[one]["regionName"])+'</li>';
	    		    }
	    		    str += '</ul>';
	    		    if(grade == 1) {
	    		    	$("#cityTemp").html(str);
	    ...
	    "popBelongToDepart":function(obj,param){
	    	...
	    	var callback = function(){
	    		...
	    		$this.parent().children("span").html(departName.unEscapeHTML());
	    	};
	    	var option={
	    			checkType:"radio",
	    ...
	    "getRowHtml":function(info){
	    	...
	    	html.push('<td><a href="#" id='+departId+' class="delete center" onclick="binOLSTJCS03.deleteDepart(this);return false;"><span class="ui-icon icon-delete"></span><span class="button-text">'+$("#deleteTitle").val()+'</span></a></td>');
	    	html.push('</tr>');
	    	return html.join("");
	    },
	    ...
	    //显示编辑
	    "edit":function(){
	    	this.editDivHtml = $("#edit").html();
	    	var that = this;
	    	$("#show").hide();
	    	$("#edit").show();
	    	$("#testType_select option").each(function(){
				if($(this).val() == that.testType){
					this.selected = true;
				}
	    	});
	    },
	    ...
	    "back":function(){
	    	$("#edit").html(this.editDivHtml).hide();
	    	$("#show").show();
	    },
...
var binOLSTJCS03 = new BINOLSTJCS03();
...
$(document).ready(function(){
	...
	$("#province").click(function(){
		// 显示省份列表DIV
		binOLSTJCS03.showRegin(this,"provinceTemp");
	});
	// 城市选择
	$("#city").click(function(){
		// 显示城市列表DIV
		binOLSTJCS03.showRegin(this,"cityTemp");
	});
	// 县级市选择
	$("#county").click(function(){
		// 显示县级市列表DIV
		binOLSTJCS03.showRegin(this,"countyTemp");
	});
