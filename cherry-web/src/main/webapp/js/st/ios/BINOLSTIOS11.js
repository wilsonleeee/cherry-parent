function BINOLSTIOS11(){};

BINOLSTIOS11.prototype = {
	"search" : function() {
		if(!$("#mainForm").valid()){
			return;
		}
		...
		// 显示结果一览
		$("#proReturnRequestExcelInfo").removeClass("hide");
		// 表格设置
		var tableSetting = {
				 // 表格ID
				 tableId : '#proReturnRequestExcelInfoDataTable',
				 // 数据URL
				 url : url,
				 // 表格默认排序
				 aaSorting : [[ 2, "desc" ]],
...
var BINOLSTIOS11 = new BINOLSTIOS11();
