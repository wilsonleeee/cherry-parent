	...
	"search" : function() {
		...
		if($impType=='1'){
			...
			aoColumn= [  { "sName": "number", "sWidth": "3%", "bSortable": false },
				...
				{ "sName": "ReturnVisit","sClass":"center"},
				{ "sName": "SkinType","sClass":"center"},
				{ "sName": "Profession","sClass":"center"},
				{ "sName": "Income","sClass":"center"},
				{ "sName": "Memo1","sClass":"center"},
				{ "sName": "ResultFlag","sClass":"center"},
				{ "sName": "ImportResults","sClass":"center","bSortable": false}];
		}else if($impType=='2'){
			index= 2;
			aaSorting = [[1, "desc"]];
			aoColumn= [  { "sName": "number", "sWidth": "3%", "bSortable": false },
