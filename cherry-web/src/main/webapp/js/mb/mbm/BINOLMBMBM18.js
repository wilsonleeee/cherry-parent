var BINOLMBMBM18 = function () {
};
BINOLMBMBM18.prototype = {
		"search" : function() {
			...
			var tableSetting = {
					 ...
					 aoColumns : [  { "sName": "number", "sWidth": "3%", "bSortable": false},
					                { "sName": "profileBillNo", "sWidth": "15%" },
					                { "sName": "importName", "sWidth": "15%" },
					                { "sName": "importType", "sWidth": "15%" },
...
var BINOLMBMBM18 = new BINOLMBMBM18();
$(document).ready(function() {
	...
	BINOLMBMBM18.importNameBinding({
		elementId:"importName",
		testUrl:"/mb/BINOLMBMBM18_getImportName.action"+"?",
		showNum:20
	});
});
//（父页面刷新）
