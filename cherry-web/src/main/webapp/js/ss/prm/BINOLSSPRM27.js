 ...
 * 全局变量定义
 */
var binOLSSPRM27_global = {};

// 消息区分(true:显示消息，false:删除消息)
binOLSSPRM27_global.msgKbn = false;
// 前一次的业务类型
binOLSSPRM27_global.tradeTypePre = "";

var BINOLSSPRM27 = function () {};
BINOLSSPRM27.prototype = {
//	SSPRM27_dialogBody : "",
...
//				modal : true,
//				autoClose : [],
//				dialogBody : BINOLSSPRM27.SSPRM27_dialogBody
//		};
//		popDataTableOfPrmInfo(prmPopParam);
		...
		var option = {
			...
			getHtmlFun:function(info){// 目标区追加数据行function
				...
				html += '<span class="close" style="margin: -1px 0 0 6px;" onclick="BINOLSSPRM27.delPrmLabel(this);return false;"><span class="ui-icon ui-icon-close"></span></span>';
...
var BINOLSSPRM27 = new BINOLSSPRM27();

$(document).ready(function() {
//	// 促销品popup初始化
//	BINOLSSPRM27.SSPRM27_dialogBody = $('#promotionDialog').html();
...
//		BINOLSSPRM27.openPrmPopup(this);
//	});
//	// 表格列选中
	...
	// 查询参数序列化
	 ...
	 var tableSetting = {
			 ...
			 aoColumns : [	{ "sName": "checkbox","bSortable": false,"sWidth": "2%"}, 	// 0			// 0
							...
							{ "sName": "stockInFlag"},						// 10
							{ "sName": "employeeName","bVisible" : false},				// 11
			...
			callbackFun : function (msg){
		 		...
		 		if (!binOLSSPRM27_global.msgKbn) {
		 			$("#actionResultDisplay").empty();
		 		}
		 		binOLSSPRM27_global.msgKbn = false;
		 	},
	 		fnDrawCallback:function(){
		 		cleanPrintBill();getPrintTip("a.printed");
		 	}
	 };
	 // 调用获取表格函数
...
//		$("#prmVendorId").val("");
//	}
//	closeCherryDialog('promotionDialog',BINOLSSPRM27.SSPRM27_dialogBody);	
//	oTableArr[1]= null;	
//}
