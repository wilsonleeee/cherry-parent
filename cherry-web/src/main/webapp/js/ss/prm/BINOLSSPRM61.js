var BINOLSSPRM61 = function () {};
BINOLSSPRM61.prototype={
	/**
	 * 弹出促销品框
	 */
	"openPrmPopup":function(_this){
		...
		var option = {
			...
			getHtmlFun:function(info){// 目标区追加数据行function
				...
				html += '<span class="close" style="margin: -1px 0 0 6px;" onclick="BINOLSSPRM61.delPrmLabel(this);return false;"><span class="ui-icon ui-icon-close"></span></span>';
...
var BINOLSSPRM61 = new BINOLSSPRM61();
