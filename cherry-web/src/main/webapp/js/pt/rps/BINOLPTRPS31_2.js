function BINOLPTRPS31_2_global() {	
	this.needUnlock = true;
};

BINOLPTRPS31_2_global.prototype = {
		"search" : function() {
			...
			tableSetting = {
				 ...
				 aoColumns : [	
		                    	...
		                    	{ "sName": "barCode"},
		                    	{ "sName": "productName"},
		                    	{ "sName": "baSaleQuantity","sClass":"alignRight"},
		                    	{ "sName": "baSaleAmount","sClass":"alignRight"}
							],
				 sScrollX : "100%",
				// 不可设置显示或隐藏的列	
				aiExclude :[0,1,2,3]
...
var BINOLPTRPS31_2 = new BINOLPTRPS31_2_global();
