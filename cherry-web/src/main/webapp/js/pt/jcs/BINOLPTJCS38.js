 ...
 * 全局变量定义
 */
var binOLPTJCS38_global = {};

// 消息区分(true:显示消息，false:删除消息)
binOLPTJCS38_global.msgKbn = false;
...
function search(){
	...
	var aoColumnsArr = [	{ "sName": "checkbox", "sWidth": "1%", "bSortable": false}, // 0
	                    	...
	                    	{ "sName": "prtFunDateName","sWidth": "20%"},	                // 2							
	                    	{ "sName": "prtFunType","sWidth": "10%"},	                // 3							
							{ "sName": "startDate","sWidth": "15%"},						// 4
							{ "sName": "endDate","sWidth": "15%"},						// 5
	                        { "sName": "validFlag","sWidth": "4%","sClass": "center"}]; // 6
...
//	var param = $(object).parent().find(':input').serialize();
	...
	param += "&"+$("#dataTable_Cloned").find(":checkbox[checked]").nextAll("#prtFunIdArr").serialize();
	var strText = '';
	var strTitle = '';
...
function dialogClose(){
	...
	if (binOLPTJCS38_global.refresh) {
		this.search();
		binOLPTJCS38_global.refresh = false;
	}
};
