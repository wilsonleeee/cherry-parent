...
<script type="text/javascript" src="/Cherry/js/st/bil/BINOLSTBIL05.js"></script>
<script type="text/javascript" src="/Cherry/js/common/cherryDate.js"></script>
<script type="text/javascript" src="/Cherry/js/lib/jquery-ui-i18n.js"></script>  
<s:i18n name="i18n.st.BINOLSTBIL05">
    <div class="hide">
        <s:url id="search_url" value="/st/BINOLSTBIL05_search"/>
        <s:url id="export_url" action="BINOLSTBIL05_export"/>
        <a id="searchUrl" href="${search_url}"></a>
        <s:text name="BIL05_select" id="defVal"/>
        <div id="BIL05_select">${defVal}</div>
    </div>
     <div class="panel-header">
      ...
      <div class="panel-content">
        <div class="box">
          <cherry:form id="mainForm" class="inline" onsubmit="BINOLSTBIL05.search(); return false;">
            <div class="box-header">
            <strong>
                <span class="ui-icon icon-ttl-search"></span>
                <%-- 查询条件 --%>
                <s:text name="BIL05_condition"/>
            </strong>
            </div>
            <div class="box-content clearfix">
              ...
              <div class="column last" style="width:49%;height:55px;">
               <p id="dateCover"  class="date">
                <%-- 日期范围 --%>
                  <label><s:text name="BIL05_date"/></label>
                ...
                <p>
                 <%-- 审核状态 --%>
                 <label><s:text name="BIL05_verifiedFlag"/></label>
                 <s:text name="BIL05_selectAll" id="BIL05_selectAll"/>
                    <s:select name="verifiedFlag" list='verifiedFlagsLSList'
                        listKey="CodeKey" listValue="Value" headerKey="" headerValue="%{BIL05_selectAll}"/>
                 </p>
              </div>
              <%-- ======================= 组织联动共通导入开始  ============================= --%>
            ...
            <p class="clearfix">
             <%--<cherry:show domId="SSPRO0727QUERY">--%>
                    <button class="right search" type="submit" onclick="BINOLSTBIL05.search();return false;">
                        <span class="ui-icon icon-search-big"></span>
                        <%-- 查询 --%>
                        <span class="button-text"><s:text name="BIL05_search"/></span>
                    </button>
              <%-- </cherry:show> --%>
            </p>
          </cherry:form>
        ...
        <div id="section" class="section hide">
          ...
          <strong>
            ...
            <%-- 查询结果一览 --%>
            <s:text name="BIL05_results_list"/>
         </strong>
        </div>
          <div class="section-content" id="result_list">
            <div class="toolbar clearfix">
             <cherry:show domId="BINOLSTBIL05EXP">
                <a class="export left" onclick="BINOLSTBIL05.exportExcel(this);return false;"  href="${export_url}">
					<span class="ui-icon icon-export"></span>
					<span class="button-text"><s:text name="global.page.export"></s:text></span>
				</a>
			 </cherry:show>
             <cherry:show domId="BINOLSTBIL05PNT">
                ...
                <%-- 设置列 --%>
                <s:text name="BIL05_colSetting"/>
                </span></a></span></div>
            <table id="dataTable" cellpadding="0" cellspacing="0" border="0" class="jquery_table" width="100%">
              <thead>
                <tr>
                  <th><input type="checkbox" id="allSelect" onclick="checkBillAll(this);"/><s:text name="global.page.selectAll"/></th><%-- 选择 --%>
                  <th><s:text name="BIL05_billNo"/><span class="ui-icon ui-icon-document"></span></th><%-- 报损单号 --%>
                  <th><s:text name="BIL05_departName"/></th><%-- 部门  --%>
                  <th><s:text name="BIL05_inventName"/></th><%-- 实体仓库 --%>
                  <th><s:text name="BIL05_logicinventName"/></th><%-- 逻辑仓库 --%>
                  <th><s:text name="BIL05_Quantity"/></th><%-- 总数量 --%>   
                   <th><s:text name="BIL05_price"/></th><%-- 总数量 --%>   
                  <th><s:text name="BIL05_outfreedate"/></th><%-- 报损时间 --%>
                  <th><s:text name="BIL05_verifiedFlag"/></th><%-- 审核状态 --%>
                  <th><s:text name="BIL05_employeeName"/></th><%-- 操作员 --%>
                  <th><s:text name="BIL05_binEmployeeIDAudit"/></th><%-- 审核者--%>
