...
<script type="text/javascript" src="/Cherry/js/st/sfh/BINOLSTSFH06.js?v=20170209"></script>
...
<s:i18n name="i18n.st.BINOLSTSFH06">
    ...
    <cherry:form id="mainForm" action="/Cherry/st/BINOLSTSFH06_SUBMIT">
        ...
        <div class="hide">
            ...
            <div id="dialogConfirm" class="highlight"><s:text name="dialog_confirm"/></div>
            <div id="dialogTitle"><s:text name="dialog_title"/></div>
            <div id="dialogCancel"><s:text name="dialog_cancel"/></div>
            <s:select id="departTypePop" name="departTypePop" list='#application.CodeTable.getCodes("1000")'
        ...
        <s:else>
            <div class="panel-content">
                <div class="section">
                    <div class="section-header"><strong><span class="ui-icon icon-ttl-section-info"></span><s:text
                            name="lblgeneral"/></strong></div>
                    <div class="section-content">
                        <table class="detail">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select style="width:200px;" name="outDepotId" id="outDepotId" disabled="true"
                                            onchange="STSFH06_clearDetailData();return false;">
                                ...
                                <td>
                                    <s:select name="outLoginDepotId" list="logicInventoryList"
                                              listKey="BIN_LogicInventoryInfoID" listValue="LogicInventoryCodeName"
                                              disabled="true" cssStyle="width:200px;"
                                              onchange="STSFH06_clearDetailData('flag');return false;"/>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="date">
                                        <span><s:textfield name="planArriveDate" cssClass="date"
                                                           id="planArriveDate"/></span>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th><s:text name="lblReasonAll"></s:text></th>
                                <td colspan=3><input class="text" type="text" name="reasonAll" id="reasonAll"
                                                     maxlength="200" style="width:95%;"/></td>
                            </tr>
                        </table>
                    </div>
                </div>
                <div class="section">
                    <div class="section-header"><strong><span class="ui-icon icon-ttl-section-list"></span><s:text
                            name="lbldetail"/></strong></div>
                    <div class="section-content">
                        <div id="suggestBill_processing" class="dataTables_processing"
                             style="top: 50%;left: 50%;display: none;"></div>
            ...
            <a class="add" onclick="BINOLSTSFH06.openProStockPopup(this);">
             ...
             <a id="spanBtnadd" class="add" onclick="BINOLSTSFH06.openProPopup();"><span
                     class="ui-icon icon-add"></span><span class="button-text"><s:text name="btnSelectProduct"/></span></a>
             <cherry:show domId="BINOLSTSFH0603">
                 <a class="add" id="billCopy" onclick="BINOLSTSFH06.copyDeliver();"><span
                         class="ui-icon icon-add"></span><span class="button-text"><s:text name="billCopy"/></span></a>
             </cherry:show>
             <cherry:show domId="BINOLSTSFH0602">
               ...
               <s:text name="blankbill"/></span>
                 ...
                 <a id="spanBtnCancel" class="delete" style="display:none;"
                    onclick="BINOLSTSFH06.canceProductResult(true);">
            ...
            <cherry:show domId="BINOLSTSFH0604">
                ...
                <span id="spanCancelSuggest" style="display:none;border:1px solid #7D8791;padding:3px 1px 6px 1px;">
                    <a id="spanBtnCancelSuggest" class="delete" style="display:none;"
                       onclick="BINOLSTSFH06.canceProductResultSuggest(true);">
                        <span class="ui-icon icon-delete"></span>
                        <span class="button-text">
                        <s:text name="SFH06_CancelSuggestbill"/></span>
                    </a>
                    <a id="spanBtnDelNoNeed" class="delete" style="display:none;" onclick="BINOLSTSFH06.delNoNeed();"
                       title="<s:text name="SFH06_DelNoNeedTip"><s:param><s:property value='delQuantityLT'/></s:param></s:text>">
                        <span class="ui-icon icon-delete"></span>
                        <span class="button-text">
                ...
                <a id="spanBtnAddNewLine" class="add" onclick="BINOLSTSFH06.addNewLine(false);"><span
                        class="ui-icon icon-add"></span><span class="button-text"><s:text name="btnadd"/></span></a>
                <a id="spanBtdelete" class="delete" onclick="STSFH06_deleterow();"><span
                        class="ui-icon icon-delete"></span><span class="button-text"><s:text
                        name="btndelete"/></span></a>
               <span class="bg_yew"><span style="line-height:25px;" class="highlight">*<s:text
                       name="lbldrag"/></span></span>
               </span>
                        ...
                        <div id="canceldetail">
                            <div style="width:100%;overflow-x:scroll;">
                                <table id="mainTable" cellpadding="0" cellspacing="0" border="0" width="100%"
                                    ...
                                    <thead>
                                    <tr>
                                        <th class="tableheader" width="3%"><input id="allSelect" type="checkbox"
                                                                                  class="checkbox"
                                                                                  onclick="doSelectAll(this,'#databody');"/>
                                            <s:text name="btnallselect"/></th>
                                        <th class="tableheader" width="15%"
                                            onclick="STSFH06_sortTable('_unitCodeArr');">
                                            <div class="DataTables_sort_wrapper"><s:text name="lblcode"/><span
                                                    id="_unitCodeArr"
                                        ...
                                        <th class="tableheader" width="15%" onclick="STSFH06_sortTable('_barCodeArr');">
                                            <div class="DataTables_sort_wrapper"><s:text name="lblbarcode"/><span
                                                    id="_barCodeArr"
                                                    class="css_right ui-icon ui-icon-carat-2-n-s"></span></div>
                                        </th>
                                        ...
                                        <th class="tableheader" width="10%" onclick="STSFH06_sortTable('_quantArr');">
                                            <div class="DataTables_sort_wrapper"><s:text name="lbloutcount"/><span
                                                    id="_quantArr" class="css_right ui-icon ui-icon-carat-2-n-s"></span>
                                            </div>
                                        </th>
                                        <th class="tableheader" width="10%">
                                            <div style="line-height:13px;"><s:text name="lblmoney"/><s:text
                                                    name="lblmoneyu"/></div>
                                        </th>
                                        <th class="tableheader" width="8%"><s:text name="SFH06_ReferencePrice"/></th>
                                        <th class="tableheader" width="8%"><s:text name="SFH06_costPrice"/></th>
                                            <%--成本价 --%>
                                        <th class="tableheader" width="8%"><s:text name="SFH06_totalCostPrice"/></th>
                                            <%--总成本价 --%>
                                        <th class="tableheader" width="8%">
                                            <s:text name="lblprice"/>
                                            <span class="calculator" onclick="BINOLSTSFH06.initRateDiv(this,'batch');"
                                                  title="<s:text name="SFH06_BatchCalTitle"/>"></span>
                        ...
                        <table cellpadding="0" cellspacing="0" width="30%" border="0" class="right editable">
                            <tr>
                                <th rowspan="2" scope="row" class="center"><s:text name="global.page.total"/></th>
                                    <%-- 合计 --%>
                                <td class="center"><s:text name="SFH06_totalQuantity"/></td>
                                    <%-- 总数量 --%>
                                <td class="center"><s:text name="SFH06_totalAmount"/></td>
                                    <%-- 总金额--%>
                            </tr>
                            <tr>
                                <td class="center">
                        ...
                        <div id="submitDiv" class="center clearfix">
                            <button class="save" type="button" onclick="STSFH06_save();return false;"><span
                                    class="ui-icon icon-save"></span><span class="button-text"><s:text
                                    name="btnSave"/></span></button>
                            <cherry:show domId="BINOLSTSFH0601">
                                <button class="confirm" type="button" onclick="STSFH06_btnSendClick()"><span
                                        class="ui-icon icon-confirm"></span><span class="button-text"><s:text
                                        name="btnOK"/></span></button>
                            </cherry:show>
                        </div>
                        <div id="submit_processing" class="dataTables_processing"
                             style="top: 50%;left: 50%;display: none;"></div>
                    </div>
                </div>
            </div>
    ...
    <div id="errmessage" style="display:none">
        ...
        <input type="hidden" id="errmsg5" class="highlight" value='<s:text name="ESS00094"/>'/>
