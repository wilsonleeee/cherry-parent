...
<cherry:form id="mainForm" class="inline" onsubmit="return false;">
    <div class="hide">
        <input type="hidden" id="currentMenuID" name="currentMenuID" value="BINOLSTSFH22"/>
    ...
    <s:else>
        ...
        <div class="section">
            ...
            <div class="toolbar clearfix">
                <span class="left">
                    <a id="spanBtnadd" class="add" onclick="BINOLSTSFH22.openProPopup();"><span class="ui-icon icon-add"></span><span class="button-text"><s:text name="SFH22_orderListModelSelectProduct"/></span></a> 
                    <a id="spanBtnaddP" class="add" onclick="BINOLSTSFH22.popAdd();"><span class="ui-icon icon-add"></span><span class="button-text"><s:text name="SFH22_mallModelSelectProduct"/></span></a>
                    ...
                    <a id="suggestProduct" class="add" onclick="BINOLSTSFH22.openSuggestDay('${initInfoMap.defaultDepartID}');"><span class="ui-icon icon-add"></span><span class="button-text"><s:text name="SFH22_suggestOrderList"/></span></a>
                </span>
            </div>
            <div id="canceldetail">
            ...
            <div class="center clearfix">
                ...
                <button id="btnSendMsm" class="confirm" type="button" onclick="BINOLSTSFH22.btnSendMsm()" ><span class="ui-icon icon-confirm"></span><span class="button-text"><s:text name="SFH22_confirmPayMoney"/></span></button>
            </div>
          </div>
        </div>
      </div>
...
<div id="errmessage" style="display:none">
    ...
    <input type="hidden" id="errmsg9"  value='<s:text name="SFH22_suggestOrderDayIsPositiveInteger"/>'/>
</div>
    <%-- ====================== 建议订货生成天数弹出框 ====================== --%>
    	...
    	<div class="clearfix">
         ...
         <ul>
    		...
    		<table style="width:100%;" class="detail">
	            <tr>
					<th><s:text name="SFH22_suggestOrderDay"/><span class="highlight"><s:text name="global.page.required"></s:text></span></th>
