...
<script type="text/javascript" src="/${CHERRY_CONTEXT_PATH}/js/st/sfh/BINOLSTSFH19.js"></script>
<%-- 后台销售（Excel导入）URL --%>
<s:url id="importInit_url" value="/st/BINOLSTSFH19_importInit"/>
...
<s:text name="global.page.all" id="select_default"/>
    <div class="panel-header">
        <div class="clearfix"> 
			...
			<cherry:show domId="BINOLSTSFH19IMP">
				<span class="right"> 
					<a onclick="javascript:openWin(this);return false;" class="add"  href="${importInit_url}">
						<span class="button-text"><s:text name="SFH19_native2"></s:text></span>
...
<div class="box">
    ...
    <div class="box-content clearfix">
      <div class="column" style="width:50%; height: auto;">
     	<p>
       		<label style="width:80px;"><s:text name="SFH19_brandName"/></label>
      	...
      	<p>
          <label style="width:80px;"><s:text name="SFH19_importBatch" /></label>
            <span>
      ...
      <div class="column last" style="width:49%; height: auto;">
        <p class="date">
        	<label><s:text name="SFH19_importDate"/></label>
            <span>
    ...
    <p class="clearfix">
      <button class="right search" onclick="BINOLSTSFH19.search();return false;">
...
<div class="section hide" id="backstageSaleExcelBatch">
  ...
  <div class="section-content">
    <table cellpadding="0" cellspacing="0" border="0" class="jquery_table" width="100%" id="backstageSaleExcelBatchDataTable">
      <thead>
        <tr>
          <th><s:text name="NO."></s:text></th>
          <th><s:text name="SFH19_importBatch"></s:text></th>
          <th><s:text name="SFH19_importDate"></s:text></th>
          <th><s:text name="SFH19_employee"></s:text></th>
          <th><s:text name="SFH19_comments"></s:text></th>
        </tr>
      </thead>
      <tbody>
      </tbody>
...
<div class="hide">
<s:url action="BINOLSTSFH19_search" id="searchUrl"></s:url>
