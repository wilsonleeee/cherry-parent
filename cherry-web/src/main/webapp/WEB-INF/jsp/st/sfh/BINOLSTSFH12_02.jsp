...
<script type="text/javascript" src="/Cherry/js/st/sfh/BINOLSTSFH12_01.js"></script>
<%-- 入库单导入模板下载URL --%>
<s:url id="downLoad_url" value="/download/产品发货单导入模版.xls"/>
<%-- 入库单导入导入URL --%>
<s:url id="import_url" value="/st/BINOLSTSFH12_import"/>
...
<div class="panel ui-corner-all">
	<div id="div_main">
	    <div class="panel-header">
	        <div class="clearfix"> 
				<span class="breadcrumb left">	    
					<span class="ui-icon icon-breadcrumb"></span><s:text name="SFH12_native1" />&nbsp;&gt;&nbsp;<s:text name="SFH12_native2"></s:text>
				</span>
	        </div>
	    </div>
	    <%-- ================== 信息提示区 START ======================= --%>
	    	...
	    	<div class="box-yew">
				<div class="box-yew-header clearfix">
					<strong class="left">
						...
						<s:text name="SFH12_importExplanation" />
					</strong> 
					<a id="expandCondition" style="margin-left: 25px; font-size: 12px; width: 80px" class="ui-select right"> 
						<span class="button-text choice" style="min-width: 50px;">
							<s:text name="SFH12_moreExplanation" />
						</span> 
				...
				<div class="box-yew-content">
					<div class="step-content">
						...
						<div class="step">
							<s:text name="SFH12_explanation1" />
						</div>
						<div class="line"></div>
					</div>
					<div id="moreCondition" style="display: none;">
						<div class="step-content">
							...
							<div class="step">
								<s:text name="SFH12_explanation2" />
							</div>
							<div class="line"></div>
						</div>
						<div class="step-content">
							...
							<div class="step">
								<s:text name="SFH12_explanation3" />
							</div>
							<div class="line"></div>
						</div>
						<div class="step-content">
							...
							<div class="step">
								<s:text name="SFH12_explanation4" />
							</div>
							<div class="line"></div>
						</div>
						<div class="step-content">
							...
							<div class="step">
								<s:text name="SFH12_explanation5" />
							</div>
							<div class="line"></div>
						</div>
					</div>
	    	...
	    	<div class="box2 box2-active">
				<div class="box2-header clearfix">
					<strong class="active left">
						...
						<s:text name="SFH12_importConditions" />
					</strong>
				</div>
				<div class="box2-content clearfix">
					 <table class="detail" cellpadding="0" cellspacing="0">
						<tr>
							<th><s:text name="SFH12_brandName" /></th>
							<td>
							...
							<th><s:text name="SFH12_importBatch" /><span class="highlight">*</span></th>
							<td>
								<span id="importBatchCodeSpan"><s:textfield name="importBatchCode" id="importBatchCode" cssClass="text" maxlength="25" /></span>
								<span>
									<input type="checkbox" id="isChecked" name="isChecked" onclick="BINOLSTSFH12_01.isChecked(this);">
									 <s:text name="SFH12_fromExcel" />
								</span>
							</td>
						</tr>
						 <tr>
						 	<th><s:text name="SFH12_importRepeatData" /><span class="highlight">*</span></th>
							<td>
								<span>
									<select name="importRepeat" id="importRepeat" >
										<option value=""><s:text name="SFH12_select" /></option>
										<option value="0"><s:text name="SFH12_no" /></option>
										<option value="1"><s:text name="SFH12_yes" /></option>
									</select>
								</span>
							</td>
							<th><s:text name="SFH12_importReson" /><span class="highlight">*</span></th>
			...
			<div class="box2 box2-active">
				<div class="box2-header clearfix">
					<strong class="active left">
						...
						<s:text name="SFH12_title" />
					</strong>
				</div> 
		        <div class="box2-content clearfix">
	        		<div class="box4-content">
						<span style="margin-left:10px; display: inline;" class="left hide"> 
							<span class="highlight"><s:text name="SFH12_snow" /></span>
							<s:text name="SFH12_notice"/>
							<a href="${downLoad_url }"><s:text name="SFH12_down"/></a>
						    <input class="input_text" type="text" id="pathExcel" name="pathExcel"/>
						    <input type="button" value="<s:text name="global.page.browse"/>"/>
						    <input class="input_file" type="file" name="upExcel" id="upExcel" size="33" onchange="BINOLSTSFH12_01.deleteActionMsg();pathExcel.value=this.value;return false;" /> 
						    <input type="button" value="<s:text name="SFH12_importExcel_btn"/>" onclick="BINOLSTSFH12_01.ajaxFileUpload('${import_url}');return false;" id="upload"/>
		     ...
		     <div class="center clearfix" id="closeButton">
	            <button onclick="BINOLSTSFH12_01.close();return false;" type="button" class="close" id="close">
	    ...
	    <div id="errMsg">
	    	...
	    	<input type="hidden" id="errmsg2" value='<s:text name="SFH12_error1"/>'/>
	    	<input type="hidden" id="errmsg3" value='<s:text name="SFH12_error2"/>'/>
	    	<input type="hidden" id="errmsg4" value='<s:text name="SFH12_error3"/>'/>
	    </div>
	</div>
</div>
</s:i18n>
