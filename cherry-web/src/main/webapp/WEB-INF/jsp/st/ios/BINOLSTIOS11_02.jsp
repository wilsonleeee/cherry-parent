...
<script type="text/javascript" src="/Cherry/js/st/ios/BINOLSTIOS11_01.js"></script>
<%-- 退库申请单导入模板下载URL --%>
<s:url id="downLoad_url" value="/download/产品退库申请单导入模版.xls"/>
<%-- 退库申请单导入导入URL --%>
<s:url id="import_url" value="/st/BINOLSTIOS11_import"/>
...
<div class="panel ui-corner-all">
    <div id="div_main">
        <div class="panel-header">
            <div class="clearfix"> 
                <span class="breadcrumb left">      
                    <span class="ui-icon icon-breadcrumb"></span><s:text name="IOS11_native1" />&nbsp;&gt;&nbsp;<s:text name="IOS11_native2"></s:text>
                </span>
            </div>
        </div>
        <%-- ================== 信息提示区 START ======================= --%>
            ...
            <div class="box-yew">
                <div class="box-yew-header clearfix">
                    <strong class="left">
                        ...
                        <s:text name="IOS11_importExplanation" />
                    </strong> 
                    <a id="expandCondition" style="margin-left: 25px; font-size: 12px; width: 80px" class="ui-select right"> 
                        <span class="button-text choice" style="min-width: 50px;">
                            <s:text name="IOS11_moreExplanation" />
                        </span> 
                ...
                <div class="box-yew-content">
                    <div class="step-content">
                        ...
                        <div class="step">
                            <s:text name="IOS11_explanation1" />
                        </div>
                        <div class="line"></div>
                    </div>
                    <div id="moreCondition" style="display: none;">
                        <div class="step-content">
                            ...
                            <div class="step">
                                <s:text name="IOS11_explanation2" />
                            </div>
                            <div class="line"></div>
                        </div>
                        <div class="step-content">
                            ...
                            <div class="step">
                                <s:text name="IOS11_explanation3" />
                            </div>
                            <div class="line"></div>
                        </div>
                        <div class="step-content">
                            ...
                            <div class="step">
                                <s:text name="IOS11_explanation4" />
                            </div>
                            <div class="line"></div>
                        </div>
                    </div>
            ...
            <div class="box2 box2-active">
                <div class="box2-header clearfix">
                    <strong class="active left">
                        ...
                        <s:text name="IOS11_importConditions" />
                    </strong>
                </div>
                <div class="box2-content clearfix">
                     <table class="detail" cellpadding="0" cellspacing="0">
                        <tr>
                            <th><s:text name="IOS11_brandName" /></th>
                            <td>
                            ...
                            <th><s:text name="IOS11_importBatch" /><span class="highlight">*</span></th>
                            <td>
                                <span id="importBatchCodeSpan"><s:textfield name="importBatchCode" id="importBatchCode" cssClass="text" maxlength="25" /></span>
                                <span>
                                    <input type="checkbox" id="isChecked" name="isChecked" onclick="BINOLSTIOS11_01.isChecked(this);">
                                     <s:text name="IOS11_fromExcel" />
                                </span>
                            </td>
                        </tr>
                         <tr>
                            <th><s:text name="IOS11_importRepeatData" /><span class="highlight">*</span></th>
                            <td>
                                <span>
                                    <select name="importRepeat" id="importRepeat" >
                                        <option value=""><s:text name="IOS11_select" /></option>
                                        <option value="0"><s:text name="IOS11_no" /></option>
                                        <option value="1"><s:text name="IOS11_yes" /></option>
                                    </select>
                                </span>
                            </td>
                            <th><s:text name="IOS11_importReson" /><span class="highlight">*</span></th>
            ...
            <div class="box2 box2-active">
                <div class="box2-header clearfix">
                    <strong class="active left">
                        ...
                        <s:text name="IOS11_title" />
                    </strong>
                </div> 
                <div class="box2-content clearfix">
                    <div class="box4-content">
                        <span style="margin-left:10px; display: inline;" class="left hide"> 
                            <span class="highlight"><s:text name="IOS11_snow" /></span>
                            <s:text name="IOS11_notice"/>
                            <a href="${downLoad_url }"><s:text name="IOS11_down"/></a>
                            <input class="input_text" type="text" id="pathExcel" name="pathExcel"/>
                            <input type="button" value="<s:text name="global.page.browse"/>"/>
                            <input class="input_file" type="file" name="upExcel" id="upExcel" size="33" onchange="BINOLSTIOS11_01.deleteActionMsg();pathExcel.value=this.value;return false;" /> 
                            <input type="button" value="<s:text name="IOS11_importExcel_btn"/>" onclick="BINOLSTIOS11_01.ajaxFileUpload('${import_url}');return false;" id="upload"/>
             ...
             <div class="center clearfix" id="closeButton">
                <button onclick="BINOLSTIOS11_01.close();return false;" type="button" class="close" id="close">
        ...
        <div id="errMsg">
            ...
            <input type="hidden" id="errmsg2" value='<s:text name="IOS11_error1"/>'/>
            <input type="hidden" id="errmsg3" value='<s:text name="IOS11_error2"/>'/>
            <input type="hidden" id="errmsg4" value='<s:text name="IOS11_error3"/>'/>
        </div>
    </div>
</div>
</s:i18n>