...
<script type="text/javascript" src="/Cherry/js/st/ios/BINOLSTIOS09.js"></script>
<%-- 入库单（Excel导入）URL --%>
<s:url id="importInit_url" value="/st/BINOLSTIOS09_importInit"/>
...
<s:text name="global.page.all" id="select_default"/>
    <div class="panel-header">
        <div class="clearfix"> 
			...
			<cherry:show domId="STIOS09IMPORT">
				<span class="right"> 
					<a onclick="javascript:openWin(this);return false;" class="add"  href="${importInit_url}">
						<span class="button-text"><s:text name="binolstios09_native2"></s:text></span>
...
<div class="box">
    ...
    <div class="box-content clearfix">
      <div class="column" style="width:50%; height: auto;">
      	<s:if test="brandInfoList != null && brandInfoList.size() > 0">
      		<p>
        		<label><s:text name="binolstios09_brandName"/></label>
      	...
      	<p>
          <label style="width:80px;"><s:text name="binolstios09_importBatch" /></label>
            <span>
      ...
      <div class="column last" style="width:49%; height: auto;">
        <p>
        	<label><s:text name="binolstios09_importDate"/></label>
            <span>
    ...
    <p class="clearfix">
      <button class="right search" onclick="BINOLSTIOS09.search();return false;">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="jquery_table" width="100%" id="productInDepotExcelInfoDataTable">
      <thead>
        <tr>
          ...
          <th><s:text name="binolstios09_importBatch"></s:text></th>
          <th><s:text name="binolstios09_importDate"></s:text></th>
          <th><s:text name="binolstios09_employee"></s:text></th>
          <th><s:text name="binolstios09_comments"></s:text></th>
        </tr>
      </thead>
      <tbody>
      </tbody>
...
<div class="hide">
<s:url action="BINOLSTIOS09_search" id="searchUrl"></s:url>
