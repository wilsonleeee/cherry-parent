...
<script type="text/javascript" src="/Cherry/js/mo/cio/BINOLMOCIO14.js"></script>
...
<s:i18n name="i18n.mo.BINOLMOCIO14">
<div class="hide">
    <s:url id="getTree_url" action="BINOLMOCIO14_getTree"/>
    <a id="getTree_url" href="${getTree_url}"></a>
    <s:url id="getChannelCntTree_url" action="BINOLMOCIO14_getChannelCntTree"/>
...
<!--    <div class="main container clearfix" >-->
        <div class="panel-header">
            <div class="clearfix">
                <span class="breadcrumb left"> 
                    ...
                    <%-- 终端互动 --%>
                    <s:text name="CIO14_breadcrumb"/>&gt;
                    <%-- 柜台消息发布 --%>
                    <s:text name="CIO14_title"/>
                </span>
            </div>
        </div>
        ...
        <div class="panel-content" >
            <div class="box">
                ...
                <div class="box-content clearfix">
                    <div class="left">
                        ...
                        <p class="clearfix">
                            <span class="left">
                                <label><s:text name="CIO14_brandName"/>：</label>
                        ...
                        <p class="clearfix">
                            <span class="left">
                                <label><s:text name="CIO14_msgTitle"/>：</label>
                        ...
                        <s:if test='null != counterMessage.importBatch && !"".equals(counterMessage.importBatch)'>
	                        ...
	                        <p class="clearfix">
	                            <span class="left">
	                                <label><s:text name="CIO14_importBatch"/>：</label>
                        ...
                        <p class="clearfix">
                            <span class="left">
                                <label><s:text name="CIO14_validDate"/>：</label>
                        ...
                        <p class="clearfix">
                           <span class="left">
                               <label><s:text name="CIO14_status"/>：</label>
                               <span><s:property value='#application.CodeTable.getVal("1194", counterMessage.status)'/></span>
                           </span>
                        </p>
                        <%-- 消息内容 --%>
                        <div>
                            <div class="left"><label><s:text name="CIO14_msgBody"/>：</label></div>
                            <div class="left msgBody"><s:property value="counterMessage.messageBody"/></div>
                        </div>
                    </div>
                </div>
                <p class="clearfix">
                    <input id="radioAllow" name="radioControlFlag" type="radio" value="1" <s:if test="%{radioControlFlag == 1}">checked</s:if>/><s:text name="CIO14_allowCounter"></s:text>
                    <input id="radioForbidden" name="radioControlFlag" type="radio" value="2" <s:if test="%{radioControlFlag == 2}">checked</s:if>/><s:text name="CIO14_forbiddenCounter"></s:text>
                </p>
            </div>
            ...
            <div class="toolbar clearfix">
		        <strong>
		            <span class="left">
		                ...
		                <s:text name="CIO14_importExcel_title"/>
		            </span>
		        </strong>
		    </div>
		    <%-- ================== 信息提示区 START ======================= --%>
			...
			<%-- ================== 信息提示区   END  ======================= --%>
		    <div>
		        <span class="highlight"><s:text name="CIO14_snow"/></span>
		        <s:text name="CIO14_notice"/>
		        <a href="${downloadUrl}"><s:text name="CIO14_download"/></a>
		    </div>
		    <div>
		            ...
		            <tr>
		                <td>
		                     ...
		                     <span style="margin-left:10px; display: inline;" class="left hide"> 
							    ...
							    <input class="input_file" type="file" name="upExcel" id="upExcel" size="33" onchange="BINOLMOCIO14.deleteActionMsg();pathExcel.value=this.value;return false;" /> 
							    <input type="button" value="<s:text name="CIO14_importExcel_btn"/>" onclick="BINOLMOCIO14.ajaxFileUpload('${import_url}');return false;" id="upload" /> 
            ...
            <div class="clearfix section-header1"> 
                <strong>
                    ...
                    <s:text name="CIO14_choiceCounter"/>
                </strong>
                <span>
					<select name="selMode" id="selMode" onchange="BINOLMOCIO14.ajaxGetNodes();return false;">
                ...
                <span class="right">
					...
					<a class="search" onclick="BINOLMOCIO14.locationCutPosition(this);return false;">
						<span class="ui-icon icon-position"></span>
						<span class="button-text"><s:text name="CIO14_locationPosition"></s:text></span>
					</a>
				</span>
            </div>
            <hr class="space" />
            ...
            <hr class="space" />
            <div class="center">
                <button class="save" type="button" onclick="BINOLMOCIO14.publish();">
                    <span class="ui-icon icon-confirm"></span>
                    <span class="button-text"><s:text name="CIO14_publish"></s:text>
                    </span>
                </button>
