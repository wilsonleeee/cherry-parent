...
<script type="text/javascript" src="/${CHERRY_CONTEXT_PATH}/js/mo/cio/BINOLMOCIO16_1.js"></script>
<%-- 柜台消息导入模板下载URL --%>
<s:url id="downLoad_url" value="/download/柜台消息导入模板.xls"/>
<%-- 柜台消息导入URL --%>
<s:url id="import_url" value="/mo/BINOLMOCIO16_import"/>
...
<div class="panel ui-corner-all">
	<div id="div_main">
	    <div class="panel-header">
	        <div class="clearfix"> 
				<span class="breadcrumb left">	    
					<span class="ui-icon icon-breadcrumb"></span><s:text name="CIO16_native1" />&nbsp;&gt;&nbsp;<s:text name="CIO16_native2"></s:text>
				</span>
	        </div>
	    </div>
	    <%-- ================== 信息提示区 START ======================= --%>
	    	...
	    	<div class="box-yew">
				<div class="box-yew-header clearfix">
					<strong class="left">
						...
						<s:text name="CIO16_importExplanation" />
					</strong> 
					<a id="expandCondition" style="margin-left: 25px; font-size: 12px; width: 80px" class="ui-select right"> 
						<span class="button-text choice" style="min-width: 50px;">
							<s:text name="CIO16_moreExplanation" />
						</span> 
				...
				<div class="box-yew-content">
					<div class="step-content">
						...
						<div class="step">
							<s:text name="CIO16_explanation1" />
						</div>
						<div class="line"></div>
					</div>
					<div id="moreCondition" style="display: none;">
						<div class="step-content">
							...
							<div class="step">
								<s:text name="CIO16_explanation2" />
							</div>
							<div class="line"></div>
						</div>
						<div class="step-content">
							...
							<div class="step">
								<s:text name="CIO16_explanation3" />
							</div>
							<div class="line"></div>
						</div>
						<div class="step-content">
							...
							<div class="step">
								<s:text name="CIO16_explanation4" />
							</div>
							<div class="line"></div>
						</div>
						<div class="step-content">
							...
							<div class="step">
								<s:text name="CIO16_explanation5" />
							</div>
							<div class="line"></div>
						</div>
					</div>
	    	...
	    	<div class="box2 box2-active">
				<div class="box2-header clearfix">
					<strong class="active left">
						...
						<s:text name="CIO16_inDepotConditions" />
					</strong>
				</div>
				<div class="box2-content clearfix">
					 <table class="detail" cellpadding="0" cellspacing="0">
						<tr>
							<th><s:text name="CIO16_brandName" /></th>
							<td>
							...
							<th><s:text name="CIO16_importBatch" /><span class="highlight">*</span></th>
							<td>
								<span id="importBatchCodeSpan"><s:textfield name="importBatchCode" id="importBatchCode" cssClass="text" maxlength="25" /></span>
								<span>
									<input type="checkbox" id="isChecked" name="isChecked" onclick="BINOLMOCIO16_1.isChecked(this);">
									 <s:text name="CIO16_fromExcel" />
								</span>
							</td>
						</tr>
						 <tr>
							<th><s:text name="CIO16_importReson" /></th>
							<td colspan="3" style="word-wrap: break-word; word-break: break-all;" >
								<span>
									<s:textarea cssStyle="height:25px;width:800px"  maxlength="200" id="comments" name="comments"></s:textarea>
								</span>
							</td>
						</tr>
					</table>    
			...
			<div class="box2 box2-active">
				<div class="box2-header clearfix">
					<strong class="active left">
						...
						<s:text name="CIO16_title" />
					</strong>
				</div> 
		        <div class="box2-content clearfix">
	        		<div class="box4-content">
						<span style="margin-left:10px; display: inline;" class="left hide"> 
							<span class="highlight"><s:text name="CIO16_snow" /></span>
							<s:text name="CIO16_notice"/>
							<a href="${downLoad_url }"><s:text name="CIO16_down"/></a>
						    <input class="input_text" type="text" id="pathExcel" name="pathExcel"/>
						    <input type="button" value="<s:text name="global.page.browse"/>"/>
						    <input class="input_file" type="file" name="upExcel" id="upExcel" size="33" onchange="BINOLMOCIO16_1.deleteActionMsg();pathExcel.value=this.value;return false;" /> 
						    <input type="button" value="<s:text name="CIO16_importExcel_btn"/>" onclick="BINOLMOCIO16_1.ajaxFileUpload('${import_url}','0');return false;" id="upload_0"/>
						    <input type="button" value="<s:text name="CIO16_impAndPublish_btn"/>" onclick="BINOLMOCIO16_1.ajaxFileUpload('${import_url}','1');return false;" id="upload_1"/>
		     ...
		     <div class="center clearfix" id="closeButton">
	            <button onclick="BINOLMOCIO16_1.close();return false;" type="button" class="close" id="close">
	    ...
	    <div id="errMsg">
	    	...
	    	<input type="hidden" id="errmsg2" value='<s:text name="CIO16_error1"/>'/>
	    	<input type="hidden" id="errmsg3" value='<s:text name="CIO16_error2"/>'/>
	    	<input type="hidden" id="errmsg4" value='<s:text name="CIO16_error3"/>'/>
	    </div>
	</div>
</div>
</s:i18n>
