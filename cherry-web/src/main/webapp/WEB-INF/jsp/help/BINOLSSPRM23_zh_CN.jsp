...
<%@ taglib prefix="s" uri="/struts-tags" %>  
        <div class="box-yew">
            ...
            <div class="box-yew-content bg_yew">                
               	<div class="text">
               		商品盘点（盲盘）：商品盘点（盲盘），是指不显示库存数量，对所有促销品进行盘点，将盘点信息存入库存中。
               		所有的盘点操作后点击“反映到库存”按钮，都将生成盘点单，可在“各类报表”目录下的页面查询相应的盘点单。
               	</div>
            </div>
        </div>	
        <div class="box-yew">
            ...
            <div class="box-yew-content">
            	<div class="step-content">
                    ...
                    <div class="step">                    
                                                               ...
                                                               可对每项商品进行盘点。盘点完成后，点击页面下方“反映到库存”按钮，进行保存盘点的内容。 点击“取消”按钮，将取消
                                                               查询列表的显示，返回到查询界面。
                    </div>
                    <div class="line"></div>
                </div>
        ...
        <div class="box-yew">
            ...
            <div class="box-yew-content">
            	<div class="step-content">
                    <label>1</label>
                    <div class="step">
                                                             需要注意的：默认的会将所有启用的促销品信息盘点出来，如果想盘点停用的促销品选择“包括停用促销品”复选框即可。      
                    </div>
                    <div class="line"></div>
                </div>
            </div>
