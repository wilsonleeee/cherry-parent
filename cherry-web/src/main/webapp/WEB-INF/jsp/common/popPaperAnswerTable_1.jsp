...
<ul>
<li><input type="radio" name="checkPaperId" value="<s:property value="#checkPaperMap.paperId"/>" />
<span style="display:none;"><input id="paperType" value="<s:property value="#checkPaperMap.paperType"/>"/></span>
</li>
