...
<label><s:text name="export.exportCharset"></s:text></label>
<s:select list='#application.CodeTable.getCodes("1279")' listKey="CodeKey" listValue="Value" name="charset"></s:select>
</p>
