...
<s:url action="BINOLCM02_popPaperAnswer" namespace="/common" id="popPaperUrl" />
<span id ="popPaperUrl" style="display:none">${popPaperUrl}</span>
<span id ="AnswerpaperTitle" style="display:none"><s:text name="global.page.AnswerpaperTitle"/></span><%--问卷信息 --%>