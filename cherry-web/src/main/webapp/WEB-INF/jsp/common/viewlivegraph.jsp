...
<div class="hide">
    <span id="header_noBatchWorkFlowFileInfo"><s:text name="header.noBatchWorkFlowFileInfo"></s:text></span>
</div>
...
if(currentStepIds.file == 0){
	$("#workflowCanvas").html("<p><label style='font-weight:bold;text-align:right;margin-top:100px;margin-left:100px;'>"+$("#header_noBatchWorkFlowFileInfo").text()+"</label><p>");
}else{
	var steps = ${stepsJson};
	//set up graphics
