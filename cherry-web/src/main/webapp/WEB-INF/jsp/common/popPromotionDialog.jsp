...
<%@ taglib prefix="s" uri="/struts-tags" %>  
	<s:url id="s_prmSearchUrl" value="/common/BINOLCM02_popPrmDialog" />
<script type="text/javascript" src="/Cherry/js/common/popDataTable.js"></script>
<s:i18n name="">
<div id ="promotionDialog" class="dialog hide">
    <input class="text" value="" id="promotionDialogSearch" onKeyup ="datatableFilter(this,23);" maxlength="50"/>
    <a class="search" onclick="datatableFilter('#promotionDialogSearch',23)">
		       ...
		       <thead>
		            <tr>
		               <th>
		               	...
		               	<input type="checkbox" id="prm_checkAll"/>
		              	</s:if>
               		  	<label for="prm_checkAll"><s:text name="global.page.Popselect"/></label>
		               </th>         <%-- 选择 --%>
		        ...
		        <tbody id="prm_dataTableBody"></tbody>
		    </table>
	<s:if test='%{param == null || "".equals(param)}'>	    
	   </div>
   </div>
   </s:if>
   <div class="hide" id="promotionDialog_temp"></div>
