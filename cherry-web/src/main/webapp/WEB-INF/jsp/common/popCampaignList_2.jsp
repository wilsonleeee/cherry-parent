...
<input type="text" class="text" onKeyup ="datatableFilter(this,77);" id="searchKey"/>
<a class="search" onclick="datatableFilter('#searchKey',77);return false;"><span class="ui-icon icon-search"></span><span class="button-text"><s:text name="global.page.searchfor"/></span></a>
<hr class="space" />

<div class="ui-tabs">

<ul class ="ui-tabs-nav clearfix">
    <li id="0" class="ui-tabs-selected" onclick="changeTab(this, 77, 'campaignMode');"><a><s:text name="global.page.campaignMode0"/></a></li>
    <li id="1" onclick="changeTab(this, 77, 'campaignMode');"><a><s:text name="global.page.campaignMode1"/></a></li>
    <li id="2" onclick="changeTab(this, 77, 'campaignMode');"><a>优惠券活动</a></li>
</ul>

<div class="right" style="margin: -25px 15px 0 0;">
<input type="radio" value="1" name="campaignValid" onclick="changeValid(this,77);" checked="checked">
<span><s:text name="global.page.valid" /></span>
<input type="radio" value="0" name="campaignValid" onclick="changeValid(this,77);">
...
<s:url action="BINOLCM02_popCampaignDialog2" id="searchCampaignListUrl"></s:url>
