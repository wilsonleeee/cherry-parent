...
<div class="main container clearfix">
	<div class="panel ui-corner-all">
	  	...
	  	<div id="actionResultDisplay" class="hide">
			<div id="actionResultDiv" class="actionSuccess">
		  		<ul class="actionMessage">
	                <li><span><s:text name="SCF06_optionSuccess"></s:text></span></li>
				</ul>
			</div>
		</div>
		<div id="errorDiv" class="actionError" style="display:none">
	  	...
	  	<cherry:form id="mainForm" method="post" class="inline" csrftoken="false" action="BINOLPLSCF08_init">
	        <s:hidden name="codeManagerID" value="%{codeManagerID}"/>
	        <input type="hidden" id="parentCsrftoken" name="csrftoken"/>
        </cherry:form>
	  	<cherry:form id="coderForm" method="post" class="inline" csrftoken="false">
	  	...
	  	<div class="panel-content">
	  		<div class="section">
                ...
                <cherry:form id="editMainInfo" method="post" class="inline hide" csrftoken="false">
			...
			<div class="section">
		        ...
		        <div class="section" id="coderSection">
		          ...
		          <div id="shwoListInfo">
		            ...
		            <cherry:form id="editListInfo" method="post" class="inline hide" csrftoken="false">
