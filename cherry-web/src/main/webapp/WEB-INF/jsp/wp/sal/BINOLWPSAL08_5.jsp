...
<script type="text/javascript" src="/Cherry/js/wp/sal/BINOLWPSAL08_5.js"></script>
...
<div class="hide">
		...
		<input type="hidden" id="maincode_LYHD_5" value="<s:property value='maincode'/>">
		<input type="hidden" id="memberCode_LYHD_5" value="<s:property value='memberCode'/>">
		<input type="hidden" id="subjectCode_LYHD_5" value="<s:property value='subjectCode'/>">
</div>
	<div class="wpleft_header">
	 ...
	 <div class="wp_tablebox">
	    ...
	    <tbody>
	    	<tr>
                <th><s:text name="wpsal08.memcodeValidRule" /></th>
    ...
    <div class="bottom_butbox clearfix">
    	<button id="btnConfirm" class="close" type="button" onclick="BINOLWPSAL08_5.confirm();return false;">
    		<span class="ui-icon icon-confirm"></span>
			<span class="button-text"><s:text name="wpsal08.confirm"/></span>
		</button>
		<button id="btnCancel" class="close" type="button" onclick="BINOLWPSAL08_5.cancel();return false;">
