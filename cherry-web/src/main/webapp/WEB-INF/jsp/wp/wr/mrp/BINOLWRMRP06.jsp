    ...
    <div class="panel-header">
	  <div class="clearfix"> 
		<span class="breadcrumb left">	    
		  ...
		  <s:text name="WRMRP06_wreport"></s:text>&nbsp;&gt;&nbsp;<s:text name="WRMRP06_memInfo"></s:text>
		</span>
	  </div>
    </div>
    <div class="panel-content">
        ...
        <cherry:form id="queryParam" class="inline">
          ...
          <div class="box-content clearfix">
            ...
            <div class="column last" style="width:49%; height: auto;">
              ...
              <p>
               	<label><s:text name="WRMRP06_mobilePhone"/></label>
      ...
      <div class="section">
        ...
        <div class="section-content">
          ...
          <cherry:show domId="BINOLWRMRP06EXP">
          ...
          <table id="resultDataTable" cellpadding="0" cellspacing="0" border="0" class="jquery_table" width="100%">
            <thead>
              <tr>              
                <th><s:text name="WRMRP06_number" /></th>
                <th><s:text name="WRMRP06_billCode" /></th>
                <th><s:text name="WRMRP06_saleTime" /></th>
                <th><s:text name="WRMRP06_memCode" /></th>
                <th><s:text name="WRMRP06_memName" /></th>
                <th><s:text name="WRMRP06_employeeId" /></th>
                <th><s:text name="WRMRP06_quantity" /></th>
                <th><s:text name="WRMRP06_amount" /></th>
              </tr>
            </thead>           
          </table>
        </div>
...
<div class="hide">
<s:a action="BINOLWRMRP06_search" id="searchUrl"></s:a>
<s:a action="BINOLWRMRP06_exportCheck" id="exportCheckUrl"></s:a>
<s:a action="BINOLWRMRP06_exportExcel" id="exportExcelUrl"></s:a>
<s:a action="BINOLWRMRP06_exportCsv" id="exportCsvUrl"></s:a>
</div>
<%-- ================== dataTable共通导入 START ======================= --%>
	...
	function searchList() {
		...
		var tableSetting = {
				 ...
				 aoColumns: [{ "sName": "number", "sWidth": "5%", "bSortable": false},
				             { "sName": "billCode", "sWidth": "15%", "bSortable": false},
