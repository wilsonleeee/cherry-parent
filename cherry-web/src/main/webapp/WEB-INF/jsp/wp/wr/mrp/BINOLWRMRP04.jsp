    ...
    <div class="panel-header">
	  <div class="clearfix"> 
		<span class="breadcrumb left">	    
		  ...
		  <s:text name="WRMRP04_wreport"></s:text>&nbsp;&gt;&nbsp;<s:text name="WRMRP04_memInfo"></s:text>
		</span>
	  </div>
    </div>
    <div class="panel-content">
        ...
        <cherry:form id="queryParam" class="inline">
          ...
          <div class="box-content clearfix">
            ...
            <div class="column last" style="width:49%; height: auto;">
              ...
              <p>
               	<label><s:text name="WRMRP04_mobilePhone"/></label>
      ...
      <div class="section">
        ...
        <div class="section-content">
          ...
          <cherry:show domId="BINOLWRMRP04EXP">
          ...
          <table id="resultDataTable" cellpadding="0" cellspacing="0" border="0" class="jquery_table" width="100%">
            <thead>
              <tr>              
                <th><s:text name="WRMRP04_number" /></th>
                <th><s:text name="WRMRP04_billNo" /></th>
                <th><s:text name="WRMRP04_tradeDateTime" /></th>
                <th><s:text name="WRMRP04_memCode" /></th>
                <th><s:text name="WRMRP04_memName" /></th>
                <th><s:text name="WRMRP04_employeeId" /></th>
                <th><s:text name="WRMRP04_quantity" /></th>
                <th><s:text name="WRMRP04_amount" /></th>
              </tr>
            </thead>           
          </table>
        </div>
...
<div class="hide">
<s:a action="BINOLWRMRP04_search" id="searchUrl"></s:a>
<s:a action="BINOLWRMRP04_exportCheck" id="exportCheckUrl"></s:a>
<s:a action="BINOLWRMRP04_exportExcel" id="exportExcelUrl"></s:a>
<s:a action="BINOLWRMRP04_exportCsv" id="exportCsvUrl"></s:a>
</div>
<%-- ================== dataTable共通导入 START ======================= --%>
	...
	function searchList() {
		...
		var tableSetting = {
				 ...
				 aoColumns: [{ "sName": "number", "sWidth": "5%", "bSortable": false},
				             { "sName": "billNo", "sWidth": "15%", "bSortable": false},
				             { "sName": "tradeDateTime", "sWidth": "15%" },
