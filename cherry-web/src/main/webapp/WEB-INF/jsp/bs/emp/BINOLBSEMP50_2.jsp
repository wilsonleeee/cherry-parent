...
<script type="text/javascript" src="/${CHERRY_CONTEXT_PATH}/js/bs/emp/BINOLBSEMP50_1.js"></script>
<%-- 实时刷新数据权限URL --%>
...
<%-- 保存编辑 --%>
<s:url id="saveEdit_url" value="/basis/BINOLBSEMP50_saveEdit"></s:url>
...
<div class="panel ui-corner-all">
    ...
    <form id="editForm" method="post" class="inline">
              ...
              <div class="section-content">
                <table class="detail" cellpadding="0" cellspacing="0">
                  <tr>
        			...
        			<s:else>
        				<s:textfield id="baCode" maxlength="15" cssClass="text" cssStyle="color:red;" name="baCode" value="%{baInfo.baCode}" onchange="BINOLBSEMP50_1.clearError(this);"></s:textfield>
        			</s:else>
                    </span></td>
                  </tr>
                  <tr>
                    ...
                    <td>
				      	...
				      	<s:hidden name="operateFlag" id="operateFlag" value="%{baInfo.operateFlag}"></s:hidden>
				      	...
				      	<a id="selectCounterButton" class="add right" style="margin-left:50px" onclick="BINOLBSEMP50_1.popCounter(this);return false;">
                    ...
                    <td><span>
                    	...
                    	<s:else>
                    		<s:textfield id="baName" maxlength="30" cssClass="text" cssStyle="color:red;" name="baName" value="%{baInfo.baName}" onchange="BINOLBSEMP50_1.clearError(this);"></s:textfield>
                    	</s:else>
                    </span></td>
                  </tr>
                  <tr>
                    ...
                    <td class="date"><span>
                    	<s:if test="!baInfo.commtDateError">
                    		...
                    		<s:textfield id="commtDate" cssClass="date" cssStyle="color:red;" name="commtDate" value="%{baInfo.commtDate}" onchange="BINOLBSEMP50_1.clearError(this);"></s:textfield>
                    	</s:else>
                    </span></td>
                    ...
                    <td class="date"><span>
	                    <s:if test="!baInfo.depDateError && !baInfo.depDateValidError">
	                    	...
	                    	<span><s:textfield id="depDate" cssClass="date" cssStyle="color:red;" name="depDate" value="%{baInfo.depDate}" onchange="BINOLBSEMP50_1.clearError(this);"></s:textfield></span>
	                    </s:else>
                    </span></td>
                  </tr>
                  <tr>
                  	...
                  	<td><span>
	                    <s:if test="!baInfo.mobilePhoneError">
	                    	...
	                    	<span><s:textfield id="mobilePhone" cssClass="text" cssStyle="color:red;" name="mobilePhone" value="%{baInfo.mobilePhone}" onchange="BINOLBSEMP50_1.clearError(this);"></s:textfield></span>
	                    </s:else>
                    </span></td>
                  	<th></th>
                  	<td></td>
		...
		<div id="saveButton" class="center clearfix">
			<button class="save" onclick="BINOLBSEMP50_1.saveEdit('${saveEdit_url}');return false;">
