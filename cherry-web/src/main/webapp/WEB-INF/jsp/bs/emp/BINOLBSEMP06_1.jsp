...
<s:iterator value="errorBaList" id="baMap">
	<s:url id="editInit" action="BINOLBSEMP06_editInit">
        <%-- 柜台消息ID --%>
    </s:url>
	<tr id="<s:property value='baCode'></s:property>">
        ...
        <td>
        	<span style="margin: 5px;">
        		<a href="${editInit}?jsonStr=<s:property value='jsonStr'></s:property>&&baCode=<s:property value='baCode'></s:property>" class="popup" onclick="javascript:openWin(this);return false;">
        ...
        <td>
        	<span style="margin: 5px;">
        		<a href="#" class="delete" onclick="BINOLBSEMP06.delErrorBA('<s:property value='baCode'></s:property>');return false;">
