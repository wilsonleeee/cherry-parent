...
<script type="text/javascript" src="/${CHERRY_CONTEXT_PATH}/js/bs/emp/BINOLBSEMP50.js"></script>
<%-- BA模板下载URL --%>
<s:url id="downLoad_url" value="/download/BA导入模板.xls"/>
<%-- BA批量导入URL --%>
<s:url id="import_url" value="/basis/BINOLBSEMP50_import"/>
        ...
        <div class="section-content">
        	<cherry:form id="mainForm" class="inline">
				...
				<table class="detail" cellpadding="0" cellspacing="0">
		            <tr>
		                <td>
		                	<s:hidden id="operateFlag" name="operateFlag" value="%{operateFlag}"/>
		                	<input class="input_text" type="text" id="pathExcel" name="pathExcel" />
							<input type="button" value="<s:text name="global.page.browse"/>"/>
		                	<input type="file" name="upExcel" id="upExcel" class="input_file"  size="33" onchange="pathExcel.value=this.value;BINOLBSEMP50.deleteActionMsg();return false;"/>
		        			<input type="button" value="<s:text name="EMP06_importExcel_btn"/>" onclick="BINOLBSEMP50.ajaxFileUpload('${import_url}');return false;" id="upload"/>
