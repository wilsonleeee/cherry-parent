...
<s:i18n name="i18n.bs.BINOLBSWEM02">
<div class="main container clearfix">
<div id="div_main">
<div class="panel-header">
  <div class="clearfix"> 
    <span class="breadcrumb left"> <span class="ui-icon icon-breadcrumb"></span><s:text name="WEM02_Manage" />&nbsp;&gt;&nbsp;<s:text name="WEM02_OrderDiscount"></s:text></span> 
  </div>
</div>
...
<div class="box">
	<div class="box-header">
		...
		<s:text name="WEM02_OrderDiscount" />
		</strong>
</div>
	<table class="detail" cellpadding="0" cellspacing="0" style="width: 100%">
	 <tr>
	    <th><s:text name="WEM02_No"></s:text></th>
	    <th><s:text name="WEM02_level"></s:text></th>
	    <th><s:text name="WEM02_DiscountPer"></s:text></th>
	  </tr>
	  <s:iterator value='agentLevelList' id="code" status="status">
	  <tr align="center">
	  	<td>${status.index+1}</td>
	  	<td>${code.Value}<input type="hidden" id="codeVal" name="orderDiscountConfList[${status.index}].departType" value="${code.CodeKey}"/></td>
	  	<td><span><input type="text" id="discountPer" name="orderDiscountConfList[${status.index}].discountPer"  value="${code.discountPer}" class="aa"/>%</span></td>
	  </tr>
	  </s:iterator>
	</table>      
<hr class="space" />
