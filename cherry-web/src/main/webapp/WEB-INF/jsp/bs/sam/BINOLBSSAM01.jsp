...
<script type="text/javascript" src="/Cherry/js/bs/sam/BINOLBSSAM01.js"></script>
		...
		<div class="clearfix">
			<span class="breadcrumb left"> <span
				class="ui-icon icon-breadcrumb"></span> <s:text
					name="SAM01_samTitle" /> &gt; <s:text name="SAM01_counterScheduling" /></span>
		</div>
	</div>
	<div class="panel-content">
		<div class="box">
			<cherry:form id="scheduleForm" class="inline">
				<div class="box-header">
					<%--主题活动搜索条件--%>
					<span class="ui-icon icon-ttl-search"></span> <strong><s:text
							name="SAM01_scheduleSearch" /></strong>
				</div>
				<div class="box-content clearfix">
					<div style="width: 50%; height: 55px;" class="column">
						<p class="clearfix">
							<%--班次类型--%>
							<label style="width: 80px;"><s:text name="SAM01_type" /></label>
							<span> <s:select name="type" Cssstyle="width:186px;"
									list='#application.CodeTable.getCodes("1358")'
					...
					<div style="width: 49%; height: 55px;" class="column last">
						<p class="date">
							<label><s:text name="SAM01_workDate"/></label>
		...
		<div id="resultList" class="hide">
			<div class="section">
				...
				<div class="section-content">
					<table id="resultScheduleDataTable" cellpadding="0" cellspacing="0"
						border="0" class="jquery_table" width="100%">
						<thead>
							<tr>
								<th><s:text name="SAM01_number" /></th>
								<th><s:text name="SAM01_workDate" /></th>
								<th><s:text name="SAM01_type" /></th>
								<th><s:text name="SAM01_workBeginTime" /></th>
								<th><s:text name="SAM01_workEndTime" /></th>
								<th><s:text name="SAM01_memo" /></th>
							</tr>
						</thead>
					</table>
				</div>
...
<div class="hide">
	<s:a action="BINOLBSSAM01_search" id="searchUrl"></s:a>
	<%-- ================== dataTable共通导入 START ======================= --%>
