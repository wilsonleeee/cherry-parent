...
<ul>
<li><input id="higher" type="radio" name="higher" value='<s:property value="#employeeMap.path"/>' />
	<input id="employeeId" type="hidden" name="employeeId" value='<s:property value="#employeeMap.employeeId"/>' />
</li>
