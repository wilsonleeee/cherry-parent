...
<%--礼品领用报表查询URL --%>
<s:url id="search_url" value="/cp/BINOLCPACT07_search"/>
<%--礼品领用结果导出URL --%>
<s:url id="export_url" value="/cp/BINOLCPACT07_export"/>
...
<s:i18n name="i18n.cp.BINOLCPACT07">
		...
		<div class="clearfix">
			<span class="breadcrumb left"> <span
				class="ui-icon icon-breadcrumb"></span> <s:text
					name="ACT07_memberActivities" /> &gt; <s:text
					name="ACT07_giftDraw" /></span>
		</div>
	</div>
	...
	<div class="section">
		<cherry:form id="mainForm" class="inline" >
	        ...
	        <div class="column" style="width:50%;height:auto;">
	        	<p class="clearfix">
					<%--品牌--%>
					<label><s:text name="ACT07_brand"/></label>
					<s:select cssStyle="width:185px" name="brandInfoId" list="brandInfoList" listKey="brandInfoId" listValue="brandName" value="%{brandInfoId}"/>
				</p>
				<p class="clearfix">
		            <%--单据号--%>
			...
			<div class="column last" style="width:49%;height:auto;">
	            ...
	            <p class="clearfix">
		            <%--主题活动号--%>
		            <label><s:text name="ACT07_activity"/></label>
		            <!-- 下拉框选择显示名称 -->
		            <s:textfield id="activityName" name="activityName" cssClass="text"/>
		            <!-- 查询时用code进行查询 -->
		            <s:hidden id="activityCode" name="activityCode"/>
	            </p>
	 		 </div>
	         </div>
				<p class="clearfix">
	...
	<div id="section" class="section hide" >
		...
		<div class="ui-tabs-panel">
			...
			<cherry:show domId="BINOLCPACT07EXP">
           		<span style="margin-right:10px;">
                   <a id="export" class="export" onclick="BINOLCPACT07.exportExcel();return false;">
...
<span id="exportUrl" style="display:none">${export_url}</span>