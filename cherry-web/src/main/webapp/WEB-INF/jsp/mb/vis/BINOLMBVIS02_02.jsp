	    ...
	    <div class="clearfix">
	       <span class="breadcrumb left"> 
	          <span class="ui-icon icon-breadcrumb"></span>
				<s:text name="mbvis02_visitMng"/> &gt; <s:text name="mbvis02_addVisitPlan"/>
	       </span>
	    </div>
	  </div>
			...
			<div class="section">
              ...
              <div class="section-content">
                <table class="detail" cellpadding="0" cellspacing="0">
					  ...
					  <td colspan="3">
					    <span>
					  	<select name="visitObjType" id="visitObjType">
					  	  ...
					  	  <option value="1"><s:text name="mbvis02_visitObjType1" /></option>
					  	  <option value="2"><s:text name="mbvis02_visitObjType2" /></option>
					  	</select>
					    </span>
					    <span class="hide">
					      <label id="visitObjLabel"></label>
					      <s:hidden name="visitObjJson"></s:hidden>
					      <a id="visitObjQuery" class="search">
					        <span class="ui-icon icon-search"></span><span class="button-text"><s:text name="global.page.Popselect" /></span>
					      </a>
					    </span>
					    <span class="hide">
					      <label id="visitObjNameLabel"></label>
					      <s:hidden name="visitObjCode"></s:hidden>
					      <s:hidden name="visitObjName"></s:hidden>
				    ...
				    <tr>
				      <th><s:text name="mbvis02_visitDateType" /><span class="highlight"><s:text name="global.page.required"></s:text></span></th>
					  <td>
					    <span>
					  	<select name="visitDateType" id="visitDateType" style="width:auto;">
					  	  <option value=""><s:text name="global.page.select" /></option>
					  	  <option value="1"><s:text name="mbvis02_visitDateType1" /></option>
					  	  <option value="2"><s:text name="mbvis02_visitDateType2" /></option>
					  	  <option value="3"><s:text name="mbvis02_visitDateType3" /></option>
					  	  <option value="4"><s:text name="mbvis02_visitDateType4" /></option>
					  	</select>
					  	</span>
					  	<span class="hide">
						  	<s:textfield name="visitStartDate" cssClass="date"></s:textfield>-
						  	<s:textfield name="visitEndDate" cssClass="date"></s:textfield>
					  	</span>
					  	<span class="hide">
						  	<select name="visitDateRelative" style="width:auto;">
						  	  <option value="1"><s:text name="mbvis02_visitDateRelative1" /></option>
						  	  <option value="2"><s:text name="mbvis02_visitDateRelative2" /></option>
						  	</select>
						  	<s:textfield name="visitDateValue" cssClass="text" cssStyle="width:40px"></s:textfield>
						  	<select name="visitDateUnit" style="width:auto;">
						  	  <option value="1"><s:text name="mbvis02_visitDateUnit1" /></option>
						  	  <option value="2"><s:text name="mbvis02_visitDateUnit2" /></option>
						  	</select>
						  	<label><s:text name="mbvis02_endDate" /></label>
						  	<s:textfield name="validValue" cssClass="text" cssStyle="width:40px"></s:textfield>
				    ...
				    <tr>
				      ...
				      <td><span>
				      	<s:select name="paperId" list="paperList" listKey="paperId" listValue="paperName" headerKey="" headerValue="%{#select_default}"></s:select>
				      </span></td>
				    </tr>
				    <tr>
				      <th><s:text name="mbvis02_visitDes"></s:text></th>
				      <td><span>
				      	<s:textarea name="visitDes" cssClass="text"></s:textarea>
				      </span></td>
				    </tr>
                </table>
			  </div>
              ...
              <div class="section-content">
                <table class="detail" cellpadding="0" cellspacing="0">
	                <tr>
				      ...
				      <td style="width: 85%"><span>
				      	<s:textfield name="startDate" cssClass="date"></s:textfield>
				      </span></td>
				    </tr>
				    <tr>
				      ...
				      <td>
				      	...
				      	<select id="planDate" name="planDate">
					  	  ...
					  	  <option value="2"><s:text name="mbvis02_planDate2" /></option>
					  	</select>
					  	</span>
					  	<span class="hide"><s:textfield name="endDate" cssClass="date"></s:textfield></span>
				      </td>
				    </tr>
                </table>
			  </div>
...
$(function(){
	...
	// 回访类型改变时，如果回访类型绑定着搜索条件，那么把该条件设置到回访对象中
	$("#visitCategoryId").change(function(){
		var value = $(this).val();
		if(value) {
			var visitObjJson = $("#visitCategoryJson").find('li[value='+value+']').text();
			if(visitObjJson) {
				$("#visitObjType").val('1');
				$("#visitObjType").change();
