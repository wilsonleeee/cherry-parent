...
<div class="panel ui-corner-all">
	    ...
	    <div class="clearfix">
	       <span class="breadcrumb left"> 
	          <span class="ui-icon icon-breadcrumb"></span>
				<s:text name="mbvis03_visitMng"/> &gt; <s:text name="mbvis03_updateVisitType"/>
	       </span>
	    </div>
	  </div>
	  ...
	  <div class="panel-content clearfix">
        <cherry:form id="saveForm" class="inline" csrftoken="false">
			<s:hidden name="visitCategoryId" value="%{visitCategoryInfo.visitCategoryId}"></s:hidden>
			<s:hidden name="modifyTime" value="%{visitCategoryInfo.modifyTime}"></s:hidden>
			<s:hidden name="modifyCount" value="%{visitCategoryInfo.modifyCount}"></s:hidden>
			<div class="section">
              ...
              <div class="section-content">
                <table class="detail" cellpadding="0" cellspacing="0">
	                <tr>
				      ...
				      <td>
				      	<span><s:property value="%{visitCategoryInfo.visitTypeCode}"/></span>
				      </td>
				      <th><s:text name="mbvis03_visitTypeName"></s:text><span class="highlight"><s:text name="global.page.required"></s:text></span></th>
					  <td><span><s:textfield name="visitTypeName" cssClass="text" maxlength="20" value="%{visitCategoryInfo.visitTypeName}"></s:textfield></span></td>
				    </tr>
                </table>
			  </div>
			</div>
			...
			<div class="section" id="counterHeadDiv">
              ...
              <div class="section-content">
				<div id="visitObjJson">
				<s:action name="BINOLCM33_init" namespace="/common" executeResult="true">
				  <s:param name="reqContent" value="%{visitCategoryInfo.visitObjJson}"></s:param>
				</s:action>
				</div>
			  </div>
			</div>
...
<div class="hide">
<s:a action="BINOLMBVIS03_update" id="updateUrl"></s:a>
</div>
</s:i18n>
