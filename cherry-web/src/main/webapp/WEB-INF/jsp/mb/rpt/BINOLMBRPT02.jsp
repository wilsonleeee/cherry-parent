...
<script type="text/javascript" src="/Cherry/js/mb/rpt/BINOLMBRPT02.js"></script>
...
<div class="panel-header">
    <div class="clearfix"> 
      <span class="breadcrumb left"> 
    	...
    	<s:text name="mbrpt_memberManage"></s:text>&nbsp;&gt;&nbsp;<s:text name="mbrpt_bindCountRpt"></s:text> 
      </span> 
    </div>
</div>
...
<s:a action="BINOLMBRPT02_searchBindCount" id="searchBindCountUrl"></s:a>
<s:a action="BINOLMBRPT02_eptBindRpt" id="eptBindRptUrl"></s:a>
