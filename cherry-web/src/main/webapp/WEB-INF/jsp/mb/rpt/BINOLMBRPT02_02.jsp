...
<script type="text/javascript" src="/Cherry/js/mb/rpt/BINOLMBRPT02_02.js"></script>
...
<div class="panel-header">
    <div class="clearfix"> 
      <span class="breadcrumb left"> 
    	...
    	<s:text name="mbrpt_memberManage"></s:text>&nbsp;&gt;&nbsp;<s:text name="mbrpt_BindByCityRpt"></s:text> 
      </span> 
    </div>
</div>
...
<s:a action="BINOLMBRPT02_searchBindByCity" id="searchBindByCityUrl"></s:a>
<s:a action="BINOLMBRPT02_eptBindByCityRpt" id="eptBindByCityRptUrl"></s:a>
