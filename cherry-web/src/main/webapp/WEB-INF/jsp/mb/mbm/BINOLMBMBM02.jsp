...
<script type="text/javascript" src="/Cherry/js/mb/mbm/BINOLMBMBM02.js"></script>
...
<s:text name="global.page.select" id="select_default"></s:text>
	...
	<div class="crm_content_header">
	  ...
	  <span><s:text name="binolmbmbm02_memDetailTab" /></span>
	</div>
	  ...
	  <div class="section">
        ...
        <s:if test='%{"3".equals(clubMod)}'>
          <table class="detail" cellpadding="0" cellspacing="0">
            ...
            <tr>
	      	    <th><s:text name="binolmbmbm02_nickname"></s:text></th>
			    <td><span><s:property value="memberInfoMap.nickname"/></span></td>
			    <th><s:text name="binolmbmbm02_creditRating"></s:text></th>
			    <td><span><s:property value='#application.CodeTable.getVal("1317", memberInfoMap.creditRating)' /></span></td>
	      	</tr>
            <tr>
            ...
            <tr>
              <th><s:text name="binolmbmbm02_tencentQQ"></s:text></th>
		      <td><span><s:property value="%{memberInfoMap.tencentQQ}" /></span></td>
          ...
          <table class="detail" cellpadding="0" cellspacing="0">
           ...
           <table class="detail" cellpadding="0" cellspacing="0">
		    ...
		    <tr>
			  <th><s:text name="binolmbmbm02_profession"></s:text></th>
			  <td colspan="3"><span><s:property value='#application.CodeTable.getVal("1236", memberInfoMap.profession)' /></span></td>
			</tr>
			<tr>
              <th><s:text name="binolmbmbm02_maritalStatus"></s:text></th>
			  <td colspan="3"><span><s:property value='#application.CodeTable.getVal("1043", memberInfoMap.maritalStatus)' /></span></td>
            </tr>
            <tr>
              <th><s:text name="binolmbmbm02_connectTime"></s:text></th>
			  <td colspan="3"><span><s:property value="memberInfoMap.connectTimeValue" /></span></td>
	...
	<s:if test='%{!"3".equals(clubMod)}'>
	  <div class="section">
        <div class="section-header">
       	  <strong>
           	<span class="ui-icon icon-ttl-section-info"></span>
           <s:text name="binolmbmbm02_memClubMsg" />
          </strong>
	    </div>
	    <div class="section-content">
	    <table class="detail" cellpadding="0" cellspacing="0">
            <tr>
              <th><s:text name="binolmbmbm02_memClub" /></th>
			  <td>
			  <s:if test='%{clubList != null && clubList.size() != 0}'>
			  <s:select id="memberClubId" name="memberClubId" list="clubList" listKey="memberClubId" listValue="clubName" onchange="binolmbmbm02.changeClub(this)" Cssstyle="width:150px;"/>
	  ...
	  <div class="section">
        ...
        <div class="section-content">
			  ...
			  <tr>
			    ...
			    <td colspan="3"><s:property value="%{#memberAddressInfo.countyName}"/></td>
			  </tr>
	        </table>
	    </div>
	  </div>
	...
	<div class="hide">
	<s:url action="BINOLMBMBM02_changeClub" id="changeClub_Url"></s:url>
