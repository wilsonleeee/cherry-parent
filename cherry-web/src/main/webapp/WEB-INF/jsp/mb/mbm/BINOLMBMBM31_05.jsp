...
//        });
        $('#endTimeSave').cherryDate({
            beforeShow: function(input){
                var value = $('#rule_mapStartTime').val();
            ...
            <form id="editRuleForm" class="inline">
                ...
                <table class="detail">
                    ...
                    <tr>
                        ...
                        <td><span id="startTimeSave"><s:property value="rule_map.startTime"/></span></td>
                        <th class="date"><s:text name="MBM31_endDate"></s:text><span class="highlight">*</span></th>
                        <input type="hidden" id="rule_mapStartTime" name="rule_mapStartTime" value="<s:property value='rule_map.startTime' />"/>
                        <td>
                            <span>
                                <s:textfield id="endTimeSave" name="endTimeSave" cssClass="date" cssStyle="width:80px" value="%{rule_map.endTime}" />
                                <input  class="hide" id="endTimeEx" name="endTimeEx" value='<s:property value="rule_map.endTime"/>'/>
                            </span>
                        </td>
                    </tr>
                    <tr>
