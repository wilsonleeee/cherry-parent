...
<div id="aaData">
	<s:iterator value="prmInDepotExcelBatchList" id="prmInDepotExcelBatchMap">
		<ul>
			<li><span>${RowNumber}</span></li>
			<li>
				<span>
					<s:url action="BINOLSSPRM67_init" id="indepotExcelBatchUrl">
						<s:param name="importBatchId" value="%{#prmInDepotExcelBatchMap.importBatchId }" />
					</s:url>
			...
			<li>
				<a class="description" style="cursor: pointer;"  title="<s:text name="SSPRM66_importComments" /> | <s:property value="comments" />">
