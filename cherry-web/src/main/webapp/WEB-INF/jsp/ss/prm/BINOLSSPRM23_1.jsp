...
<s:i18n name="i18n.ss.BINOLSSPRM23">
       ...
       <div class="toolbar clearfix">         
           ...
           <% int i = 0; %>
            <s:iterator value="stockPromotionList" >            
             <tr id="dataRow<%= i %>" > 
               ...
               <td><s:text name="format.price"><s:param value="standardCost"></s:param></s:text></td>   
               <td id="dataTd6" style="text-align:right">
					<input type="text" id="quantityuArr<%= i %>"  name="quantityuArr" Class="text-number" size="10" maxlength="9" onchange="SSPRM23_changeCount(this,'<%= i %>')" />
				</td>
               ...
               <td style="display:none">
                ...
                <input type="hidden" id="priceUnit<%= i %>" name="priceUnitArr" value="<s:property value='standardCost'/>"/>
         ...
         <div class="center clearfix">            
            <button class="confirm" type="button" onclick="SSPRM23_submitFormSave()"><span class="ui-icon icon-confirm"></span><span class="button-text"><s:text name="btnOK"/></span></button>
         </div>      
       </div>
	<script type="text/javascript">
