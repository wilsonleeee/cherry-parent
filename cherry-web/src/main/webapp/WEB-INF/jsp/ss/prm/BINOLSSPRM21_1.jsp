...
<s:i18n name="i18n.ss.BINOLSSPRM21">
       ...
       <div class="toolbar clearfix">         
            ...
            <s:iterator value="stockPromotionList" >            
             <tr id="dataRow<%= i %>" > 
               ...
               <td id="dataTd6" style="text-align:right">
					<input type="text" id="quantityuArr<%= i %>"  name="quantityuArr" Class="text-number" size="10" maxlength="9" onchange="changeCount(this,'<%= i %>')" />
				</td>
         ...
         <div class="center clearfix">            
            <button class="confirm" type="button" onclick="submitFormSave()"><span class="ui-icon icon-confirm"></span><span class="button-text"><s:text name="btnOK"/></span></button>
         </div>      
       </div>
	<script type="text/javascript">
