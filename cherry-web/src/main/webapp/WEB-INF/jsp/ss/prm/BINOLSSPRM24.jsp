...
<s:i18n name="i18n.ss.BINOLSSPRM24">
...
<s:url id="url_getdepotAjax" value="/ss/BINOLSSPRM24_GETDEPOT" />
<span id ="s_getdepotAjax" style="display:none">${url_getdepotAjax}</span>

<s:url id="url_getLogicDepotAjax" value="/ss/BINOLSSPRM24_GETLOGICDEPOT" />
<span id ="s_getLogicDepotAjax" style="display:none">${url_getLogicDepotAjax}</span>

<s:url id="url_getStockCount" value="/ss/BINOLSSPRM24_GETSTOCKCOUNT" />
<span id ="s_getStockCount" style="display:none">${url_getStockCount}</span>

<s:url id="url_saveURL" value="/ss/BINOLSSPRM24_SAVE" />
    ...
    <div class="hide">
		...
		<div class="section-content">
			<table class="detail">
				<tr>
					...
					<td>
						<select style="width:200px;" name="organizationId" id="organizationId" onchange="SSPRM24_chooseDepart(this)" >		                  		
				...
				<tr>
					...
					<td>
						<select style="width:200px;" name="depot" id="depot" onchange="SSPRM24_clearDetail();">		                  		
					...
					<span id="pLogicDepot" class="<s:if test='null == logicDepotList || logicDepotList.size()==0'>hide</s:if>">
						...
						<td>
							<select style="width:200px;" name="logicDepot" id="logicDepot" onchange="SSPRM24_clearDetail();">                             
      ...
      <div id="mydetail" class="section">
          ...
          <div class="toolbar clearfix"><span class="left">
             <input id="allSelect" type="checkbox"  class="checkbox" onclick="SSPRM24_selectAll()"/>
             <s:text name="btnallselect"/><a class="add" onclick="SSPRM24_openPromotionSearchBox(this);"><span class="ui-icon icon-add"></span><span class="button-text"><s:text name="btnadd"/></span></a> <a class="delete" onclick="SSPRM24_deleterow();"><span class="ui-icon icon-delete"></span><span class="button-text"><s:text name="btndelete"/></span></a></span></div>
            ...
            <div class="center clearfix">            	
            	<button class="confirm" type="button" onclick="SSPRM24_submitFormSave()"><span class="ui-icon icon-confirm"></span><span class="button-text"><s:text name="btnOK"/></span></button>
            </div>
          </div>
        </div>
      </ct:form>
