...
<div id="aaData">
	<s:iterator value="activeInfoList" id="active">
		<%--发布URL --%>
    	<s:url id="publishUrl" value="/ss/BINOLSSPRM14_publicActive" >
	    	<s:param name="activeID">${active.activeID}</s:param>
	    </s:url>
	    <s:url id="checkUrl" value="/ss/BINOLSSPRM14_publicActive" >
		...
		<ul>
			...
			<%-- 操作 --%>
			<li>
				<cherry:show domId="SSPRM0214COPY">
				...
				<s:if test="#active.validFlag ==1">
					<cherry:show domId="SSPRM0214STOP">
				...
				<cherry:show domId="SSPRM14CHECK">
