...
function endSelect(){
	...
	if(okflag){
		...
		var argUrl = $('#s_getDetail').html();
		var params=$('#orderForm').formSerialize();
		window.opener.getAllocationDetail(argUrl,params);		
	}
	window.close();
	return false;
}
...
<div class="panel ui-corner-all">
	...
	<s:url id="url_getDetail" value="/ss/BINOLSSPRM20_GETDETAILDATA" />
	<span id ="s_getDetail" style="display:none">${url_getDetail}</span>
	<div class="center clearfix">
		...
		<s:form action ="" method ="POST" id="orderForm" name="orderForm"> 
         <table id="mainTable" cellpadding="0" cellspacing="0" border="0" width="100%">
           <thead>
             ...
             <th class="tableheader" width="3%" ><s:text name="lblRadio"/></th>
               ...
               <th class="tableheader" width="10%"><s:text name="lblAllocationNoIF"/></th>
               ...
               <th class="tableheader" ><s:text name="lblAllocationDate"/></th>
             </tr>
           </thead>
           <tbody id="databody">
           <% int i = 0; %>
            <s:iterator value="allocationList" status="status">            
             <tr id="dataRow<%= i %>" > 
               <td id="dataTd0" style="text-align:center"><input id="allocationchkbox" name="allocationchkbox" type="checkbox" value="<s:property value='BIN_PromotionAllocationID'/>_<s:property value='TaskInstanceID'/>"/></td>               
               <td id="dataTd1" style="text-align:center"><%= i+1 %></td>
               <td id="dataTd2"><s:property value='AllocationNoIF' /></td>
               <td id="dataTd3" style="text-align:center"><s:property value='RelevanceNo'/>&nbsp;</td>
               ...
               <td id="dataTd8"><s:property value='AllocationDate' /></td>
             </tr>
             <%  i += 1; %>
            </s:iterator>  
