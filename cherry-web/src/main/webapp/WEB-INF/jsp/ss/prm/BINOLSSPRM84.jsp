...
<script type="text/javascript" src="/Cherry/js/ss/prm/BINOLSSPRM84_15.js"></script>
<script type="text/javascript" src="/Cherry/js/ss/prm/BINOLSSPRM84.js"></script>
...
$(document).ready(function() {
	...
	holidays = '${holidays}';
	// js 国际化变量设置
	BINOLSSPRM84_js_i18n.counter = '<s:text name="counter"/>';
	BINOLSSPRM84_js_i18n.channel = '<s:text name="channel"/>';
	BINOLSSPRM84_js_i18n.city = '<s:text name="city"/>';
    ...
    <s:url id="s_loadRuleUrl" value="/ss/BINOLSSPRM84_loadRule" />
    <%--新增促销活动URL --%>
    <s:url id="s_newPrmRuleUrl" value="/ss/BINOLSSPRM88_init" >
    	<s:param name="opt">1</s:param>
    </s:url>
    <%--促销活动查询URL --%>
	<s:url id="s_searchActiveUrl" value="/ss/BINOLSSPRM84_searchActive" />
    <%--促销活动下发URL --%>
    ...
    <%--促销主活动名查询URL --%>
    <s:url id="s_indSearchPrmGrpNameUrl" value="/ss/BINOLSSPRM84_indSearchPrmGrpName" />
    <%-- URL set end --%>
    ...
    <div class="panel-header">
		...
		<span class="breadcrumb left">	    
        	...
        	<cherry:show domId="SSPRM0216ADD">
        	...
        	<cherry:show domId="SSPRM0216RULE">
	        ...
	        <cherry:show domId="SSPRM0216LOAD">
