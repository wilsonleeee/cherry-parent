...
<script type="text/javascript" src="/Cherry/js/ss/common/BINOLSSCM06.js"></script>
<div id="deliverDialog" class="hide">
    <input type="text" class="text" onKeyup ="datatableFilter(this,9);" maxlength="50" id="deliverKw"/>
    <a class="search" onclick="datatableFilter('#deliverKw',9);return false;"><span class="ui-icon icon-search"></span><span class="button-text"><s:text name="global.page.searchfor"/></span></a>
...
<s:url action="BINOLSSCM06_getDeliver" namespace="/ss" id="popDeliver" />
