...
<h2>Description</h2>
<div id="description">
<p>The <code>checkbox</code> plugin makes multiselection possible
using three-state checkboxes. The checkbox plugin requires the <a
	href="ui.html">UI plugin</a>.</p>
</div>
...
<div class="panel">
<h3>Using the checkbox plugin - all you need to do is include it in
the list of active plugins.</h3>
...
<h2 id="api">API</h2>
<div class="panel api">
<p>The checkbox plugin maps UI's <a href="ui.html#get_selected">get_selected
function</a> to its own <a href="#get_checked">get_checked function</a> and
overwrites the <a href="ui.html#reselect">UI reselect function</a>. It
also disables the <code>select_node</code>, <code>deselect_node</code>
and <code>deselect_all</code> functions.
...
<p>Changes the state of a node. Used mostly internally - you'd be
better off using the <code>check_node</code> and <code>uncheck_node</code>
functions. Triggers an event.</p>
<ul class="arguments">
	<li><code class="tp">mixed</code> <strong>node</strong>
	<p>This can be a DOM node, jQuery node or selector pointing to an
	element within the tree.</p>
	...
	<p>If set to <code>true</code> the node is unchecked, if set to <code>false</code>
	the node is checked, otherwise - the state is toggled.</p>
	</li>
</ul>
...
<div style="height: 1px; visibility: hidden; overflow: hidden;"><span
	id="get_unchecked">&#160;</span></div>
<h3 id="get_checked">.get_checked ( context ), .get_unchecked (
context )</h3>
<p>Both functions return jQuery collections.</p>
<ul class="arguments">
	<li><code class="tp">mixed</code> <strong>context</strong>
	<p>This can be a DOM node, jQuery node or selector pointing to an
	element within the tree. If specified only nodes inside the specified
	context are returned, otherwise the whole tree is searched.</p>
	</li>
</ul>

<div style="height: 1px; visibility: hidden; overflow: hidden;"><span
	id="hide_checkboxes">&#160;</span></div>
