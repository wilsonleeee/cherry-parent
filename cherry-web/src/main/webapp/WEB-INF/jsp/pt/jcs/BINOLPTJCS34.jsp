...
<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS34.js"></script>
<script type="text/javascript" src="/Cherry/js/bs/common/BINOLBSCOM03.js"></script>
<%-- 产品添加URL --%>
<s:url id="add_url" action="BINOLPTJCS33_init"/>
      ...
      <div class="panel-header">
        <div class="clearfix">
			<span class="breadcrumb left">	    
       		...
       		<span class="right"> 
       		<%-- 产品下发按钮 --%>
       		<cherry:show domId="BINOLPTJCS3403">
       		...
       		<%-- 产品添加按钮 --%>
       		<cherry:show domId="BINOLPTJCS3401">
       		 	<a href="#" class="add" onclick="BINOLPTJCS34.addprt('${add_url}');return false;">
       		 		<span class="button-text"><s:text name="pro.add"/></span>
       		 		<span class="ui-icon icon-add"></span>
       		 	</a>
       		 	<%-- 批量添加 --%>
       		 	<a href="#" class="add" onclick="BINOLPTJCS34.openChkPrtDialogInit();return false;">
       		 		<span class="button-text"><s:text name="批量添加"/></span>
       		 		<span class="ui-icon icon-add"></span>
       		 	</a>
       		 	<%-- 根据条件导入产品 --%>
       		 	<a href="#" class="add" onclick="BINOLPTJCS34.openSelPrtDialogInit();return false;">
       		 		<span class="button-text"><s:text name="筛选导入"/></span>
       		 		<span class="ui-icon icon-add"></span>
       		 	</a>
       		 	
       		 </cherry:show>
       		 	<s:url action="BINOLPTJCS34_treeInit" id="treeModeInitUrl"/>
        		<s:url action="BINOLPTJCS34_listInit" id="listModeInitUrl"/>
        		<span class="hide">
        		...
        		<a id="treeMode" class="display display-tree display-tree-on" title='<s:text name="pro.treeMode"></s:text>' 
        			onclick="BINOLPTJCS34.changeTreeOrTable(this,'${treeModeInitUrl}');return false;"></a>
       			<a id="listMode" class="display display-table" title='<s:text name="pro.listMode"></s:text>' 
        			onclick="BINOLPTJCS34.changeTreeOrTable(this,'${listModeInitUrl}');return false;"></a>
       			</span>
       		</span>
       	</div>
        ...
        <!-- 查看当前启用的条码是否存在且有效 -->
		<s:url id="issuedPrtUrl" action="BINOLPTJCS34_issuePrt"/>
		<span class="hide" id="issuedPrtId">${issuedPrtUrl}</span>
      </div>
      <div id="treeOrtableId">
	  	<!-- <s:action name="BINOLPTJCS34_treeInit" executeResult="true"></s:action> -->
	  	<s:action name="BINOLPTJCS34_listInit" executeResult="true"></s:action>
	  </div>
</s:i18n>	 