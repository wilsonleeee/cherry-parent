...
<%-- 产品查询URL --%>
<s:url id="search_url" value="/pt/BINOLPTJCS24_search"/>
        ...
        <div class="box">
          <cherry:form id="mainForm" class="inline" onsubmit="search(); return false;">
            ...
            <p class="clearfix">
              	<%--<cherry:show domId="">--%>
              		<%-- 产品查询按钮 --%>
              		<button class="right search" type="button" onclick="BINOLPTJCS24.search('${search_url}');return false;">
        ...
        <div id="section" class="section">
          ...
          <div class="section-content">
            <div class="toolbar clearfix">
                <span class="left">
                    <cherry:show domId="BINOLPTJCS04EXPSSSSSSSSSSSSSSSSS">
                ...
                <cherry:show domId="BINOLPTJCS04BATSSSSSSSSSSSSSSSSS">
	                <a href="" class="delete" onclick="BINOLPTJCS24.editBatchValidFlag('disable','${delProduct}');return false;">
