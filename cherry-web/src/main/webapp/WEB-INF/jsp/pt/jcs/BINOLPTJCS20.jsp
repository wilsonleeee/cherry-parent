...
<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS20.js"></script>
...
<cherry:form id="toDetailForm" action="BINOLPTJCS19_init" method="post" csrftoken="false">
  ...
  <div class="clearfix"> 
   <span class="breadcrumb left"> <span class="ui-icon icon-breadcrumb"></span>
   		<s:if test='"0".equals(isPosCloud)'>
   			...
   			<s:text name="JCS20_detail"></s:text>
	    </s:if>
	    <s:elseif test='"1".equals(isPosCloud)'>
	    	<s:text name="solu_prtlisttitle1" />&nbsp;&gt;&nbsp;
	    	<s:text name="JCS20_editlistdetail"></s:text>
	    </s:elseif>
   </span> 
...
<div class="section">
 ...
 <div class="center clearfix" id="pageButton">
          ...
          <s:a action="BINOLPTJCS20_save" id="JCS20_save" cssStyle="display: none;"></s:a>
