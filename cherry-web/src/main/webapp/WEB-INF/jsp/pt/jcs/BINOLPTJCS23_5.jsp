...
<div id="bomDiv" class="section <s:if test="proMap == null || proMap.mode.indexOf('BOM') == -1">hide</s:if>">
    <div class="section-header clearfix">
    	<strong class="left">
    		...
    		<s:text name="JCS03_BOMList"/><%-- BOM列表 --%>
    	</strong>
    	<a class="add right" onclick="BINOLPTJCS00.addBOMs();return false;">																
      		<span class="ui-icon icon-add"></span>
			<span class="button-text"><s:text name="JCS03_addBOM"/></span><%-- 添加BOM组件--%>
      	</a>
    </div>
