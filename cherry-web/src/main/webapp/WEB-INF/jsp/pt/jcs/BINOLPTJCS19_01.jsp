		...
		<ul>
			...
			<li>
				<span class="editSaleClass"><s:text name="format.price"><s:param value="salePrice"/></s:text>  </span>
       		   <span class="hide">
       		   		<input name="salePrice" type="text" class="price" value="<s:property value="salePrice"/>"  onchange="BINOLPTJCS19.setPrice(this);" maxlength="17" />
       		   </span>
			...
			<li>
				<span class="editMemClass"><s:text name="format.price"><s:param value="memPrice"/></s:text>  </span>
       		   <span class="hide">
       		   		<input name="memPrice" type="text" class="price" value="<s:property value="memPrice"/>" onchange="BINOLPTJCS19.setPrice(this);" maxlength="17" />
       		   </span>
			</li>
			<li>
				<s:if test="productPriceSolutionInfo.isPosCloud == 0">
