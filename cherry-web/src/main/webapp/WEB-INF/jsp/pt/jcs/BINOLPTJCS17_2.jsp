...
<div class="panel-content">
	<div id="div_main">
	    ...
	    <div class="panel-content">
		 	 <p class="clearfix">
					...
					<p>
		            	...
		            	<span>
			            	<label><s:text name="prtSoluName" /><span class="highlight">*</span></label>
			 ...
			 <div class="dialog2 clearfix"  id="location_dialog_0"> 
				...
				<div class="hide">
					<p style="margin: 5px;">
					<label>分配地点类型</label>
					<s:hidden id="cntOwnOpt" name="cntOwnOpt" value="1"> </s:hidden><!-- 是否门店自设,有值即自设 -->
					<select id="sel_location_type_0" style="width:150px;" onchange="changeLocationType(this);return false;" >
						<option value="7">门店地点类型</option>
					</select>
		   			<%-- 
	    ...
	    <div class="center " id="pageButton">	
	        <cherry:show domId="BINOLPTJCS2301">
