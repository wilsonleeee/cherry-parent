...
<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS18.js"></script>
<script type="text/javascript" src="/Cherry/js/common/cherryDate.js"></script>
<script type="text/javascript" src="/Cherry/js/common/popDataTable.js"></script>
<script type="text/javascript" src="/Cherry/js/lib/jquery-ui-i18n.js"></script>
<s:i18n name="i18n.pt.BINOLPTJCS18">
    <s:url action="BINOLPTJCS18_disOrEnableSolu" id="disOrEnableSolu"></s:url>
	<s:url id="search_url" value="/pt/BINOLPTJCS18_search"/>
	<s:url id="add_url" action="BINOLPTJCS21_init"/>
			...
			<span class="breadcrumb left">	    
				<jsp:include page="/WEB-INF/jsp/common/navigation.inc.jsp" flush="true" />
	       		...
	       		<s:if test='"0".equals(isPosCloud)'>
	       			<%-- 柜台产品下发按钮 --%>
		       		<cherry:show domId="BINOLPTJCS1802">
	      ...
	      <div class="panel-content">
	        <div class="box">
	          <cherry:form id="mainForm" class="inline">
	           <input type="hidden" id="currentUnitID" name="currentUnitID" value="BINOLPTJCS18"/>
