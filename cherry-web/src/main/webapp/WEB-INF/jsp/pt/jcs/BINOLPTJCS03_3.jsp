  ...
  <div id="baseInfo" class="section-content">
    ...
    <table class="detail" cellpadding="0" cellspacing="0" >
      ...
      <s:if test="%{!isU2M}">
	      <tr>
	         ...
	         <td><span><s:textfield name="unitCode" cssClass="text textOth" maxlength="20" tabindex="1" onkeyup="this.value=this.value.toUpperCase()" /></span></td>
	       	<th>
	      	...
	      	<td id="barCode">
	      		<span class="vendorSpan" style="display:block; float:none;">		    
				    <span><input class="text textOth" maxlength="13" type="text" value="" name="barCode" tabindex="2" onkeyup="this.value=this.value.toUpperCase()" /></span>
		 		</span>
	      	</td>
	 	  </tr>     
      </s:if>
      <tr>
      	...
      	<td><span><s:textfield id="nameTotal" name="nameTotal" cssClass="text textOth" onkeyup="return isMaxByteLen(this)" tabindex="3"/></span ><span id="nameTotalTip" class="highlight"></span></td>
      ...
      <tr>
      	<th><label><s:text name="JCS03.measureUnit"/></label></th><%-- 计量单位 --%>
   		<td>
   			<span><s:textfield name="spec" cssClass="text textOth" maxlength="8" cssStyle="width:80px;"/></span>
   			<s:select name="moduleCode" list='#application.CodeTable.getCodes("1190")'
   			listKey="CodeKey" listValue="Value" cssStyle="width:90px;"/>
   		</td>
    ...
    <table class="detail" cellpadding="0" cellspacing="0" style="margin:0">
      ...
      <tr>
		...
		<td>
			<span>
       			<s:textfield name="color" cssClass="text textOth"  maxlength="16"/>
       		</span>
       	</td>
      </tr>
      <tr>
	      <th><label><s:text name="JCS03_profit"/></label></th><%-- 利润 --%>
	      <td>
	      	 <span>
	      	 	<s:textfield name="profit" cssClass="price" maxlength="15"/><s:text name="JCS03_moneryUnit"/>
	      	 </span>
	      </td>
      ...
      <tr>
	      ...
	      <td>
	      	 <span>
	      	 	<s:textfield name="secQty" cssClass="price"  maxlength="15"/><s:text name="JCS03_Unit"/>
	      	 </span>
	      </td>
	      <th><label><s:text name="JCS03_displayQty"/></label></th><%-- 陈列数 --%>
	      <td>
	      	 <span>
	      	 	<s:textfield name="displayQty"   cssClass="price" maxlength="15"/><s:text name="JCS03_Unit"/>
	      	 </span>
	      </td>
      </tr>
      <%--
