...
<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS26.js"></script>
<!-- 语言 -->
...
<div class="main container clearfix">
 	<div class="panel ui-corner-all">
      ...
      <div class="panel-content">
       	<form id="toEditForm" action="BINOLPTJCS27_init" method="post">
        ...
        <cherry:form id="mainForm" method="post" class="inline" csrftoken="false">
          ...
          <%-- ===================== 基本信息开始  =========================== --%>
          <jsp:include page="/WEB-INF/jsp/pt/jcs/BINOLPTJCS26_1.jsp" flush="true"/>
          <%-- ===================== 基本信息结束  =========================== --%>
          <%-- ===================== 分类信息开始  =========================== --%>
          <jsp:include page="/WEB-INF/jsp/pt/jcs/BINOLPTJCS26_2.jsp" flush="true"/>
          <%-- ===================== 分类信息结束  =========================== --%>
          <%-- ===================== 价格信息开始  =========================== --%>
          <jsp:include page="/WEB-INF/jsp/pt/jcs/BINOLPTJCS26_3.jsp" flush="true"/>
          <%-- ===================== 价格信息结束  =========================== --%>
          <%-- ===================== 图片信息开始  =========================== --%>
          <%--<jsp:include page="/WEB-INF/jsp/pt/jcs/BINOLPTJCS26_4.jsp" flush="true"/>--%>
          <%-- ===================== 图片信息结束  =========================== --%>
          <%-- ===================== BOM组件信息开始  =========================== --%>
          <jsp:include page="/WEB-INF/jsp/pt/jcs/BINOLPTJCS26_5.jsp" flush="true"/>
          <%-- ===================== BOM组件信息结束  =========================== --%>
          <%-- ===================== 编码条码履历开始  =========================== --%>
          <%-- <jsp:include page="/WEB-INF/jsp/pt/jcs/BINOLPTJCS26_6.jsp" flush="true"/>--%>
          <%-- ===================== 编码条码履历结束  =========================== --%>
          
          <div class="center clearfix"  style="margin-top: 10px;">
           <%-- 产品编辑 --%>
       		<cherry:show domId="BINOLPTJCS2701">
