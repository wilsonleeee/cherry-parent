...
<div id="aaData">
	<s:iterator value="proList">
		<s:url id="detailsUrl" value="/pt/BINOLPTJCS36_init.action">
		...
		<ul>
			<li>
				...
				<s:hidden name="productInfoIds" value="%{productId}"></s:hidden>
			</li>
			<li>${RowNumber}</li><%-- 编号 --%>
			<li>
			...
			<li><span><s:text name="format.price"><s:param value="minSalePrice"/></s:text></span></li><%-- 销售最低价格 --%>
			<li><span><s:text name="format.price"><s:param value="maxSalePrice"/></s:text></span></li><%-- 销售最高价格 --%>
			...
			<li>
				<cherry:show domId="BINOLPTJCS3402">
				<s:if test='"1".equals(validFlag)'>
					<%-- 停用 --%>
	                <a href="" class="delete" onclick="BINOLPTJCS34.confirmInit('0','<s:property value="productId"/>','<s:property value="unitCode"/>','<s:property value="barCode"/>','<s:property value="UpdateTime"/>','<s:property value="ModifyCount"/>',null,'<s:property value="BIN_ProductVendorID"/>');return false;">
				...
				<s:else>
					<%-- 启用--%>
	                <a href="" class="add" onclick="BINOLPTJCS34.popDisOrEnableDialog('1','<s:property value="productId"/>','<s:property value="unitCode"/>','<s:property value="barCode"/>','<s:property value="UpdateTime"/>','<s:property value="ModifyCount"/>','<s:property value="BIN_ProductVendorID"/>');return false;">
