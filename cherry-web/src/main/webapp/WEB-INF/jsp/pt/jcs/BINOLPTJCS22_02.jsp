			...
			<tr>
			    ...
			    <th class="hide teminalTransOth">
			    	...
			    	<span class= "right" style="margin-top: 2px;">
			    		<a onclick="BINOLPTJCS22.openCateDialog(<s:property value='propId'/>,this);return false;" class="add right">																
			    			...
			    			<tr>
			    				<td>
			    					<span class="list_normal">
			    						...
			    						<span onclick="BINOLPTJCS22.removeCate(this);return false;" style="margin: 4px 0px 0px 6px;" class="close">
...
<s:if test="cateList.size() > 3">
	...
	<div style="text-align: center; background: none repeat scroll 0% 0% rgb(238, 238, 238); padding: 3px 0px;">
		<a style="margin-left: 0px; font-size: 12px;" class="ui-select" onclick="BINOLPTJCS22.cateVisible('<s:text name="JCS03_showCate"/>','<s:text name="JCS03_hideCate"/>');return false;">
