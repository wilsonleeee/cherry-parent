      ...
      <div class="detail_box2" style="margin-bottom:10px;">
       <table class="detail" cellpadding="0" cellspacing="0">
        ...
        <s:if test="%{!isU2M}">
         <tr>
 			<th><label><s:text name="JCS06.unitCode"/></label></th><%-- 厂商编码 --%>
  			<td><span><s:property value="proMap.unitCode"/></span></td>
    	...
    	<tr>
      	...
      	<tr>
       		<th><label><s:text name="JCS06.standardCost"/></label></th><%-- 结算(终端成本)价格 --%>
       		<td><span><s:text name="format.price"><s:param value="proMap.standardCost"/></s:text><s:text name="JCS06.moneryUnit"/></span></td><%-- 元 --%>	
       		<th><label><s:text name="JCS06.orderPrice"/></label></th><%-- 成本（终端采购）价格 --%>
        ...
        <tr>
     	...
     	<tr>
    		<th><s:text name="JCS06.itemType"/></th><%-- 品类 --%>
	       	...
	       	<th><label><s:text name="JCS06.color"/></label></th><%-- 色系 --%>
	      	<td><span><s:property value="proMap.color"/></span></td>
     	</tr>
     	<tr>
    		<th><s:text name="JCS06.profit"/></th><%-- 利潤 --%>
			<td><span><s:property value="proMap.profit"/><s:text name="JCS06.moneryUnit"/></span></td>
	      	<th><s:text name="JCS06.grade"/></th><%-- 产品等级 --%>
			<td><span><s:property value='#application.CodeTable.getVal("1348",proMap.grade)'/></span></td>
     	</tr>
     	<tr>
    		<th><s:text name="JCS06.secQty"/></th><%-- 安全库存数量 --%>
			<td><span><s:property value="proMap.secQty"/><s:text name="JCS06.Unit"/></span></td>
	      	<th><s:text name="JCS06.displayQty"/></th><%-- 陈列数 --%>
			<td><span><s:property value="proMap.displayQty"/><s:text name="JCS06.Unit"/></span></td>
     	</tr>
       </table>
       </div>
		<%-- 用户自定义扩展属性 --%>
