...
<s:url id="downLoad_url" value="/download/产品方案明细导入模板.xls"/>
<s:url id="downLoad_urlOT" value="/download/OT/产品方案明细导入模板.xls"/>
<%-- 入库单导入导入URL --%>
<s:url id="import_url" value="/pt/BINOLSTIOS16_import"/>
	    	...
	    	<div class="box-yew">
				...
				<div class="box-yew-content">
					<div class="step-content">
						...
						<span>产品方案是必选项，选择系统中已存在的方案，方可添加excel中的产品列表明细。</span>
						</div>
						<div class="line"></div>
					</div>
					<div id="moreCondition" style="display: none;">
						<div class="step-content">
							...
							<%-- 
								...
								--%>
								<span>产品方案中已经存在的产品，导入excel时执行更新操作。不存在则新增。
								</span>
						...
						<div class="step-content">
							...
							<div class="step">
								<span>厂商编码(unitCode)作为识别产品唯一性条件，如果厂商编码在系统中不存在，则无法将该条数据导入到产品方案中。</span>
							</div>
							<div class="line"></div>
						</div>
						<div class="step-content">
						...
						<tr>
							...
							<td colspan="3">
								<s:if test="brandInfoList.size() > 1">
									<s:select id="brandInfoId" name="brandInfoId" list="brandInfoList" listKey="brandInfoId" listValue="brandName" Cssstyle="width:120px;" onchange="ptjcs16.changeBrand();"></s:select>
								</s:if> 
								<s:else>
						 ...
						 <tr>
						 	<th><s:text name="产品方案" /><span class="highlight">*</span></th>
							<td colspan = "3">
						     	<span>
						     		...
						     		headerKey="" headerValue="%{#select_default}" onchange="ptjcs16.changeSolu(this);"/>
						    	</span>
						        ...
						        <span id="soluMsg" class="hide">
									...
									<span class="red">当前产品方案已有明细，继续导入则会将原有明细覆盖。</span>
						        </span>
							</td >
		        ...
		        <div class="box2-content clearfix">
	        		<div class="box4-content">
						<span style="margin-left:10px; display: inline;" class="left hide"> 
						    ...
						    <input class="input_file" type="file" name="upExcel" id="upExcel" size="33" onchange="ptjcs16.deleteActionMsg();pathExcel.value=this.value;return false;" /> 
						    <input type="button" value="<s:text name="binolstios09_importExcel_btn"/>" onclick="ptjcs16.ajaxFileUpload('${import_url}');return false;" id="upload"/>
