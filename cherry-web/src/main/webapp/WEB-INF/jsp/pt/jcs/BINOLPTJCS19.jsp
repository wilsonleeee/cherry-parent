...
<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS19.js"></script>
...
<div class="main container clearfix">
	<div class="panel ui-corner-all">
		...
		<cherry:form id="toEditForm" action="BINOLPTJCS20_init" method="post" csrftoken="false">
		...
		<div class="clearfix"> 
			...
			<s:elseif test="productPriceSolutionInfo.isPosCloud == 1">
			    <span class="breadcrumb left"> <span class="ui-icon icon-breadcrumb"></span><s:text name="solu_prtlisttitle1" />&nbsp;&gt;&nbsp;<s:text name="JCS19_prtlistdetail"></s:text></span> 
			</s:elseif>
		</div>
		</div>
		<div class="panel-content clearfix">
			...
			<s:elseif test="productPriceSolutionInfo.isPosCloud == 1">
				<div class="section">
				  <div class="section-header">
					<strong><span class="ui-icon icon-ttl-section-info"></span><s:text name="JCS19_cntprtlistdetail"></s:text></strong>
				  </div>
				  <div class="section-content" id="detail">
					 <table class="detail" cellpadding="0" cellspacing="0">
					  	  <tr>
			...
			<div class="section show detail_box2" id="productInDepotExcelInfo">
				...
				<%-- ================== 错误信息提示   END  ======================= --%>
		        <div class="box">
		          <form id="searchForm" class="inline" onsubmit="BINOLPTJCS19.search(); return false;">
		            ...
		            <p class="clearfix">
		              	<%--<cherry:show domId="">--%>
		              		<%-- 产品查询按钮 --%>
		              		<button class="right search" type="button" onclick="BINOLPTJCS19.search();return false;">
				...
				<div class="section-content">
					...
					<%-- 
						<cherry:show domId="BINOLPTJCS18EXP">
			  		...
			  		<s:url action="BINOLPTJCS19_deleteRow" id="deleteSoluDetail"></s:url>
			  		
			  		<s:if test='productPriceSolutionInfo.isPosCloud == 0'>
				  		<cherry:show domId="BINOLPTJCS1803">
							<a  class="add left" onclick="BINOLPTJCS19.openChkPrtDialogInit();return false;"  href="#">
		       		 			<span class="button-text"><s:text name="solu_addPrt"/></span>
			       		 		<span class="ui-icon icon-add"></span>
							</a>
			                <a href="" class="delete" 
			                	onclick="BINOLPTJCS19.editBatchValidFlag('disable','${deleteSoluDetail}');return false;"
			                	title="去除当前勾选的产品">
			  		...
			  		<s:elseif test="productPriceSolutionInfo.isPosCloud == 1">
			  			<cherry:show domId="BINOLPTJCS2303">
							  <a class="add left" onclick="BINOLPTJCS19.openChkPrtDialogInit();return false;" href="#" title="从产品云中选择产品并添加到当前门店产品列表中。">
			                  ...
			                  <a href="" class="add " onclick="BINOLPTJCS19.addPrt();return false;" title="创建产品云中没有的产品，并添加到当前门店产品列表中。">
			...
			<div class="center">
				<s:if test="productPriceSolutionInfo.isPosCloud == 0">
					<cherry:show domId="BINOLPTJCS18UPD">
						<button class="edit" onclick="BINOLPTJCS19.edit();return false;">
...
<div class="section hide" id="addPrtTable">
  ...
  <div class="section">
    ...
    <div class="toolbar clearfix">
        <span class="left">
            <a id="spanBtnadd" class="add" onclick="BINOLPTJCS19.openProPopup();"><span class="ui-icon icon-add"></span><span class="button-text"><s:text name="solu_addRow"/></span></a> 
            <a id="spanBtdelete" class="delete" onclick="BINOLPTJCS19.deleterow();"><span class="ui-icon icon-delete"></span><span class="button-text"><s:text name="solu_delRow"/></span></a>
...
<div class="hide">
	<s:url action="BINOLPTJCS19_search" id="searchUrl" />
