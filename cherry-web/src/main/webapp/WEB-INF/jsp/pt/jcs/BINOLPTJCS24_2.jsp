...
$(function() {
	...
	$("#locationPosition").result(function(event, data, formatted){
		BINOLPTJCS24.locateCategory(data[0]);
	});
     ...
     <div class="ui-layout-west">
       <div style="min-width: 190px;">
		 ...
		 <div class="treebox2-header">
			...
			<a class="search" onclick="BINOLPTJCS24.locateCategory();return false;">
...
<div class="hide">
  <s:url action="BINOLPTJCS24_next" id="categoryInitUrl"></s:url>
  <input type="hidden" id="categoryInitUrl" value="${categoryInitUrl }"/>
  <s:url action="BINOLPTJCS24_search" id="search_url"/>
  <input type="hidden" id="search_url" value="${search_url }"/>
  <s:url action="BINOLPTJCS24_locateCat" id="locateCatUrl"></s:url>
