...
$(function() {
	...
	$("#locationPosition").result(function(event, data, formatted){
		BINOLPTJCS04.locateCategory(data[0]);
	});
     ...
     <div class="ui-layout-west">
       <div style="min-width: 190px;">
		 ...
		 <div class="treebox2-header">
			...
			<a class="search" onclick="BINOLPTJCS04.locateCategory();return false;">
		            ...
		            <table id="dataTable" cellpadding="0" cellspacing="0" border="0" class="jquery_table" width="100%">
		              <thead>
		                ...
		                <th><input type="checkbox" id="checkAll" onclick="bscom03_checkRecord(this,'#dataTable_Cloned');"/></th>
		                  ...
		                  <th><s:text name="pro.nameTotalCN"/></th><%-- 中文名称--%>
...
<div class="hide">
  <s:url action="BINOLPTJCS04_next" id="categoryInitUrl"></s:url>
  <input type="hidden" id="categoryInitUrl" value="${categoryInitUrl }"/>
  <s:url action="BINOLPTJCS04_search" id="search_url"/>
  <input type="hidden" id="search_url" value="${search_url }"/>
  <s:url action="BINOLPTJCS04_locateCat" id="locateCatUrl"></s:url>
