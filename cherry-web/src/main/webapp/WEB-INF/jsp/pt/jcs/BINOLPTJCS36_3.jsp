        ...
        <s:iterator value="sellPriceList">
			<table class="detail" cellpadding="0" cellspacing="0">
				...
				<tbody>
			          ...
			          <td><span><s:text name="format.price"><s:param value="proMap.salePrice"/></s:text><s:text name="JCS06.moneryUnit"/></span></td>
			          <th><label><s:text name="JCS06.memPrice"/></label></th><%-- 会员价格 --%>
			          <td><span><s:text name="format.price"><s:param value="proMap.memPrice"/></s:text><s:text name="JCS06.moneryUnit"/></span></td>
			        </tr>
			     	<tr class="hide">
