...
<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS22.js"></script>
		...
		<div class="panel-content clearfix">
          ...
          <div class="section detail_box2" >
		    ...
		    <div class="section-content" id="cateInfo">
          		<jsp:include page="/WEB-INF/jsp/pt/jcs/BINOLPTJCS22_02.jsp" flush="true"/>
          	</div>
          </div>		
          <%-- ======================= 产品分类结束  ========================================================== --%> 
			<div class="section show detail_box2" id="productInDepotExcelInfo">
				...
				<%-- ================== 错误信息提示   END  ======================= --%>
		        <div class="box">
		          <form id="searchForm" class="inline" onsubmit="BINOLPTJCS22.search(); return false;">
		            ...
		            <p class="clearfix">
		              	<%--<cherry:show domId="">--%>
		              		<%-- 产品查询按钮 --%>
		              		<button class="right search" type="button" onclick="BINOLPTJCS22.search();return false;">
				...
				<div class="section-content">
					...
					<a  class="add left" onclick="BINOLPTJCS22.openChkPrtDialogInit();return false;"  href="#">
	       		 		<span class="button-text"><s:text name="solu_addPrt"/></span>
	       		 		<span class="ui-icon icon-add"></span>
					</a>
	                <a href="" class="delete" onclick="BINOLPTJCS22.editBatchValidFlag('disable','${deleteSoluDetail}');return false;">
			...
			<div class="center">
				<cherry:show domId="BINOLPTJCS18UPD">
					<button class="edit" onclick="BINOLPTJCS22.edit();return false;">
...
<div class="section hide" id="addPrtTable">
  ...
  <div class="section">
    ...
    <div class="toolbar clearfix">
        <span class="left">
            <a id="spanBtnadd" class="add" onclick="BINOLPTJCS22.openProPopup();"><span class="ui-icon icon-add"></span><span class="button-text"><s:text name="solu_addRow"/></span></a> 
            <a id="spanBtdelete" class="delete" onclick="BINOLPTJCS22.deleterow();"><span class="ui-icon icon-delete"></span><span class="button-text"><s:text name="solu_delRow"/></span></a>
...
<div class="hide">
	...
	<!-- 产品方案明细添加产品分类 -->
	<s:url action="BINOLPTJCS19_addCate" id="addCateUrl" />
