...
<div id="aaData">
	<s:iterator value="proList">
		<s:url id="detailsUrl" value="/pt/BINOLPTJCS06_init.action">
		...
		<ul>
			...
			<li>
				...
				<s:if test='"1".equals(validFlag)'>
					<%-- 停用 --%>
	                <a href="" class="delete" onclick="BINOLPTJCS04.confirmInit('0','<s:property value="productId"/>','<s:property value="unitCode"/>','<s:property value="barCode"/>','<s:property value="UpdateTime"/>','<s:property value="ModifyCount"/>',null,'<s:property value="BIN_ProductVendorID"/>');return false;">
				...
				<s:else>
					<%-- 启用--%>
	                <a href="" class="add" onclick="BINOLPTJCS04.popDisOrEnableDialog('1','<s:property value="productId"/>','<s:property value="unitCode"/>','<s:property value="barCode"/>','<s:property value="UpdateTime"/>','<s:property value="ModifyCount"/>','<s:property value="BIN_ProductVendorID"/>');return false;">
			...
			<li><span><s:property value="#application.CodeTable.getVal('1220',isExchanged)"/></span></li><%-- 积分兑换 --%>
		</ul>
	</s:iterator>
</div>
