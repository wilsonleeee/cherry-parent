...
<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS46.js"></script>
...
<div class="panel-header">
  <div class="clearfix"> 
    ...
    <s:if test='"0".equals(isPosCloud)'>
	    ...
	    <s:text name="JCS46_detail"></s:text>
    </s:if>
    <s:elseif test='"1".equals(isPosCloud)'>
    	<s:text name="solu_prtlisttitle1" />&nbsp;&gt;&nbsp;
	    <s:text name="JCS46_addPrtList"></s:text>
    </s:elseif>
    </span>
  </div>
</div>
  ...
  <cherry:form id="add" csrftoken="false" onsubmit="save();return false;">
    ...
    <table class="detail" id="detailId" cellpadding="0" cellspacing="0">
	 ...
	 <tr> 
      ...
      <tr>
          <th><s:text name="solu_isSynchProductPrice"></s:text><span class="highlight"><s:text name="global.page.required"></s:text></span></th>
          <td><span><s:select list='#application.CodeTable.getCodes("1416")' listKey="CodeKey" listValue="Value" name="isSynchProductPrice"></s:select></span></td>
	      <th> </th>
		  <td></td>
	  </tr>
    </table>   
...
<hr class="space" />
<div class="center">
  <s:a action="BINOLPTJCS46_save" id="JCS46_save" cssStyle="display: none;"></s:a>
