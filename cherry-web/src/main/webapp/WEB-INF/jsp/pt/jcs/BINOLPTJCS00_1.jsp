...
<s:i18n name="i18n.pt.BINOLPTJCS04">
	<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS00_1.js"></script>
	<%-- ======================= 产品分类开始  ============================= --%>
						...
						<s:else>
							...
							<label> <%-- 分类名 --%> 
									<s:if test="teminalFlag == 1">
										<span class="teminalTrans1" title='<s:text name="JCS04.teminalTrans1" />' style="margin: 5px 0;">
											<span><s:property value="propName" /></span>
										</span>
									</s:if> 
									<s:elseif test="teminalFlag == 2">
										<span class="teminalTrans2" title='<s:text name="JCS04.teminalTrans2" />' style="margin: 5px 0;">
											<span><s:property value="propName" /></span>
										</span>
									</s:elseif>
									<s:elseif test="teminalFlag == 3">
										<span class="teminalTrans3" title='<s:text name="JCS04.teminalTrans3" />' style="margin: 5px 0;">
											<span><s:property value="propName" /></span>
										</span>
									</s:elseif> 
									<s:else>
							...
							<span class="right" style="display: inline-block; float: none; vertical-align: middle;" >
								<a onclick="BINOLPTJCS00_1.openCateDialog(<s:property value='propId'/>,this,'checkbox');return false;" class="add right"> 
							...
							<input type="hidden" name="teminalFlag" value="<s:property value='teminalFlag'/>" />
						</th>
						<s:if test="#st1.getIndex() < 3">
									...
									<tr>
										<td>
											<span class="list_normal"> 
												...
												<span onclick="BINOLPTJCS00_1.removeCate(this);return false;" style="margin: 4px 0px 0px 6px;" class="close">
...
<%-- 	<s:if test="cateList.size() > 3">
		...
		<div style="text-align: center; background: none repeat scroll 0% 0% rgb(238, 238, 238); padding: 3px 0px;">
			<a style="margin-left: 0px; font-size: 12px;" class="ui-select" onclick="BINOLPTJCS00_1.cateVisible('<s:text name="JCS04_showCate"/>','<s:text name="JCS04_hideCate"/>');return false;">
				<span id="cateVisibleBtn" style="min-width: 50px;" class="button-text choice"><s:text name="JCS04_showCate" /></span>
