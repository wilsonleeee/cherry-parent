...
<script type="text/javascript" src="/Cherry/js/pt/jcs/BINOLPTJCS48.js"></script>
<s:url id="downLoad_url" value="/download/产品方案明细导入模板.xls"/>
<s:url id="downLoad_urlOT" value="/download/OT/产品方案明细导入模板.xls"/>
<%-- 入库单导入导入URL --%>
<s:url id="import_url" value="/pt/BINOLPTJCS48_import"/>
<s:url id="getDownloadPathByAjaxURL" value="/st/BINOLSTIOS09_getDownloadPathByAjax"/>
<div class="hide">
    <a id="downLoad_url" href="${downLoad_url}"></a>
    <a id="downLoad_urlOT" href="${downLoad_urlOT}"></a>
