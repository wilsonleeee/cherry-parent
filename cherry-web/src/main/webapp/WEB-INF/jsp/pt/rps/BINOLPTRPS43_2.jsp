...
<s:i18n name="i18n.pt.BINOLPTRPS43">
	  		<div class="section">
	            <div class="section-header">
	            	<strong>
	            		...
	            		<s:text name="RPS43_saleTotal"/><%-- 销售单据统计信息 --%>
	            	</strong>
	            </div>
	            <div class="section-content" id="shwoMainInfo">
	            	<%-- 符合查询条件的单据数: --%>
					<s:text name="RPS43_saleSum"/>
			...
			<div class="section">
		          <div class="section-header">
			          ...
			          <s:text name="RPS43_saleDetailTotal" /><%-- 各商品统计信息 --%>
			          </strong>
		          </div>
		        <%--dataTabel area --%>
		          <div class="section-content">
		            <form method="post">
						...
						<table  cellpadding="0" cellspacing="0" border="0"  style="width:100%;">
							<thead>
								<tr>
								   <th ><s:text name="RPS43_proPrmName" /></th>
								   <th ><s:text name="RPS43_proPrmBarCode" /></th>
								   <th ><s:text name="RPS43_proPrmSumQuantity" /></th>
								   <th ><s:text name="RPS43_proPrmSumAmount" /></th>
								   <th ><s:text name="RPS43_quantityPercent" /></th>
								   <th ><s:text name="RPS43_amountPercent" /></th>
								</tr>
							</thead>
							<tbody>
