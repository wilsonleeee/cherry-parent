...
<s:if test='%{fiscalShow == "1"}'>
	<div id="fiscalMonthInfoDiv">
		<s:text name="binolptrps44_fiscalMonthInfo" />
		<s:property value="fiscalYearDisplay"/><s:text name="binolptrps44_fiscalYear" />
		<s:property value="fiscalMonthDisplay"/><s:text name="binolptrps44_fiscalMonth" />
		(<s:property value="fiscalMonthStart"/>~<s:property value="fiscalMonthEnd"/>)
	</div>
</s:if>
<s:elseif test='%{fiscalShow == "2"}'>
	<div id="fiscalMonthInfoDiv">
		<s:text name="binolptrps44_fiscalYearInfo" />
		<s:property value="fiscalYearDisplay"/><s:text name="binolptrps44_fiscalYear" />
		(<s:property value="fiscalMonthStart"/>~<s:property value="fiscalMonthEnd"/>)
	</div>
</s:elseif>
...
<s:if test='saleCountInfo != null'>
	<div id="saleCountInfoDiv">
		<s:text name="binolptrps44_totalQuantity"/>
		...
		<s:text name="binolptrps44_totalAmount"/>
