...
<div id="div_main" class="panel ui-corner-all">
	<div>
<form id="mainForm" action="/Cherry/ss/BINOLSSPRM17_SUBMIT">
<input class="hide" id="csrftoken" name="csrftoken" value='<s:property value="parentCsrftoken"/>'/>
...
<input type="hidden"  id="reminderId" name="reminderId" value='<s:property value="reminderId"/>'>
...
window.onbeforeunload = function(){
	if(window.opener){
      ...
      <div class="panel-header">
        <div class="clearfix"> 	
       	<span id="reminderHandleDiv" class="breadcrumb left">	    
			<s:i18n name="i18n.pt.BINOLPTRPS39">
				<s:text name="rps39_promotionDeliverTitle"/>
			</s:i18n>
		</span>
		 </div>
      </div>
                  ...
                  <div class="tr">
                    ...
                    <div class="tr">
                        ...
                        <div class="td">
                            ...
                            <input type="hidden" name="remInOrganizationId" id="remInOrganizationId" value="${remInOrganizationId }">
