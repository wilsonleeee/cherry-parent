...
<s:if test='sumInfo != null'>
	...
	<s:url id="detailsUrl" action="BINOLPTRPS20_init">
		<%-- 促销产品收发货ID --%>
	...
	<ul>
		...
		<li>
			...
			<s:if test='departNameReceive != null && !"".equals(departNameReceive)'>
				(<s:property value="departCodeReceive"/>)<s:property value="departNameReceive"/>
			</s:if>
            <s:else>
            	&nbsp;
            </s:else>
