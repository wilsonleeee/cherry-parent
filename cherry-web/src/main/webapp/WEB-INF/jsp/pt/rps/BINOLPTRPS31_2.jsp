...
<script type="text/javascript" src="/${CHERRY_CONTEXT_PATH}/js/pt/rps/BINOLPTRPS31_1.js"></script>

<s:i18n name="i18n.pt.BINOLPTRPS31">
	<%-- 指定代理商的推荐会员销售明细导出URL --%>
	<div class="hide">
	<s:url action="BINOLPTRPS31_memberBuyExport" id="export_url"/>
	<s:url id="exporCheck_url" action="BINOLPTRPS31_memberBuyExportCheck" ></s:url>
	<a id="exporCheckUrl" href="${exporCheck_url}"></a>
	</div>
	<form id="memberBuyForm">
				...
				<div id="errorMessage"></div>
 				...
 				<div class="panel-content clearfix">
 					<div class="box">
 						...
 						<p class="clearfix">
	 						<button class="right search" onclick="BINOLPTRPS31_1.search();return false;">
 					...
 					<div class="section hide" id="memberBuyInfo">
	 					...
	 					<div class="section-content">
	 						<div class="toolbar clearfix">
	 							<cherry:show domId="PTRPS31MEMEXP">
									<span style="margin-right:10px;">
								     	<a id="export" href="${export_url }" class="export" onclick="BINOLPTRPS31_1.exportExcel(this, '0');return false;">
	 						...
	 						<table cellpadding="0" cellspacing="0" border="0" class="jquery_table" width="100%" id="memberBuyDataTable">
	 							<thead>
							        <tr>
		...
		<div class="hide">
			<s:url action="BINOLPTRPS31_memberBuySearch" id="search_url" />
