...
<s:i18n name="i18n.pt.BINOLPTRPS09">
	<div id="headInfo">
		...
		<s:text name="RPS09_outSumAmount"/>
...
<div id="aaData">
	<s:iterator value="proInOutList" id="pro">
		<s:url id="detailsUrl" value="/pt/BINOLPTRPS10_init">
			<s:param name="proIOId">${pro.proIOId}</s:param>
		</s:url>
		<ul>
			<%-- No. --%>
			<li>${pro.RowNumber}</li>
			...
			<%-- 业务类型   --%>
			<li><span><s:property value='#application.CodeTable.getVal("1263", tradeType)'/></span></li>
			<%-- 入出库状态   --%>
