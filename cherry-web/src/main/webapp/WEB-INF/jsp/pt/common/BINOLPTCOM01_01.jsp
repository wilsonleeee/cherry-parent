...
<div id="aaData">
<s:iterator value="departInfoList" id="departMap">
<ul>
<li>
	<input type="radio" name="depatDetail" value='<s:property value="#departMap.departCode"/>' id='<s:property value="#departMap.organizationId"/>'/>
</li>
