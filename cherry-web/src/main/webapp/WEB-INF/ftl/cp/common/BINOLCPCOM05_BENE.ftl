        ...
        <a href="#"><@s.text name="cp.memberAct" /></a> > <a href="#"><@s.text name="cp.baseInfo" /></a> </span> </div>
            ...
            <div class="section">
			  <div class="section-content">
		        ...
		        <input type="hidden" name="campInfo.isShared" value="0"/>
		        <#-- 领取柜台 -->
				<input type="hidden" name="campInfo.gotCounter" value="1"/>
				<input type="hidden" name="campInfo.sendFlag" value="1"/>
		...
		<#--================================================================ 基础信息  =================================================================-->
			    ...
			    <table cellspacing="0" cellpadding="0" class="detail"  style="margin-bottom:0px">
					...
					<tr>
						...
						<td>
							<div>
						  	<select name="campInfo.subCampaignValid" style="width:120px;" id="subCampaignValid" onchange="BINOLCPCOM05.changeSubValid(this);" <#if (campInfo.state)! == "1" >disabled="disabled"</#if>>
						  	 ...
						  	 <#if (campInfo.state)! == "1" >
							  	<input type="hidden" name="campInfo.subCampaignValid" value="${campInfo.subCampaignValid!}"/>
							  </#if>
						  	</div>
						 </td>
				     </tr>
					<tr>
						...
						<#else>
							<@s.radio name="campInfo.needBuyFlag" disabled="true" list="#application.CodeTable.getCodes('1235')"
	                    		listKey="CodeKey" listValue="Value" value='${(campInfo.needBuyFlag)!"0"}'/>
	                    		<input type="hidden" name="campInfo.needBuyFlag" value='${campInfo.needBuyFlag!"0"}'/>
						</#if>
						</td>
					...
					<tr>
						<#-- 柜台库存管理 -->
						<th><@s.text name="cp.manageGift"/></th>
						<td>
						<#if (campInfo.state)! != "1" >
							<@s.radio name="campInfo.manageGift" list="#application.CodeTable.getCodes('1320')"
	                    		listKey="CodeKey" listValue="Value" value='${(campInfo.manageGift)!"0"}'/>
						<#else>
					  			<@s.radio name="campInfo.manageGift" disabled="true" list="#application.CodeTable.getCodes('1320')"
	                    		listKey="CodeKey" listValue="Value" value='${(campInfo.manageGift)!"0"}'/>
					  			<input type="hidden" name="campInfo.manageGift" value="${campInfo.manageGift!}"/>
					  	</#if>
						...
						<th><@s.text name="cp.actDes" /></th>
             		  	<td>
             		  		<span style="width:85%;">
             		  			<textarea cols="" rows="" name="campInfo.descriptionDtl" style="width: 93%;height:30px;">${(campInfo.descriptionDtl)!?html}</textarea>
             		  		</span>
             		  	</td>
					</tr>
			    </tbody>
...
<div class="hide">
  	...
  	<select id="subCampaignValid_CXHD">
		<#list application.CodeTable.getCodes("1230") as code>
		 	<#if code.CodeKey=='2'>
				<option selected="true" value="${code.CodeKey!?html}">${code.Value!?html}</option>
			</#if> 
	  	</#list>
  	</select>
  	<table>
