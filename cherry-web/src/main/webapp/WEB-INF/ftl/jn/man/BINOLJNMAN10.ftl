  ...
  <div class="panel-header">
    <div class="clearfix">
       <span class="breadcrumb left"> 
         ...
         <@s.text name="cp.rulePoint" /> &gt; <@s.text name="cp.combRuleAdd" />
       </span>
    </div>
  </div>
  ...
  <div class="panel-content">
  	 ...
  	 <table class="detail" id="combContent">
  	 	...
  	 	<tr>
  	 		...
  	 		<td><input type="text" name="campaignName" value="" class="text" maxlength="50"/></td>
  	 	</tr>
  	 	<tr>
  	 	...
  	 	<tr>
  	 		...
  	 		<td><@s.select list='#application.CodeTable.getCodes("1192")' listKey="CodeKey" listValue="Value" name="matchType" cssStyle="width:128px;"/></td>
  	 	</tr>
  	 	<tr>
  	 		<th><@s.text name="cp.configExecType" /></th>
  	 		<td><@s.select list='#application.CodeTable.getCodes("1166")' listKey="CodeKey" listValue="Value" name="combType"/></td>
  	 	</tr>
