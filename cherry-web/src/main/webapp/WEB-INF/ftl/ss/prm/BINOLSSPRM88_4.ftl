...
<div class="box4">
	...
	<div class="box4-content">
		...
		<div class="box2 box2-active">
			<div class="box2-header clearfix"><strong class="left active"><span class="ui-icon icon-buy"></span><@s.text name="exRanges" /></strong>
			</div>
				...
				<table class="detail">
					<tr>
						...
						<td style="width:90%;">
							...
							<a class="left" href="#" onclick="PRM88_4.popRangeDialog(this);return false;"><@s.text name="global.page.add" /></a>
                            <a  onclick="PRM88_4.popRangeExceptDialog(this);return false;" class="search right hide">
                                <span class="ui-icon icon-add"></span>
                                <span class="button-text"><@s.text name="productImport"/></span>
                            </a>
						</td>
					</tr>
				</table>
		...
		<div class="box2 box2-active">
			<div class="box2-header clearfix"> 
				...
				<#--
				<a class="add right" onclick="PRM88_4.addReward('GIFT');" style="margin-top:5px;">
				...
				<#list (pageTemp.resMap.logicObjArr)![{"rewardType":"GIFT"}] as result>
					<div class="clearfix REWARDBOX">
						<div class="clearfix PARAMS">
						    ...
						    <select id="rewardType" name="rewardType" style="margin:0px;width:100px;" onchange="PRM88_4.changeRewardType(this);">
...
<select name="rangeType" style="margin:0px;width:95px;" onchange="PRM88_4.changeRangeType(this);">
    <@getOptionList list=rangeTypeList val= item.rangeType! />
    <@getOptionList list=extList val= item.rangeType! />
</select>
<select name="rangeOpt" style="margin:0px;width:60px;" <#if !item.rangeType!?ends_with('CODE')>disabled="true"</#if> onchange="PRM88_4.changeRangeOpt(this);">
   <@getOptionList list=rangeOptList val= item.rangeOpt! />
</select>
<span id="rangeVal_${index}" onclick="PRM88_4.popConDialog(this);" class="RANGEVAL">
...
<a href="#" class="<#if item.rangeType! != 'RANGE'>hide</#if>" onclick="PRM88_4.popRangeDialog(this);return false;"><@s.text name="global.page.add" /></a>
...
<#macro likeRangeVal rangeVal = '+'>
	...
	<div class="tag">
		...
		<input class="text" style="width:120px;" onchange="PRM88_4.setRangeVal(this);" value="${rangeValArr[0]}"><@s.text name="matchPosition" />
		<input class="number" onchange="PRM88_4.setRangeVal(this);" value="${rangeValArr[1]}">
...
<#macro priceRangeVal rangeVal = '+'>
	...
	<div class="tag">
		...
		<input class="price"  onchange="PRM88_4.setRangeVal(this);" value="${rangeValArr[0]}">
		<@s.text name="maxValue" />：
		<input class="price" onchange="PRM88_4.setRangeVal(this);" value="${rangeValArr[1]}">
		<input type="hidden" value="${rangeVal}" name="rangeVal">
	</div>
</#macro>
...
<div style="margin:0px;" class="box2">
    ...
    <div class="sortbox_subhead_${logicOpt} clearfix">
        ...
        <a class="add right" onclick="PRM88_4.popShopProductDialog(this);return false;"><span class="ui-icon icon-add"></span><span class="button-text"><@s.text name="productImport" /></span></a>
        <a class="delete right" onclick="PRM88_4.delBox(this);return false;"><span class="ui-icon icon-delete"></span><span class="button-text"><@s.text name="deleteBox" /></span></a>
    	<a class="add right" onclick="PRM88_4.addItem(this,0);"><span class="ui-icon icon-add"></span><span class="button-text"><@s.text name="addCondition" /></span></a>
    </div>
...
<div id="shoppingCart" class="clearfix">
	<div class="clearfix">
		...
		<select id="condType" style="margin:0px;width:100px;" onchange="PRM88_4.changeCondType(this);">
	  		<@getOptionList list=condTypeList val= condType />
	  	</select>
	  	<span class="<#if condType != '2'>hide</#if>">
		  	<a style="margin-top:3px;" onclick="PRM88_4.addBox('OR');" class="add right">
	            <span class="ui-icon icon-add"></span><span class="button-text"><@s.text name="global.page.add" /><@s.text name="boxOR" /></span>
	        </a>
	        <a style="margin-top:3px;" onclick="PRM88_4.addBox('AND');" class="add right">
...
<div style="margin:0px;" class="box2">
    ...
    <div class="sortbox_subhead_${logicOpt} clearfix">
        ...
        <a class="delete right" onclick="PRM88_4.delRewardBox(this);return false;"><span class="ui-icon icon-delete"></span><span class="button-text"><@s.text name="deleteBox" /></span></a>
    	<a class="add right" onclick="PRM88_4.addItem(this,1);"><span class="ui-icon icon-add"></span><span class="button-text"><@s.text name="addResult" /></span></a>
    </div>
    <div class="box2-content_${logicOpt}">
    	<ul>
    		<#if logicObjArr?exists && logicObjArr?size gt 0>
...
<#macro getRewardValBody map={}>
	...
	<#elseif map.rewardType! == 'ZDMS'>
		...
		<span style="margin-left:10px;">
			<input type="checkbox" <#if map.rewardQty! != '' && map.rewardQty! != '0'>checked="true"</#if> id="rewardQtyFlag" onclick="PRM88_4.showRewardQty(this);">
	...
	<#elseif map.rewardType! == 'ZDXL'>
		<span>
			<input type="radio" onclick="PRM88_4.changeZDXL('#rewardQty_ZDXL','#rewardMtp_ZDXL');" name="quantityType" id="quantityType_1" <#if map.rewardQty! != '' && map.rewardQty! != '0'>checked="true"</#if>/>
		...
		<span>
			<input type="radio" onclick="PRM88_4.changeZDXL('#rewardMtp_ZDXL','#rewardQty_ZDXL');" name="quantityType" id="quantityType_2" <#if map.rewardMtp! != '' && map.rewardMtp! != '0'>checked="true"</#if> />
...
<#if rewardType !='JFDK' && rewardType !='SGGJ' && rewardType !='ZDYH' && rewardType !='ZDZK' && rewardType !='TZZK' && rewardType !='YHTZ' && rewardType !='ZDMS' && rewardType !='ZDXL'>
	<#--
	<a onclick="PRM88_4.delReward(this);return false;" class="delete right" style="margin-top:5px;">
		<span class="ui-icon icon-delete"></span><span class="button-text">删除奖励</span>
	</a>
	 -->
	<a class="add right" onclick="PRM88_4.addRewardBox('OR',this);" style="margin-top:5px;">
	    <span class="ui-icon icon-add"></span><span class="button-text"><@s.text name="global.page.add" /><@s.text name="boxOR" /></span>
	</a>
	<a class="add right" onclick="PRM88_4.addRewardBox('AND',this);" style="margin-top:5px;">
	    <span class="ui-icon icon-add"></span><span class="button-text"><@s.text name="global.page.add" /><@s.text name="boxAND" /></span>
	</a>
</#if>
</#macro>
