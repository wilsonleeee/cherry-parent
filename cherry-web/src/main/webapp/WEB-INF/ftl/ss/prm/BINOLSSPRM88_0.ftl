...
<#macro timePlaceInfo page={} temp={}>
		...
		<div class="box2-header clearfix">
			...
			<#if temp.placeJson?exists>
				<#if temp.placeJson.size() gt 12>
                    <a class="right search" onclick="PRM88.showMore(this,'#morePlace');return false;">
			...
			<#if temp.placeJson?exists>
				<div style="width:85%;float:left;">
					...
					<#list temp.placeJson as placeMap>
                        ...
                        <li class="left" style="width:33%;white-space: nowrap;list-style-type:none;">
	...
	<#if temp.placeJson_b?exists>
	<div class="box2 box2-active">
        <div class="box2-header clearfix">
            <strong class="left active"><span class="ui-icon icon-flag"></span><@s.text name="rulePlaceBlack" /></strong>
            <span class="ui-widget breadcrumb" style="position: relative; margin-left:30px;"></span>
			<#if temp.placeJson_b.size() gt 12>
				<a class="right search" onclick="PRM88.showMore(this,'#morePlace');return false;">
					<span class="ui-icon icon-search"></span>
					<span class="button-text"><@s.text name="showPlace"/></span>
				</a>
        ...
        <div class="box2-content clearfix" style="padding:1em;">
            <div style="width:15%;float:left;">
                <span class="ui-icon icon-arrow-crm"></span>
				<@s.property value="#application.CodeTable.getVal('1156','5')"/>
            </div>
			<div style="width:85%;float:left;">
				<ul>
				<#list temp.placeJson_b as placeBlackMap>
					<#if placeBlackMap_index == 12>
					<ul id="morePlace" class="hide">
					</#if>
					<li class="left" style="width:33%;white-space: nowrap;list-style-type:none;">
						<span style="margin:5px 0px;width:210px;">
					...
					<#if (placeBlackMap_index+1 == placeBlackMap.size())||(placeBlackMap_index == 11)>
					</ul>
					</#if>
				</#list>
				</ul>
			...
			<div class="relation clearfix" style="margin-top:0px;">
			    ...
			    <#if memberType !='6'>
					...
					<span id="searchMeb_0" class="right">
						<a onclick="PRM88_3.memSearch(0);return false;" class="search" style="margin: 3px 0 0 20px;">
					...
					<div class="SEARCHCODE">
						<input type="hidden" id="searchCode_0" name="pageC.searchCode" value="${(temp.searchCode)!}"/>
                        <input type="hidden" id="searchCodeBlack_0" name="pageC.searchCodeBlack" value="${(temp.searchCodeBlack)!}"/>
					</div>
			    </#if>
			</div>
...
<div class="clearfix REWARDBOX">
	<div class="clearfix PARAMS">
	    ...
	    <select name="rewardType" style="margin:0px;width:100px;" disabled="true" onchange="PRM88_4.changeRewardType(this);">
...
<select name="rangeType" style="margin:0px;width:95px;" onchange="PRM88_4.changeRangeType(this);" disabled="true">
    <@getOptionList list=rangeTypeList val= item.rangeType! />
    <@getOptionList list=extList val= item.rangeType! />
</select>
<select name="rangeOpt" style="margin:0px;width:60px;" <#if !item.rangeType!?ends_with('CODE')>disabled="true"</#if> onchange="PRM88_4.changeRangeOpt(this);" disabled="true">
