<@s.i18n name="i18n.ss.BINOLSSPRM88">
<#include "/WEB-INF/ftl/common/head.inc.ftl" />
<#include "/WEB-INF/ftl/ss/prm/BINOLSSPRM88_0.ftl" />
...
<script type="text/javascript" src="/Cherry/js/ss/prm/BINOLSSPRM88.js"></script>
<script type="text/javascript" src="/Cherry/js/ss/prm/BINOLSSPRM88_${pageNo!}.js"></script>
...
<div class="main container clearfix" id="div_main">
	<div class="panel ui-corner-all">
		...
		<div class="panel-content">
			...
			<@c.form id="mainForm" method="post" class="inline" csrftoken="false" action="BINOLSSPRM88_init">
				<@comHidden pageNo=pageNo! opt=opt! csrftoken=csrftoken! brandInfoId=pageTemp.brandInfoId! activeID=activeID!/>
				<#include "/WEB-INF/ftl/ss/prm/BINOLSSPRM88_${pageNo!}.ftl" />
			</@c.form>
...
<#macro button pageNo=1>
	<div class="center clearfix">
		...
		<#else>
			...
			<#else>
				<button onclick="PRM88.toNext(${pageNo},-1);return false;" class="save" type="button">
			...
			<#if pageNo == 5>
				<#if opt == '1'>
					<button onclick="PRM88.setTemplateFlag(1);PRM88.toNext(${pageNo},1);return false;" class="back" type="button">
						<span class="ui-icon icon-save"></span>
						<span class="button-text"><@s.text name="saveTemplate" /></span>
					</button>
				</#if>
				<button onclick="PRM88.toNext(${pageNo},1);return false;" class="back" type="button">
					<span class="ui-icon icon-save"></span>
...
<div class="LOGICBTN">
	<button onclick="PRM88.changeLogicOpt(this);return false;" <#if disabled>disabled="disabled"</#if> class="button_${logicOpt}" type="button">
