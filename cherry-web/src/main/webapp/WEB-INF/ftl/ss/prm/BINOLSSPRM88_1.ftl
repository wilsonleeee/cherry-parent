<div class="box4">
	<div class="box4-header">
		...
		<a href="#" class="add right" onclick="PRM88_1.addPrmActGrop();"><span class="ui-icon icon-add"></span><span class="button-text"><@s.text name="addActGrp" /></span></a>
		<#--<a href="#" class="add right" onclick="PRM88_1.eidtPrmActGrop();"><span class="ui-icon icon-edit"></span><span class="button-text">编辑主活动</span></a>-->
	</div>
