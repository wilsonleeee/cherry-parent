...
public class ProFlowCR_YT_FN_TEST extends CherryJunitBase{
    ...
    public void testWorkFlow1() throws Exception {
        ...
        String flowFile = "proFlowCR_DLYL.xml";
        ...
        assertEquals(CherryConstants.CRAUDIT_FLAG_SUBMIT2,actualList.get(0).get("VerifiedFlag"));
        ...
        form = binOLSTBIL16_Action.getModel();
        DataUtil.injectObject(form, otherFormData);
        ...
        paramMap.put("tableName", "Inventory.BIN_ProStocktakeRequest");
        paramMap.put("RelevanceNo", stocktakeReqMainData.get("StockTakingNo"));
        actualList = testCOM_Service.getTableData(paramMap);
        
        assertEquals(CherryConstants.CRAUDIT_FLAG_AGREE2,actualList.get(0).get("VerifiedFlag"));
        ...
        assertEquals("1",ConvertUtil.getString(actualList.get(0).get("SynchFlag")));
    ...
    public void testWorkFlow2() throws Exception {
        ...
        assertEquals(CherryConstants.VALIDFLAG_ENABLE,actualList.get(0).get("ValidFlag"));
    ...
    public void testWorkFlow3() throws Exception {
        ...
        //二审废弃
        request.addParameter("entryid", ConvertUtil.getString(workFlowID));
        request.addParameter("actionid", "524");
        binOLSTBIL16_Action = createAction(BINOLSTBIL16_Action.class, "/st","BINOLSTBIL16_doaction");
