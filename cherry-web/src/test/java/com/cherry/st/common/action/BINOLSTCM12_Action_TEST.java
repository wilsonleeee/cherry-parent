...
public class BINOLSTCM12_Action_TEST extends CherryJunitBase{
	@Resource(name="TESTCOM_Service")
	private TESTCOM_Service testCOM_Service;
	
	private BINOLSTCM12_Action action;
	...
	public void testGetDeliver1() throws Exception {
        ...
        action = createAction(BINOLSTCM12_Action.class, "/st","BINOLSTCM12_getDeliver");
        ...
        if(null != tempList && tempList.size()>0){
            ...
            if(null != tempList && tempList.size()>0){
                ...
                if(null != tempList && tempList.size()>0){
                    String billNoIF = ConvertUtil.getString(tempList.get(0).get("DeliverNoIF"));
                    ...
                    BINOLSTCM12_Form form = action.getModel();
                    ...
                    //proxy代理
                    assertEquals("BINOLSTCM12_1", proxy.execute());
                }
            }
        }
    }
