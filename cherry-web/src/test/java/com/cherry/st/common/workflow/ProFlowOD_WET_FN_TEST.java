...
public class ProFlowOD_WET_FN_TEST extends CherryJunitBase{
    ...
    @Rollback(true)
    @Transactional
    public void testWorkFlowOD_WET1() throws Exception {
        //维尔汀工作流
        String caseName = "testWorkFlowOD_WET1";
        ...
        String flowFile = "proFlowOD_WET.xml";
        ...
        assertEquals(deliverNoIF,ConvertUtil.getString(actualList.get(0).get("DeliverNoIF")));
