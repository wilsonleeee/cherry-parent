...
public class ProFlowOD_YT_FN_TEST extends CherryJunitBase{
    ...
    @Rollback(true)
    @Transactional
    public void testWorkFlowOD_YT1() throws Exception {
        //大陆幽兰工作流（三审第三方）
        String caseName = "testWorkFlowOD_YT1";
        ...
        //加载工作流文件
        String orgCode = "TCYT1";
        String brandCode = "TCYT1";
        String flowName = "proFlowOD";
        String flowFile = "proFlowOD_DLYL.xml";
        ...
        //设置三审第三方
        metaAttributes = workflow.getWorkflowDescriptor(wfName).getStep(58).getMetaAttributes();
        ...
        assertEquals(expectList.get(0).get("OrderTime"),actualList.get(0).get("OrderTime"));
        ...
        actualParamMap.put("OrderNoIF", orderNoIF);
        actualList = testCOM_Service.getTableData(actualParamMap);
        assertEquals("13",actualList.get(0).get("VerifiedFlag"));
        ...
        actualParamMap.put("OrderNoIF", orderNoIF);
        actualList = testCOM_Service.getTableData(actualParamMap);
        assertEquals("14",actualList.get(0).get("VerifiedFlag"));
    ...
    @Rollback(true)
    @Transactional
    public void testWorkFlowOD_YT2() throws Exception {
        //香港颖通工作流
        String caseName = "testWorkFlowOD_YT2";
        List<Map<String,Object>> dataList = DataUtil.getDataList(this.getClass(),caseName);
        Map<String,Object> dataMap = (Map<String,Object>) DataUtil.getDataMap(this.getClass());
        UserInfo userInfo = DataUtil.getUserInfo(this.getClass(),caseName);
        ...
        //加载工作流文件
        String orgCode = "TCYT2";
        String brandCode = "TCYT2";
        String flowName = "proFlowOD";
        String flowFile = "proFlowOD_XGYT.xml";
        loadWorkFlowDescriptor(flowFile,flowName,orgCode,brandCode);
        ...
        actualParamMap.put("OrderNoIF", orderNoIF);
        List<Map<String,Object>> actualList = testCOM_Service.getTableData(actualParamMap);
        assertEquals("",ConvertUtil.getString(actualList.get(0).get("SynchFlag")));
        assertEquals("5",actualList.get(0).get("VerifiedFlag"));
    ...
    @Rollback(true)
    @Transactional
    public void testWorkFlowOD_YT3() throws Exception {
        //大陆幽兰工作流（三审新后台）
        String caseName = "testWorkFlowOD_YT3";
        List<Map<String,Object>> dataList = DataUtil.getDataList(this.getClass(),caseName);
        Map<String,Object> dataMap = (Map<String,Object>) DataUtil.getDataMap(this.getClass());
        UserInfo userInfo = DataUtil.getUserInfo(this.getClass(),caseName);
        ...
        //加载工作流文件
        String orgCode = "TCYT3";
        String brandCode = "TCYT3";
        String flowName = "proFlowOD";
        String flowFile = "proFlowOD_DLYL.xml";
        loadWorkFlowDescriptor(flowFile,flowName,orgCode,brandCode);
        ...
        //设置发货
        metaAttributes = workflow.getWorkflowDescriptor(wfName).getStep(80).getMetaAttributes();
        metaAttributes.put("OS_Rule",ConvertUtil.getString(osRuleList.get(0).get("Step80")));
        workflow.getWorkflowDescriptor(wfName).getStep(80).setMetaAttributes(metaAttributes);
        workflow.getWorkflowDescriptor(wfName).getAction(801).setMetaAttributes(metaAttributes);
        ...
        request.addParameter("entryid", ConvertUtil.getString(workFlowID));
        request.addParameter("actionid", "581");
        binOLSTSFH03_Action = createAction(BINOLSTSFH03_Action.class, "/st","BINOLSTSFH03_doaction");
        ...
        form.setOperateType(CherryConstants.OPERATE_SD);
        form.setProductOrderID(orderID);
        form.setProductVendorIDArr(new String[]{ConvertUtil.getString(productVendorID1),ConvertUtil.getString(productVendorID2)});
        form.setInventoryInfoIDArr(new String[]{"1","1"});
        form.setLogicInventoryInfoIDArr(new String[]{"1","1"});
        ...
        form.setLogicInventoryInfoIDAcceptArr(new String[]{"2","2"});
//        String deliverNoIF = ConvertUtil.getString(otherInfo.get("DeliverNoIF"));
//        form.setDeliverNoIF(deliverNoIF);
        setSession(CherryConstants.SESSION_USERINFO, userInfo);
        binOLSTSFH03_Action.setSession(session);
        binOLSTSFH03_Action.setServletRequest(request);
        binOLSTSFH03_Action.doaction();
        ...
        actualParamMap.put("tableName", "Inventory.BIN_ProductDeliver");
        //actualParamMap.put("DeliverNoIF", deliverNoIF);
        actualParamMap.put("RelevanceNo", orderNoIF);
        actualList = testCOM_Service.getTableData(actualParamMap);
        assertEquals("2",actualList.get(0).get("VerifiedFlag"));
        String deliverNoIF = ConvertUtil.getString(actualList.get(0).get("DeliverNoIF"));
        ...
        //收货
        msgBody = getMessageBody(mqList.get(2));
        msgBody = msgBody.replace("#DeliverNoIF#", deliverNoIF);
        tran_analyzeMessage(msgBody);
