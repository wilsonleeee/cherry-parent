...
public class BINOLSTIOS04_Action_TEST extends CherryJunitBase{
	private BINOLSTIOS04_Action action;
	...
	private void setUpInit1() throws Exception{
		action = createAction(BINOLSTIOS04_Action.class, "/st","BINOLSTIOS04_init");
	...
	//测试选择柜台时取终端逻辑仓库
		...
		paramMap.put("CounterCode", "T-ZGL-001");
