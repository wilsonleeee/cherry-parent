...
public class BINOLSTBIL15_Action_TEST extends CherryJunitBase{
	@Resource(name="TESTCOM_Service")
	private TESTCOM_Service testCOM_Service;
	
	private BINOLSTBIL15_Action action;
	...
	public void testInit1() throws Exception {
        ...
        action = createAction(BINOLSTBIL15_Action.class, "/st","BINOLSTBIL15_init");
    ...
    public void testSearch1() throws Exception {
        ...
        action = createAction(BINOLSTBIL15_Action.class, "/st","BINOLSTBIL15_search");
        List<Map<String,Object>> dataList = DataUtil.getDataList(this.getClass(),caseName);
        Map<String,Object> dataMap = (Map<String,Object>) DataUtil.getDataMap(this.getClass());
        UserInfo userInfo = DataUtil.getUserInfo(this.getClass(),caseName);
        ...
        BINOLSTBIL15_Form form = action.getModel();
        ...
        //proxy代理
        assertEquals("BINOLSTBIL15_1", proxy.execute());
    }
}