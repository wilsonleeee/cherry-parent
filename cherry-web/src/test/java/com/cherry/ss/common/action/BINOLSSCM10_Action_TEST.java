...
public class BINOLSSCM10_Action_TEST extends CherryJunitBase{
	@Resource(name="TESTCOM_Service")
	private TESTCOM_Service testCOM_Service;
	
	private BINOLSSCM10_Action action;
	...
	public void testGetInDepot1() throws Exception {
        ...
        action = createAction(BINOLSSCM10_Action.class, "/ss","BINOLSSCM10_getInDepot");
        ...
        if(null != tempList && tempList.size()>0){
            ...
            if(null != tempList && tempList.size()>0){
                ...
                if(null != tempList && tempList.size()>0){
                    ...
                    BINOLSSCM10_Form form = action.getModel();
                    ...
                    //proxy代理
                    assertEquals("BINOLSSCM10_1", proxy.execute());
                }
            }
        }
    }
