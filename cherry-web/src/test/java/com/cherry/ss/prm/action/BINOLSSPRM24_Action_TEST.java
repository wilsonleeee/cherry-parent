...
import com.cherry.ss.prm.form.BINOLSSPRM24_Form;


public class BINOLSSPRM24_Action_TEST extends CherryJunitBase{
	private BINOLSSPRM24_Action action24;
    @Resource 
	...
	private void setUpinit1() throws Exception{
		...
		action24 = createAction(BINOLSSPRM24_Action.class, "/ss","BINOLSSPRM24_INIT");
		BINOLSSPRM24_Form form = action24.getModel();
		DataUtil.getForm(this.getClass(), "testInit1", form);
		setSession("userinfo", userInfo);
		setSession(CherryConstants.SESSION_USERINFO, userInfo);
		action24.setSession(session);
	}
    ...
    public void testgetIsStock() throws Exception{
    	action24 = createAction(BINOLSSPRM24_Action.class, "/ss", "BINOLSSPRM24_GETSTOCKCOUNT");
		...
		action24.setServletResponse(response);
		action24.setServletRequest(request);
		action24.getStockCount();
    }
    @Test
    @Rollback(true)
    @Transactional
