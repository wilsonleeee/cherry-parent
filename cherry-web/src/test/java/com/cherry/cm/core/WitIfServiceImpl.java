...
public class WitIfServiceImpl extends SqlMapClientDaoSupport implements IBaseService, Serializable {
	protected static final Logger log = LoggerFactory.getLogger(WitIfServiceImpl.class);
